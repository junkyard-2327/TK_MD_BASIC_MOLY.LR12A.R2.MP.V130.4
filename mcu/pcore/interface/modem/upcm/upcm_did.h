 ...
 * $Log$
 *
 * 10 24 2017 cammie.yang
 * [MOLY00285041] 【?外部?用】VoLTE 受???
 * [R2] RTP Confidence Development
 ...
 * [UMOLYA][LR12A.MP1.5.RDIT.DEV][EPDCP] Fix DID linkage during scaling.
 *
 * 06 09 2017 steve.kao
 * [MOLY00256235] [BIANCO][MT6763][RDIT][PHONE][GCF][TS8980][CA 3A_7A 8.7.1.1_A.1]Assert fail: upcm.c 3554 - IPCORE
 * [UMOLYA][LR12A.MP1][EPDCP] Fix DID linkage during scaling.
 *
 * 05 24 2017 steve.kao
 * [MOLY00250411] [MT6763][RDIT][PHONE][GCF][ME7873L][CA 39A_41A 8.7.2.1_A.1 ]Assert fail: erlcdl_reasm.c 692 - EL2H
 * [UMOLYA][LR12A.MP1] 
 * 	[UPCM] DID format change and new macro for filling SI. 
 * 	[EPDCP] Use type 2 DID format for loopback test mode buffer release.
 *
 * 05 23 2017 steve.kao
 * [MOLY00250411] [MT6763][RDIT][PHONE][GCF][ME7873L][CA 39A_41A 8.7.2.1_A.1 ]Assert fail: erlcdl_reasm.c 692 - EL2H
 * [UMOLYA][LR12A.MP1] 
 * 	[UPCM] Use DID macros; add new macro for SIT entry pointer access. 
 * 	[EPDCP] Use DID macros.
 *
