...
l4cl1_em_rf_test_gsm_power_scan_cnf_struct;  //mphc_em_rf_test_gsm_power_scan_struct
...
typedef struct {
    LOCAL_PARA_HDR
    kal_uint8  reconfig_type;
}l4c_me_reconfigure_req_struct, l4c_me_volte_reconfigure_req_struct, l4c_me_ims_reconfigure_req_struct, l4c_me_dsbp_reconfigure_req_struct, l4c_me_dsbp_reconfigure_cnf_struct;
