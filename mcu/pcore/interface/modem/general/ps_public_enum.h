...
/* ============================== L4C cause ============================== */
    ...
    L4C_AT_CMD_RAC_NOTIFY_EGTYPE_ERROR = 0x1016,
    /* CAN ADD NEW CAUSE HERE <---------------- */
...
/* ============================== PAM VZW cause ============================== */
  	...
  	PAM_VZW_PDN_ACCESS_REJECT_THROTTLE_WITH_BACKOFF_TIMER       = 0x08 + PAM_VZW_CAUSE_START, // R12 replaces THROTTLE_FOREVER_CANDIDATE
...
typedef enum
{
    ...
    RETRY_CS,
    RETRY_IMS
}sdm_retry_domain_enum;

typedef struct
{
    sdm_retry_domain_enum when_last_trial_is_ims;
    sdm_retry_domain_enum when_last_trial_is_cs;
}sdm_retry_when_all_trials_fail_struct;

typedef struct
{
    sdm_retry_domain_enum when_ims_fail;
    sdm_retry_domain_enum when_cs_fail;
//    kal_uint16 max_retry_count;
    sdm_retry_when_all_trials_fail_struct when_all_trials_fail;   
