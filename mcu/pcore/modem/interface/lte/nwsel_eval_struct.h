 ...
 *
 * 04 22 2019 chien-li.chou
 * [MOLY00400151] §Ö³t?¨ú2/3/4G«ü©wband¤U©ÎªÌ¯S©w??list¤U©Ò¦³cellªº«H??«×©M?¶q - Interface
 * 	
 * 	ALPS04204574 vivo freq scan (NWSEL interface part)
 *
 * 03 26 2019 keith.xu
 * [MOLY00394192] [Cervino][CU VOLTE][Joint Test][JiNan][WW FT][Call Performance][ViLTE to ViLTE][LAT2]drop to 3G and not back to LTE.
 *
 * 11 30 2018 ian.hsieh
 * [MOLY00369001] (NWSEL header part)[B181113-011]¡i¥«?§ë?¡j¡iFT-·sÃ¦©_¥x¡j¡iCS¡j²¾?TDSÊI?¡A?ªk©I¤J??¡]5/20¡^
 * 	
 * 	ALPS04190600 - NWSEL header part.
 *
 * 08 20 2018 chien-li.chou
 * [MOLY00346767] [Struct][Cervino][P0][BSP+]VoLTE is not registered in this case
 * 	
 * 	Gemini suspend emm resume needed (NWSEL-EVAL structure part)
 *
 * 04 19 2018 chien-li.chou
 * [MOLY00321455] [A70AXL TMO][simulator][US][Protocol][42271]Recover Interrupted File - Sender Interrupted due to network conditions ¡V Sender Resumes fail
 * 	
 ...
 *
 * 03 01 2018 puneet.t
 * [MOLY00310205] [Gen93] TELCEL CC33 (MM NWSEL interface change part)
 * 	
 * 	TELCEL MM/NWSEL interface part
 *
 * 02 12 2018 harry.chang
 * [MOLY00307824] [MT6771][BSP+][O1]Cannot show ECC button when put the device out to shielding room - header file
 * 	
 * 	.
 *
 * 09 06 2017 harry.chang
 * [MOLY00275259] [Gen93][Network Search Optimization] Code Merge from LR11 to UMOLYA LR12A.R2
 * 	
 * 	NWSEL part
 *
 * 08 30 2017 chien-li.chou
 * [MOLY00274800] [MT6763][C2K][OM6M][Regression][Titan case] too long time and hang up automatically when dialing 110 (R2)
