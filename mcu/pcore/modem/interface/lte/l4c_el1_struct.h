 ...
 * [MOLY00363043] ¦Ñ¤Æ??airplane mode¾Þ§@
 * 	
 * 	[R2][LTE] AT+ERFTX error cause enhancement
 *
 * 06 05 2018 vend_mtb_mobiveil012
 * [MOLY00325261] Looking for TAS AT comamnd while target execte RF test by AT+ERFTX
 * Added two opional antenna parameters to AT+ERFTX=6 changes.
 *
 * 12 20 2017 bart.liang
