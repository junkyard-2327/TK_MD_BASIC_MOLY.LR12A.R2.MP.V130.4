...
/* MSG_ID_SDM_ATP_IMS_NORMAL_SMS_SMART_CONGESTION_START_REQ
   ...
   MSG_ID_SDM_ATP_IMS_CDMA_SMS_SMART_CONGESTION_START_REQ
 */
typedef struct
{
    LOCAL_PARA_HDR
...
typedef sdm_atp_ims_sms_smart_congestion_start_req_struct sdm_atp_ims_cdma_sms_smart_congestion_start_req_struct;
...
/* MSG_ID_SDM_ATP_IMS_NORMAL_SMS_SMART_CONGESTION_START_CNF
   ...
   MSG_ID_SDM_ATP_IMS_CDMA_SMS_SMART_CONGESTION_START_CNF
 */
typedef struct{
    LOCAL_PARA_HDR
    sdm_at_cmd_result_enum result;
...
typedef sdm_atp_ims_sms_smart_congestion_start_cnf_struct sdm_atp_ims_cdma_sms_smart_congestion_start_cnf_struct;
