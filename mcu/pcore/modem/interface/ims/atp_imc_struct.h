...
{
    ECBM_STOP_NONE = 0,
    ECBM_STOP_TIMER_EXPIRED
}ecbm_stop_cause_enum;
...
/*
 * @brief
 * @note MSG_ID_ATP_IMC_ECBM_STATE_REQ
 *      +CIEV:<102>,<state>,<1(expired)>
 */
typedef struct {
    LOCAL_PARA_HDR
    kal_uint8 ecbm_state;      //ecbm_state_enum
    kal_uint8 ecbm_stop_cause; //ecbm_stop_cause_enum
} atp_imc_ecbm_state_ind_struct;
