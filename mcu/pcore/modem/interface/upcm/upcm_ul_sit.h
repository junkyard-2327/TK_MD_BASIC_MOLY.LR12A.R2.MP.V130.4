 ...
 *  - operation indexes
 *
 *  note: 1. User Plane only.
 *        2. the 'size' is statically defined & configured; DO NOT modify it in your code. 
 */
typedef struct
{
    upcm_ul_sdu_info_t *p_addr;     // SIT base address
    kal_uint32          size;       // SIT size (entry #); DO NOT modify this field. 
    kal_uint32          head;
    kal_uint32          tail;
} upcm_ul_sit_t;
