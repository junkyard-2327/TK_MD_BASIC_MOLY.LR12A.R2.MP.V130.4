 ...
 *
 * 06 04 2018 ben.chiu
 * [MOLY00330046] [IMS interface]?Telecomm??CS?Emergency call is ending when SIM cards are taken out.
 * 	
 * 	IMS IF - patch back plug-out SIM while ECC is on-going
 *
 * 02 08 2018 ben.chiu
 * [MOLY00306516] [R2][Volunteer Patch][IMS][IMS Common IF]Dual IMS registration enhacement
 * [R2] [IMS Common IF] - Dual IMS registration enhacement
 *
 * 11 20 2017 yulong.chang
