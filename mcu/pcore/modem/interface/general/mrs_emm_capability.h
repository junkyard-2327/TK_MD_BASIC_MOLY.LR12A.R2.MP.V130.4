 ...
 * $Log$
 *
 * 04 20 2018 zanya.peng
 * [MOLY00321646] [R2][MT6765][Cervino][O1][MD Static Test][China][Auto]The UMTS security capability is not correctly set in UE Network Capability from the URRC Dynamic CAP.
 * 	
 * 	.
 *
 * 08 18 2017 zanya.peng
