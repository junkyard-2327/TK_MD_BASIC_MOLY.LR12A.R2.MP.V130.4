...
//MSG_ID_MM_RATCM_REG_PROC_ABNORMAL_IND
typedef ratcm_rrce_reg_proc_abnormal_ind_struct mm_ratcm_reg_proc_abnormal_ind_struct ;

//MSG_ID_MM_RATCM_FORCE_CONN_RELEASE_REQ
typedef ratcm_rrce_force_conn_release_req_struct mm_ratcm_force_conn_release_req_struct  ;

//MSG_ID_RATCM_RRCE_CELL_BARRED_IND
typedef ratcm_rrce_cell_barred_ind_struct mm_ratcm_cell_barred_ind_struct  ;
