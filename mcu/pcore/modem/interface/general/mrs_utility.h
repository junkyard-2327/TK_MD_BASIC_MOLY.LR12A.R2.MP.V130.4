 ...
 * 	.
 *
 * 03 20 2018 morton.lin
 * [MOLY00313302] [Gen93][P40][LR12A.R2.MP] Gionee blacklist feature - MRS
 * [MRS] Gionee blacklist feature phase-in
 *
 * 01 18 2018 muneeswaraiah.dama
 * [MOLY00302582] [Gen93][Huawei][CHR] Index 8, Index 9 - header/ interface files
 * .
 *
 * 11 29 2017 amit.sharma
 * [MOLY00292105] [Bianco MP1.0][MT6763][After MP Benchmark][VIVO V7+][Performance Test][SIM1:GT 4G][SIM2:N/A] DUT 2G Flight mode time is worse than benchmark >3 sec
 * .
 *
