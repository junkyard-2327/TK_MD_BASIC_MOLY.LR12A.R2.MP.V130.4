 ...
 * [LR12A.R2.MP] Remove LTM parts from EPDCP & RATDM and delete ltm_el2_msg_struct.h
 *
 ...
 * [R2][EPDCP][UL] Fix for data in data_req different from current epdcp rb_idx-ebi mapping
 *
 ...
 * 	
 * 	[R2][EPDCP][UL] Handle data received in inactive protocol_idx
 *
