 ...
 * ALPS04285656 TELUS
 *
 * 02 26 2018 yulong.chang
 * [MOLY00309588] [LR12A.R2.MP][VDM][Cervino][MT6765][O1][MP1.5][TDD][CMCC FT][Beijing][VoLTE FT][4.4]UE A drop to G when call UE B_Nongzhanqiao_15:03:40
 * 	
 ...
 * .[R2] .public api for is_e911_flow_applied
 *
