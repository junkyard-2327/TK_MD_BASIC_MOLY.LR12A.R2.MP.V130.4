 ...
 * [MOLY00406411] P70和P80 ?整循?LOG Filter : MRS Changes for ALPS04323455
 * 	
 * 	(R2)
 *
 * 01 18 2019 peter.chien
 * [MOLY00379338] Custom file enum usage update
 * 	
 * 	.[R2]OA
 *
 * 07 16 2018 plum.tseng
 * [MOLY00338708] 【系??定性】Assert fail: errc_cel_iscells.c 2108 - ERRC
 * 	
 * 	Fix reset part in band setting update by hplmn and cplmn.
 *
 * 03 29 2018 otto.liu
 * [MOLY00316940] [RCM][MT6765][Cervino][O1][MD Static Test][China][Auto]Incorrect AS Release and features are set in the ERRC UE Capability Information message.
 * 	
 * 	.
 *
 * 11 02 2017 otto.liu
 ...
 *
 * 09 14 2017 otto.liu
 * [MOLY00277983] [Market]确???移?TDD LTE网?下???量FDD LTE band 原因
 * 	
 * 	OPPO disable band according to sim and plmn
 *
 * 08 24 2017 morton.lin
 * [MOLY00273612] [MT6763][Bianco][N1][in-FTA][4G PCT][Anritsu][HQ][E04][8.2.1.5]
 * Add new extended version for MRS EAS APIs to reduce trace print (LR12A.R2.MP)
 *
 * 07 28 2017 morton.lin
 * [MOLY00266852] [Bianco/Zion] fre sw check-in
 * [MRS] B71 SW eFuse phase in (LR12A.R2.MP)
 *
 * 07 06 2017 morton.lin
 * [MOLY00261305] [Gen93] B71 development
 * MRS and NVRAM phase in (LR12A.R2.MP)
 *
