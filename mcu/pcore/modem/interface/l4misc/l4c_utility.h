...
extern void l4c_start_call_retry_max_timer_hdlr(kal_uint8 src_id);
...
extern void l4c_retry_max_timer_hdlr(void);
...
extern void l4c_nw_get_power_level_threshold(kal_uint8 *mode, kal_int32 *upper_threshold, kal_uint8 *tup,
...
extern kal_bool l4c_sim_is_esimmap_ongoing(void);
...
extern kal_bool l4c_queue_has_pending_action(l4c_action_enum pending_action);
extern kal_bool l4c_queue_delete_pending_action(l4c_action_enum pending_action);
extern kal_bool l4c_enqueue_pending_action(l4c_action_enum action_to_be_pended);
extern kal_bool l4c_dequeue_pending_action();
extern void l4c_queue_print_all_pending_action();
...
extern void plmn_convert_to_mcc_mnc(plmn_id_struct *source, kal_uint8 *mcc, kal_uint8 *mnc);
