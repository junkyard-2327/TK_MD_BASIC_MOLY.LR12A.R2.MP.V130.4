...
extern kal_bool l4c_ps_send_cellular_network_cfg_to_tcm(kal_uint8 src_id, l4c_cellular_network_config *config);

extern void l4c_ps_send_data_service_status_update_to_rac(kal_bool is_data_service_on);
