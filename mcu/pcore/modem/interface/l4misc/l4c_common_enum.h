...
typedef enum
{
   ...
   L4C_AUTO_PS_DETACH,  // If PS detach and PLMN List operation conflict, pending PS detach until PLMN List complete
...
typedef enum
{
    ...
    L4C_TIMER_ID_EPSNLTE,   // 17: EPSNLTE URC timer
    L4C_TIMER_ID_CALL_RETRY_MAX_TIMER,//18: call retry max timer
