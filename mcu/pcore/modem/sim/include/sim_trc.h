...
BEGIN_TRACE_MAP(MOD_SIM)
    ...
    TRC_MSG(FUNC_SIM_JSR177_ATR_REQ_HANDLER,"[SIM] sim_jsr177_atr_req_handler()")
    TRC_MSG(FUNC_SIM_JSR177_APDU_REQ_HANDLER,"[SIM] sim_jsr177_apdu_req_handler()") // mtk01616_110317
    ...
    TRC_MSG(INFO_SIM_NOSAT_REFRESH_FCN,"[SIM] Non-SAT refresh: Send File Change Notification")
    ...
    TRC_MSG(INFO_SIM_INIT_DONE_FILE_READ,"[SIM] SIM init done, Send SIM Refresh(FCN) to request FILE read")
    ...
    TRC_MSG(INFO_SAT_EXTRA_FILE_SELECTION_BEFORE_ENVELOPE, "[SAT] extra_file_selection_before_envelope(): CURRENT_FILE=%d")
    ...
    TRC_MSG(INFO_SAT_LOCI_UPDATE_IN_SAT_SESSION, "[SAT] LOCI Update in SAT Session, update again later")
    TRC_MSG(INFO_SAT_UPDATE_LOCI_AGAIN, "[SAT] Update LOCI again")
    ...
    TRC_MSG(INFO_SIM_CACHE_FILE_NOT_CACHED,"%Msim_file_index_enum not part of cache table")
    TRC_MSG(INFO_SIM_CACHE_FILE_NOT_UPDATED,"%Msim_file_index_enum cache not updated")
    ...
    TRC_MSG(WARNING_REISSUE_REFRESH_WRONG_DATA,"[SAT] sat_reissue_refresh_handler() WRONG DATA and INTERRUPT the REFRESH!")
    ...
    TRC_MSG(WARNING_SIM_CDMA_RESET_NO_SIM,"[SIM] SIM_Reset_NoSIM in CDMA Detection")
    ...
    TRC_MSG(WARNING_SIM_AP_SIMPOWER_SET_DOWN,"[SIM] AP SIM Power or OP20 SIM Lock set as down")
    ...
    TRC_MSG(WARNING_SAT_CMD_IND_DURING_SAT_SESSION, "[SAT] 91XX received under sat session or after command prefetched, ignored!")
    ...
    TRC_MSG(ERROR_SIM_AP_SIMPOWER_REQ_INVALID_HANDLE,"[SIM] AP SIM Power or OP20 SIM Lock req error!")
