...
extern void sim_cdma_detection(sim_context_struct *this_sim, sim_reset_struct *sim_reset_ptr, kal_bool *is_reset_error, kal_bool *is_temp_loss);
...
#if 1 // try to update File context update by APDU, if work, all xxx_OLD could be removed
#define USIM_CURRENT_FILE_UPDATE_OLD(channel)  (dummy_var)
#define USIM_CURRENT_DF_UPDATE_OLD(channel)    (dummy_var)
#define USIM_CURRENT_DF_ID_UPDATE_OLD(channel) (dummy_var)
#else
/* under construction !*/
/* under construction !*/
/* under construction !*/
...
void sim_submodule_reread_req_handler(ilm_struct *sim_ilm_ptr, sim_context_struct *this_sim);
