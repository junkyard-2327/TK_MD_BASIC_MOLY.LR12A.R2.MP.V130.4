...
#if defined(__SIM_MMDS_CLIENT__) || defined(__APVSIM__)
...
typedef kal_bool (*CACHE_FILE_READ_FUNC)(kal_uint8 p1, kal_uint8 p2, kal_uint8 p3, kal_uint8 *data, kal_uint32 data_size, kal_uint16 *status_word, sim_context_struct *this_sim);
typedef kal_bool (*CACHE_FILE_WRITE_FUNC)(kal_uint8 p1, kal_uint8 p2, kal_uint8 p3, kal_uint8 *data, kal_uint32 data_size, sim_context_struct *this_sim);
typedef kal_bool (*CACHE_FILE_RESET_FUNC)(sim_context_struct *this_sim);
...
}sim_cache_nvram_file_enum_info_struct;
...
typedef struct
{
    ...
    sim_cache_nvram_file_enum_info_struct enum_info;

    /* current path */
    kal_uint8 path[MAX_SIM_NUM][6];

    /* cache file read fn_ptr*/
    CACHE_FILE_READ_FUNC  read_fn_ptr;      // nvram read operation, sim_cmd_all()
 
    /* cache file write fn_ptr*/
    CACHE_FILE_WRITE_FUNC  write_fn_ptr;     // nvram write operation, sim_cmd_all()

    /* cache file reset fn_ptr*/    
    CACHE_FILE_RESET_FUNC  reset_fn_ptr;     // nvram reset operation.  
}sim_cache_nvram_file_info_struct;

extern sim_cache_nvram_file_info_struct cache_file_info[];

extern kal_uint16 dummy_var;
