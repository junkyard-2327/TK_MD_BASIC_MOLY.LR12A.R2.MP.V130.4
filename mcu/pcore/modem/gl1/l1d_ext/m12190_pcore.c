...
#endif  /*#if IS_2G_RX_DIVERSITY_PATH_SUPPORT*/
/* ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ */
#if IS_2G_RX_DIVERSITY_PATH_SUPPORT
...
sNSFT_ADJUST_TPO*  Adjust_TPO_GMSK_Pcore[FrequencyBandCount];
   #if IS_EPSK_TX_SUPPORT
       #if IS_EPSK_ADJUST_TPO_SUPPORT
sNSFT_ADJUST_TPO*  Adjust_TPO_EPSK_Pcore[FrequencyBandCount];
...
#endif/*IS_RX_POWER_OFFSET_SUPPORT*/
#if IS_NSFT_ADJUST_TX_POWER_OFFSET_SUPPORT
void L1D_RF_SetAdjustTPOData_GMSK_Pcore( int rf_band, void *table )
{  signed char *src, *dst;
   int  n;

   src = (signed char*)table;
   dst = (signed char*)(Adjust_TPO_GMSK_Pcore[rf_band]);
...
/* ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ */
    #if IS_EPSK_ADJUST_TPO_SUPPORT
void L1D_RF_SetAdjustTPOData_EPSK_Pcore( int rf_band, void *table )
{  signed char *src, *dst;
   int  n;

   src = (signed char*)table;
   dst = (signed char*)(Adjust_TPO_EPSK_Pcore[rf_band]);
...
void L1D_MMRF_PCoreSHMDataInit(void)
{
   ...
   for(i=1; i<FrequencyBandCount; i++) // start from pointer not equal to zero
   {
      ...
      Adjust_TPO_GMSK_Pcore[i] = MMRF_CUSTOM_SHARED_ARRAY(Adjust_TPO_GMSK_SHM_TABLE[i]);
      MMRF_CUSTOM_SHARED_DATA_SET_TO_CACHE(Adjust_TPO_GMSK_Pcore[i], (sizeof(sNSFT_ADJUST_TPO)));
   #if IS_EPSK_TX_SUPPORT
       #if IS_EPSK_ADJUST_TPO_SUPPORT
      /*   EPSK TX POWER OFFSET pointer table re-assign*/
      Adjust_TPO_EPSK_Pcore[i] = MMRF_CUSTOM_SHARED_ARRAY(Adjust_TPO_EPSK_SHM_TABLE[i]);
      MMRF_CUSTOM_SHARED_DATA_SET_TO_CACHE(Adjust_TPO_EPSK_Pcore[i], (sizeof(sNSFT_ADJUST_TPO)));	
       #endif//IS_EPSK_ADJUST_TPO_SUPPORT
   #endif//IS_EPSK_TX_SUPPORT
#endif//IS_NSFT_ADJUST_TX_POWER_OFFSET_SUPPORT
...
void L1D_PcoreNvramUpdate2SHM( kal_uint32 cal_lid )
{
   ...
   switch ( (nvram_lid_enum)cal_lid )
   {
      ...
      {
   #if IS_NSFT_ADJUST_TX_POWER_OFFSET_SUPPORT
         nsft_adjust_tpo_t *nsft_adjust_tpo = (nsft_adjust_tpo_t *)L1_ALLOC_BUF( sizeof( nsft_adjust_tpo_t ) );
         kal_bool error_no;

         error_no = nvram_external_read_data(NVRAM_EF_L1_GMSK_ADJUST_TPO_GSM850_LID, 1, (kal_uint8 *)nsft_adjust_tpo,  sizeof( nsft_adjust_tpo_t ) );
         ASSERT(error_no == KAL_TRUE);
         L1D_RF_SetAdjustTPOData_GMSK_Pcore( FrequencyBand850,  (nsft_adjust_tpo_t*)nsft_adjust_tpo);
         L1_FREE_BUF( nsft_adjust_tpo );
   #endif
      }
      break;
      ...
      case NVRAM_EF_L1_GMSK_ADJUST_TPO_GSM900_LID:
      {
         ...
         error_no = nvram_external_read_data(NVRAM_EF_L1_GMSK_ADJUST_TPO_GSM900_LID, 1, (kal_uint8 *)nsft_adjust_tpo,  sizeof( nsft_adjust_tpo_t ) );
         ASSERT(error_no == KAL_TRUE);
         L1D_RF_SetAdjustTPOData_GMSK_Pcore( FrequencyBand900,  (nsft_adjust_tpo_t*)nsft_adjust_tpo);
         L1_FREE_BUF( nsft_adjust_tpo );
   #endif
      }
      break;
      ...
      case NVRAM_EF_L1_GMSK_ADJUST_TPO_DCS_LID:
      {
         ...
         error_no = nvram_external_read_data(NVRAM_EF_L1_GMSK_ADJUST_TPO_DCS_LID, 1, (kal_uint8 *)nsft_adjust_tpo,  sizeof( nsft_adjust_tpo_t ) );
         ASSERT(error_no == KAL_TRUE);
         L1D_RF_SetAdjustTPOData_GMSK_Pcore( FrequencyBand1800,  (nsft_adjust_tpo_t*)nsft_adjust_tpo);
         L1_FREE_BUF( nsft_adjust_tpo );
   #endif
      }
      break;
      ...
      case NVRAM_EF_L1_GMSK_ADJUST_TPO_PCS_LID:
      {
         ...
         error_no = nvram_external_read_data(NVRAM_EF_L1_GMSK_ADJUST_TPO_PCS_LID, 1, (kal_uint8 *)nsft_adjust_tpo,  sizeof( nsft_adjust_tpo_t ) );
         ASSERT(error_no == KAL_TRUE);
         L1D_RF_SetAdjustTPOData_GMSK_Pcore( FrequencyBand1900,  (nsft_adjust_tpo_t*)nsft_adjust_tpo);
         L1_FREE_BUF( nsft_adjust_tpo );
   #endif
      }
      break;
      ...
      case NVRAM_EF_L1_EPSK_ADJUST_TPO_GSM850_LID:
      {
         ...
         error_no = nvram_external_read_data(NVRAM_EF_L1_EPSK_ADJUST_TPO_GSM850_LID, 1, (kal_uint8 *)nsft_adjust_tpo,  sizeof( nsft_adjust_tpo_t ) );
         ASSERT(error_no == KAL_TRUE);
         L1D_RF_SetAdjustTPOData_EPSK_Pcore( FrequencyBand850,  (nsft_adjust_tpo_t*)nsft_adjust_tpo);
         L1_FREE_BUF( nsft_adjust_tpo );
       #endif//IS_EPSK_ADJUST_TPO_SUPPORT
   #endif//IS_NSFT_ADJUST_TX_POWER_OFFSET_SUPPORT
      }
      ...
      case NVRAM_EF_L1_EPSK_ADJUST_TPO_GSM900_LID:
      {
         ...
         error_no = nvram_external_read_data(NVRAM_EF_L1_EPSK_ADJUST_TPO_GSM900_LID, 1, (kal_uint8 *)nsft_adjust_tpo,  sizeof( nsft_adjust_tpo_t ) );
         ASSERT(error_no == KAL_TRUE);
         L1D_RF_SetAdjustTPOData_EPSK_Pcore( FrequencyBand900,  (nsft_adjust_tpo_t*)nsft_adjust_tpo);
         L1_FREE_BUF( nsft_adjust_tpo );
       #endif//IS_EPSK_ADJUST_TPO_SUPPORT
   #endif//IS_NSFT_ADJUST_TX_POWER_OFFSET_SUPPORT
      }
      ...
      case NVRAM_EF_L1_EPSK_ADJUST_TPO_DCS_LID:
      {
         ...
         error_no = nvram_external_read_data(NVRAM_EF_L1_EPSK_ADJUST_TPO_DCS_LID, 1, (kal_uint8 *)nsft_adjust_tpo,  sizeof( nsft_adjust_tpo_t ) );
         ASSERT(error_no == KAL_TRUE);
         L1D_RF_SetAdjustTPOData_EPSK_Pcore( FrequencyBand1800,  (nsft_adjust_tpo_t*)nsft_adjust_tpo);
         L1_FREE_BUF( nsft_adjust_tpo );
      #endif//IS_EPSK_ADJUST_TPO_SUPPORT
   #endif//IS_NSFT_ADJUST_TX_POWER_OFFSET_SUPPORT
      }
      ...
      case NVRAM_EF_L1_EPSK_ADJUST_TPO_PCS_LID:
      {
         ...
         error_no = nvram_external_read_data(NVRAM_EF_L1_EPSK_ADJUST_TPO_PCS_LID, 1, (kal_uint8 *)nsft_adjust_tpo,  sizeof( nsft_adjust_tpo_t ) );
         ASSERT(error_no == KAL_TRUE);
         L1D_RF_SetAdjustTPOData_EPSK_Pcore( FrequencyBand1900,  (nsft_adjust_tpo_t*)nsft_adjust_tpo);
         L1_FREE_BUF( nsft_adjust_tpo );
      #endif//IS_EPSK_ADJUST_TPO_SUPPORT
   #endif//IS_NSFT_ADJUST_TX_POWER_OFFSET_SUPPORT
      }
...
void L1D_PcoreUpdate2SHM_ByDefaultCustom( kal_uint32 cal_lid  )
{
   switch ( (nvram_lid_enum)cal_lid )
   {
      ...
      {
   #if IS_NSFT_ADJUST_TX_POWER_OFFSET_SUPPORT
         L1D_RF_SetAdjustTPOData_GMSK_Pcore( FrequencyBand850,  (nsft_adjust_tpo_t*)Adjust_TPO_GMSK_SetDefault[FrequencyBand850]);
   #endif
      }
      break;
      ...
      {
   #if IS_NSFT_ADJUST_TX_POWER_OFFSET_SUPPORT
         L1D_RF_SetAdjustTPOData_GMSK_Pcore( FrequencyBand900,  (nsft_adjust_tpo_t*)Adjust_TPO_GMSK_SetDefault[FrequencyBand900]);
   #endif
      }
      break;
      ...
      {
   #if IS_NSFT_ADJUST_TX_POWER_OFFSET_SUPPORT
         L1D_RF_SetAdjustTPOData_GMSK_Pcore( FrequencyBand1800,  (nsft_adjust_tpo_t*)Adjust_TPO_GMSK_SetDefault[FrequencyBand1800]);
   #endif
      }
      break;
      ...
      {
   #if IS_NSFT_ADJUST_TX_POWER_OFFSET_SUPPORT
         L1D_RF_SetAdjustTPOData_GMSK_Pcore( FrequencyBand1900,  (nsft_adjust_tpo_t*)Adjust_TPO_GMSK_SetDefault[FrequencyBand1900]);
   #endif
      }
      break;
   ...
   #if IS_NSFT_ADJUST_TX_POWER_OFFSET_SUPPORT
      #if IS_EPSK_ADJUST_TPO_SUPPORT
         L1D_RF_SetAdjustTPOData_EPSK_Pcore( FrequencyBand850,  (nsft_adjust_tpo_t*)Adjust_TPO_EPSK_SetDefault[FrequencyBand850]);
      #endif//IS_EPSK_ADJUST_TPO_SUPPORT
   #endif
      }
      break;
   ...
   #if IS_NSFT_ADJUST_TX_POWER_OFFSET_SUPPORT
      #if IS_EPSK_ADJUST_TPO_SUPPORT
         L1D_RF_SetAdjustTPOData_EPSK_Pcore( FrequencyBand900,  (nsft_adjust_tpo_t*)Adjust_TPO_EPSK_SetDefault[FrequencyBand900]);
      #endif//IS_EPSK_ADJUST_TPO_SUPPORT
   #endif
      }
      break;
   ...
   #if IS_NSFT_ADJUST_TX_POWER_OFFSET_SUPPORT
      #if IS_EPSK_ADJUST_TPO_SUPPORT
         L1D_RF_SetAdjustTPOData_EPSK_Pcore( FrequencyBand1800,  (nsft_adjust_tpo_t*)Adjust_TPO_EPSK_SetDefault[FrequencyBand1800]);
      #endif//IS_EPSK_ADJUST_TPO_SUPPORT
   #endif
      }
      break;
   ...
   #if IS_NSFT_ADJUST_TX_POWER_OFFSET_SUPPORT
      #if IS_EPSK_ADJUST_TPO_SUPPORT
         L1D_RF_SetAdjustTPOData_EPSK_Pcore( FrequencyBand1900,  (nsft_adjust_tpo_t*)Adjust_TPO_EPSK_SetDefault[FrequencyBand1900]);
      #endif//IS_EPSK_ADJUST_TPO_SUPPORT
   #endif
      }
      break;
...
#endif
#if IS_NSFT_ADJUST_TX_POWER_OFFSET_SUPPORT
      MMRF_CUSTOM_SHARED_DATA_SET_TO_NOCACHE(Adjust_TPO_GMSK_Pcore[i], (sizeof(sNSFT_ADJUST_TPO)));
   #if IS_EPSK_TX_SUPPORT
      #if IS_EPSK_ADJUST_TPO_SUPPORT
      MMRF_CUSTOM_SHARED_DATA_SET_TO_NOCACHE(Adjust_TPO_EPSK_Pcore[i], (sizeof(sNSFT_ADJUST_TPO)));	
      #endif//IS_EPSK_ADJUST_TPO_SUPPORT
   #endif
#endif
