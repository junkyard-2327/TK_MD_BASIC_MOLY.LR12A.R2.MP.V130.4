...
void l4c_em_ch_lock_get_rrsp(kal_bool result, kal_uint8 mode, kal_uint8 act, 
    kal_uint8 band_indicator, kal_uint32 arfcn, kal_uint16 cell_id);
...
extern void l4c_eval_lteca_band_read_rrsp(l4c_source_id_enum src_id,
        kal_bool result,
...
extern void l4c_egmc_set_rrsp(kal_uint16 src_id, kal_bool result);
...
extern void l4c_nw_mrs_black_cell_list_rrsp(mrs_as_black_cell_list_struct *mrs_black_cell_list);
...
extern void l4c_plmn_list_wss_rrsp(l4c_rac_response_enum result, kal_uint8 length, l4c_rat_plmn_info_struct *list);
