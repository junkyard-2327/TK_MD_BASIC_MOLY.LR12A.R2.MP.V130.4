...
extern void l4c_nw_ecell_report(kal_bool is_at, kal_bool is_shm);
...
extern void l4c_nw_mcc_mnc_rind(kal_uint8 *mcc, kal_uint8 *mnc);
extern void l4c_nw_extended_lce_report_rind(kal_uint32 ul_kbps, kal_uint32 dl_kbps);
