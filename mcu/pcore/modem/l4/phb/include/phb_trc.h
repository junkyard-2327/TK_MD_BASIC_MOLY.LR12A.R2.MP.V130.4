...
BEGIN_TRACE_MAP(MOD_PHB)
   ...
   TRC_MSG(INFO_PHB_SIM_ECC_RESET, "[PHB] SIM ECC reset for sim id: %d")
   TRC_MSG(INFO_PHB_WRONG_CAUSE_IN_SIM_ERROR, "[PHB] Wrong Cause in SIM error ind")
   TRC_MSG(INFO_PHB_L4C_WRONG_RES_IF_CB, "[PHB] L4C primitive mismatch CB[%d] created ID = %d, res_msg_id = %d, cnf_msg_id = %d")
