...
TRC_MSG(RAC_SBP_MATCH_CUSTOM_TABLE, "[RAC] %Msbp_md_feature_enum is in custom table, and the result is  %Mkal_bool")
TRC_MSG(RAC_SBP_MISMATCH_CUSTOM_TABLE, "[RAC] %Msbp_md_feature_enum is not in custom table, so remain default on")
...
TRC_MSG(RAC_INFO_UPDATE_SMS_OVER_IP, "[RAC] smsoip_source: %s, smsoip in erac_context: %Mkal_bool, new smsoip: %Mkal_bool")
