...
typedef struct
{
    ...
    emm_cause_enum                  previous_emm_cause;
...
//   kal_uint8                           ber;
   ...
   kal_bool                            is_supporting_roaming;
	...
	/*[ALPS03782151] mtk13782: cell info updated during plmn search, but the detach ind came after the receive plmn search cnf, 
	  MM/GMM/EMM reg state was restored to previous state(REG_NORMAL), this make wrong combination between cell info and reg state because DUT never attach this cell,
	  and show fake 4G symbol*/
	kal_bool                            is_cell_info_update_during_search;
