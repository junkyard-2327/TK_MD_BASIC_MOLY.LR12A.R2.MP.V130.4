...
extern void rac_l4c_get_last_rat_select_ind_req_handler(local_para_struct *local_para_ptr, peer_buff_struct *peer_buff_ptr);
...
extern void rac_gmss_1x_conn_status_ind_handler(local_para_struct *local_para_ptr, peer_buff_struct *peer_buff_ptr);
...
extern void rac_gmss_get_last_rat_select_ind_cnf_handler(local_para_struct *local_para_ptr, peer_buff_struct *peer_buff_ptr);
...
extern void  rac_gmss_active_rat_ind_handler(local_para_struct *local_para_ptr, peer_buff_struct *peer_buff_ptr);

extern void rac_gmss_suspend_egreg_update_ind_handler(local_para_struct *local_para_ptr, peer_buff_struct *peer_buff_ptr);
