...
extern kal_bool l4c_nw_set_and_trigger_auto_detach_req(kal_uint8 src_id);
...
extern kal_bool l4c_nw_lteca_band_read_req (kal_uint8 src_id);

extern kal_bool l4c_nw_lteca_band_set_req (kal_uint8 l4c_source_id_enum,
...
extern kal_bool l4c_nw_emc_service_scan_req(l4c_source_id_enum src_id, rat_enum available_rat, rat_enum prefer_rat, kal_bool is_new_call);
...
extern void l4c_nw_set_ps_only_req(kal_bool rsim_status);
#endif
...
extern void l4c_nw_sim_lock_req(l4c_source_id_enum src_id, kal_uint8 lock_mode,kal_uint8 attach_type);
extern void l4c_send_sim_lock_cnf(kal_bool result);
...
extern void l4c_nw_mrs_black_cell_list_report(void);
extern void l4c_nw_clear_black_cell_list(void);
extern kal_bool l4c_nw_add_black_cell_list(mrs_as_black_cell_list_struct *mrs_black_cell_list);
