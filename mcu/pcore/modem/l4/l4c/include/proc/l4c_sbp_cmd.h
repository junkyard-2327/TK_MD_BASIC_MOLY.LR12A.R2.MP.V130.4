 ...
 *
 *****************************************************************************/
kal_bool l4c_sbp_set_dsbp_id(kal_uint32 sim_sbp_id);
 ...
 *
 *****************************************************************************/
kal_bool l4c_sbp_set_dsbp_req(l4c_source_id_enum src_id, l4c_me_reconfig_enum type, kal_uint32 sim_sbp_id);
