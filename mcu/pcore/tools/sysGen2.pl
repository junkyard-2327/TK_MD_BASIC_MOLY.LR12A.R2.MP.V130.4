...
my $SYSGEN2_VERNO    = " u0.44_UMOLY";
                        #  u0.44_UMOLY,  2018/01/15,  Tero,   Modem mini dump implementation
                        #  u0.43_UMOLY,  2017/08/31,  Tero,   Added code region dump support
                        #  u0.42_UMOLY,  2017/06/08,  Carl,   Support overlapped ROM region
                        #  u0.41_UMOLY,  2017/06/08,  Tero,   IOCU area dump support
