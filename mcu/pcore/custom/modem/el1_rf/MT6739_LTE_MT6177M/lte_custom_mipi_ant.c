...
LTE_MIPI_EVENT_TABLE_T LTE_Band6_MIPI_ANTRX_EVENT_SetDefault[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   { /* 0  */ LTE_MIPI_ANT  , { 0    , 0    }, LTE_MIPI_TRX_ON    , LTE_FDD_MIPI_ANT_RX_ON0_SetDefault  }, //PA On
...
LTE_MIPI_EVENT_TABLE_T LTE_Band9_MIPI_ANTRX_EVENT_SetDefault[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   { /* 0  */ LTE_MIPI_ANT  , { 0    , 0    }, LTE_MIPI_TRX_ON    , LTE_FDD_MIPI_ANT_RX_ON0_SetDefault  }, //PA On
...
LTE_MIPI_EVENT_TABLE_T LTE_Band11_MIPI_ANTRX_EVENT_SetDefault[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   //{ /* 0  */ LTE_MIPI_ANT  , { 0    , 0    }, LTE_MIPI_TRX_ON    , LTE_FDD_MIPI_ANT_RX_ON0_SetDefault  }, //PA On
...
LTE_MIPI_EVENT_TABLE_T LTE_Band18_MIPI_ANTRX_EVENT_SetDefault[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   //{ /* 0  */ LTE_MIPI_ANT  , { 0    , 0    }, LTE_MIPI_TRX_ON    , LTE_FDD_MIPI_ANT_RX_ON0_SetDefault  }, //PA On
...
LTE_MIPI_EVENT_TABLE_T LTE_Band19_MIPI_ANTRX_EVENT_SetDefault[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   { /* 0  */ LTE_MIPI_ANT  , { 0    , 0    }, LTE_MIPI_TRX_ON    , LTE_FDD_MIPI_ANT_RX_ON0_SetDefault  }, //PA On
...
LTE_MIPI_EVENT_TABLE_T LTE_Band21_MIPI_ANTRX_EVENT_SetDefault[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   //{ /* 0  */ LTE_MIPI_ANT  , { 0    , 0    }, LTE_MIPI_TRX_ON    , LTE_FDD_MIPI_ANT_RX_ON0_SetDefault  }, //PA On
...
LTE_MIPI_EVENT_TABLE_T LTE_Band22_MIPI_ANTRX_EVENT_SetDefault[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   //{ /* 0  */ LTE_MIPI_ANT  , { 0    , 0    }, LTE_MIPI_TRX_ON    , LTE_FDD_MIPI_ANT_RX_ON0_SetDefault  }, //PA On
...
LTE_MIPI_EVENT_TABLE_T LTE_Band25_MIPI_ANTRX_EVENT_SetDefault[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   { /* 0  */ LTE_MIPI_ANT  , { 0    , 0    }, LTE_MIPI_TRX_ON    , LTE_FDD_MIPI_ANT_RX_ON0_SetDefault  }, //PA On
...
LTE_MIPI_EVENT_TABLE_T LTE_Band27_MIPI_ANTRX_EVENT_SetDefault[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   //{ /* 0  */ LTE_MIPI_ANT  , { 0    , 0    }, LTE_MIPI_TRX_ON    , LTE_FDD_MIPI_ANT_RX_ON0_SetDefault  }, //PA On
...
LTE_MIPI_EVENT_TABLE_T LTE_Band32_MIPI_ANTRX_EVENT_SetDefault[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   //{ /* 0  */ LTE_MIPI_ANT  , { 0    , 0    }, LTE_MIPI_TRX_ON    , LTE_FDD_MIPI_ANT_RX_ON0_SetDefault  }, //PA On
...
LTE_MIPI_EVENT_TABLE_T LTE_Band42_MIPI_ANTRX_EVENT_SetDefault[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   //{ /* 0  */ LTE_MIPI_ANT  , { 0    , 0    }, LTE_MIPI_TRX_ON    , LTE_TDD_MIPI_ANT_RX_ON0_SetDefault  }, //PA On
...
LTE_MIPI_EVENT_TABLE_T LTE_Band43_MIPI_ANTRX_EVENT_SetDefault[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   //{ /* 0  */ LTE_MIPI_ANT  , { 0    , 0    }, LTE_MIPI_TRX_ON    , LTE_TDD_MIPI_ANT_RX_ON0_SetDefault  }, //PA On
...
LTE_MIPI_EVENT_TABLE_T LTE_Band44_MIPI_ANTRX_EVENT_SetDefault[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   //{ /* 0  */ LTE_MIPI_ANT  , { 0    , 0    }, LTE_MIPI_TRX_ON    , LTE_TDD_MIPI_ANT_RX_ON0_SetDefault  }, //PA On
...
LTE_MIPI_EVENT_TABLE_T LTE_Band71_MIPI_ANTRX_EVENT_SetDefault[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
...
LTE_MIPI_EVENT_TABLE_T LTE_Band252_MIPI_ANTRX_EVENT_SetDefault[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   //{ /* 0  */ LTE_MIPI_ANT  , { 0    , 0    }, LTE_MIPI_TRX_ON    , LTE_FDD_MIPI_ANT_RX_ON0_SetDefault  }, //PA On
...
LTE_MIPI_EVENT_TABLE_T LTE_Band255_MIPI_ANTRX_EVENT_SetDefault[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   //{ /* 0  */ LTE_MIPI_ANT  , { 0    , 0    }, LTE_MIPI_TRX_ON    , LTE_FDD_MIPI_ANT_RX_ON0_SetDefault  }, //PA On
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band6_MIPI_ANTRX_DATA_SetDefault[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band9_MIPI_ANTRX_DATA_SetDefault[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band11_MIPI_ANTRX_DATA_SetDefault[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band18_MIPI_ANTRX_DATA_SetDefault[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band19_MIPI_ANTRX_DATA_SetDefault[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band21_MIPI_ANTRX_DATA_SetDefault[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data }, 
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band22_MIPI_ANTRX_DATA_SetDefault[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band25_MIPI_ANTRX_DATA_SetDefault[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band27_MIPI_ANTRX_DATA_SetDefault[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band32_MIPI_ANTRX_DATA_SetDefault[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band42_MIPI_ANTRX_DATA_SetDefault[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band43_MIPI_ANTRX_DATA_SetDefault[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band44_MIPI_ANTRX_DATA_SetDefault[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band71_MIPI_ANTRX_DATA_SetDefault[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band252_MIPI_ANTRX_DATA_SetDefault[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band255_MIPI_ANTRX_DATA_SetDefault[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
   //{ /* 0  */ LTE_MIPI_ANT , LTE_MIPI_PORT2    , LTE_REG_W     , MIPI_USID_ANT0_SetDefault   ,{ { 24960 /*100 kHz*/ ,0x1C ,0x38 }, { 25445 /*100 kHz*/ ,0x1C ,0x38 }, { 25930 /*100 kHz*/ ,0x1C ,0x38 }, { 26415 /*100 kHz*/ ,0x1C ,0x38 }, { 26900 /*100 kHz*/ ,0x1C ,0x38 },} },
   { /* 8  */ LTE_MIPI_NULL, 0                 , 0             , 0                ,{ {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    },} },
...
LTE_MIPI_EVENT_TABLE_T LTE_Band6_MIPI_ANTTX_EVENT_SetDefault[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   { /* 0  */ LTE_MIPI_ANT  , { 0    , 0    }, LTE_MIPI_TRX_ON    , LTE_FDD_MIPI_ANT_TX_ON0_SetDefault  }, //PA On
...
LTE_MIPI_EVENT_TABLE_T LTE_Band9_MIPI_ANTTX_EVENT_SetDefault[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   { /* 0  */ LTE_MIPI_ANT  , { 0    , 0    }, LTE_MIPI_TRX_ON    , LTE_FDD_MIPI_ANT_TX_ON0_SetDefault  }, //PA On
...
LTE_MIPI_EVENT_TABLE_T LTE_Band11_MIPI_ANTTX_EVENT_SetDefault[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   //{ /* 0  */ LTE_MIPI_ANT  , { 0    , 0    }, LTE_MIPI_TRX_ON    , LTE_FDD_MIPI_ANT_TX_ON0_SetDefault  }, //PA On
...
LTE_MIPI_EVENT_TABLE_T LTE_Band18_MIPI_ANTTX_EVENT_SetDefault[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   //{ /* 0  */ LTE_MIPI_ANT  , { 0    , 0    }, LTE_MIPI_TRX_ON    , LTE_FDD_MIPI_ANT_TX_ON0_SetDefault  }, //PA On
...
LTE_MIPI_EVENT_TABLE_T LTE_Band19_MIPI_ANTTX_EVENT_SetDefault[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   { /* 0  */ LTE_MIPI_ANT  , { 0    , 0    }, LTE_MIPI_TRX_ON    , LTE_FDD_MIPI_ANT_TX_ON0_SetDefault  }, //PA On
...
LTE_MIPI_EVENT_TABLE_T LTE_Band21_MIPI_ANTTX_EVENT_SetDefault[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   //{ /* 0  */ LTE_MIPI_ANT  , { 0    , 0    }, LTE_MIPI_TRX_ON    , LTE_FDD_MIPI_ANT_TX_ON0_SetDefault  }, //PA On
...
LTE_MIPI_EVENT_TABLE_T LTE_Band22_MIPI_ANTTX_EVENT_SetDefault[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   //{ /* 0  */ LTE_MIPI_ANT  , { 0    , 0    }, LTE_MIPI_TRX_ON    , LTE_FDD_MIPI_ANT_TX_ON0_SetDefault  }, //PA On
...
LTE_MIPI_EVENT_TABLE_T LTE_Band25_MIPI_ANTTX_EVENT_SetDefault[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   { /* 0  */ LTE_MIPI_ANT  , { 0    , 0    }, LTE_MIPI_TRX_ON    , LTE_FDD_MIPI_ANT_TX_ON0_SetDefault  }, //PA On
...
LTE_MIPI_EVENT_TABLE_T LTE_Band27_MIPI_ANTTX_EVENT_SetDefault[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   //{ /* 0  */ LTE_MIPI_ANT  , { 0    , 0    }, LTE_MIPI_TRX_ON    , LTE_FDD_MIPI_ANT_TX_ON0_SetDefault  }, //PA On
...
LTE_MIPI_EVENT_TABLE_T LTE_Band29_MIPI_ANTTX_EVENT_SetDefault[] =    /* This is only used to create a dummy one */
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   //{ /* 0  */ LTE_MIPI_ANT  , { 0    , 0    }, LTE_MIPI_TRX_ON    , LTE_FDD_MIPI_ANT_TX_ON0_SetDefault  }, //PA On
...
LTE_MIPI_EVENT_TABLE_T LTE_Band32_MIPI_ANTTX_EVENT_SetDefault[] =    /* This is only used to create a dummy one */
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   //{ /* 0  */ LTE_MIPI_ANT  , { 0    , 0    }, LTE_MIPI_TRX_ON    , LTE_FDD_MIPI_ANT_TX_ON0_SetDefault  }, //PA On
...
LTE_MIPI_EVENT_TABLE_T LTE_Band42_MIPI_ANTTX_EVENT_SetDefault[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   //{ /* 0  */ LTE_MIPI_ANT  , { 0    , 0    }, LTE_MIPI_TRX_ON    , LTE_TDD_MIPI_ANT_TX_ON0_SetDefault  }, //PA On
...
LTE_MIPI_EVENT_TABLE_T LTE_Band43_MIPI_ANTTX_EVENT_SetDefault[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   //{ /* 0  */ LTE_MIPI_ANT  , { 0    , 0    }, LTE_MIPI_TRX_ON    , LTE_TDD_MIPI_ANT_TX_ON0_SetDefault  }, //PA On
...
LTE_MIPI_EVENT_TABLE_T LTE_Band44_MIPI_ANTTX_EVENT_SetDefault[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   //{ /* 0  */ LTE_MIPI_ANT  , { 0    , 0    }, LTE_MIPI_TRX_ON    , LTE_TDD_MIPI_ANT_TX_ON0_SetDefault  }, //PA On
...
LTE_MIPI_EVENT_TABLE_T LTE_Band71_MIPI_ANTTX_EVENT_SetDefault[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
...
LTE_MIPI_EVENT_TABLE_T LTE_Band252_MIPI_ANTTX_EVENT_SetDefault[] =    /* This is only used to create a dummy one */
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   //{ /* 0  */ LTE_MIPI_ANT  , { 0    , 0    }, LTE_MIPI_TRX_ON    , LTE_FDD_MIPI_ANT_TX_ON0_SetDefault  }, //PA On
...
LTE_MIPI_EVENT_TABLE_T LTE_Band255_MIPI_ANTTX_EVENT_SetDefault[] =    /* This is only used to create a dummy one */
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   //{ /* 0  */ LTE_MIPI_ANT  , { 0    , 0    }, LTE_MIPI_TRX_ON    , LTE_FDD_MIPI_ANT_TX_ON0_SetDefault  }, //PA On
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band9_MIPI_ANTTX_DATA_SetDefault[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band11_MIPI_ANTTX_DATA_SetDefault[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band18_MIPI_ANTTX_DATA_SetDefault[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band19_MIPI_ANTTX_DATA_SetDefault[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band21_MIPI_ANTTX_DATA_SetDefault[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band22_MIPI_ANTTX_DATA_SetDefault[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band25_MIPI_ANTTX_DATA_SetDefault[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band27_MIPI_ANTTX_DATA_SetDefault[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band29_MIPI_ANTTX_DATA_SetDefault[] =    /* Dummy one */
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band32_MIPI_ANTTX_DATA_SetDefault[] =    /* Dummy one */
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
   //{ /* 0  */ LTE_MIPI_ANT  , LTE_MIPI_PORT2    , LTE_REG_W     , MIPI_USID_ANT0_SetDefault,{ { 23050 /*100 kHz*/ ,0x00 ,0x01 }, { 23075 /*100 kHz*/ ,0x00 ,0x01 }, { 23100 /*100 kHz*/ ,0x00 ,0x01 }, { 23125 /*100 kHz*/ ,0x00 ,0x01 }, { 23150 /*100 kHz*/ ,0x00 ,0x01 },} }, // PA On PM_Trig: normal mode
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band42_MIPI_ANTTX_DATA_SetDefault[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band43_MIPI_ANTTX_DATA_SetDefault[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band44_MIPI_ANTTX_DATA_SetDefault[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band71_MIPI_ANTTX_DATA_SetDefault[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band252_MIPI_ANTTX_DATA_SetDefault[] =    /* Dummy one */
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band255_MIPI_ANTTX_DATA_SetDefault[] =    /* Dummy one */
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
   //{ /* 0  */ LTE_MIPI_ANT  , LTE_MIPI_PORT2    , LTE_REG_W     , MIPI_USID_ANT0_SetDefault    ,{ { 24960 /*100 kHz*/ ,0x1C ,0x38 }, { 25445 /*100 kHz*/ ,0x1C ,0x38 }, { 25930 /*100 kHz*/ ,0x1C ,0x38 }, { 26415 /*100 kHz*/ ,0x1C ,0x38 }, { 26900 /*100 kHz*/ ,0x1C ,0x38 },} }, // PA On PM_Trig: normal mode
   { /* 6  */ LTE_MIPI_NULL, 0                 , 0             , 0                ,{ {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    },} },
