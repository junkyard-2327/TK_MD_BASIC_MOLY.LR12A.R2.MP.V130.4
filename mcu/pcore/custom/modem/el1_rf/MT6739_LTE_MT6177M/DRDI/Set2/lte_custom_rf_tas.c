...
LTE_MIPI_EVENT_TABLE_T LTE_TAS_CAT_A_CONFIG0_MIPI_EVENT_Set2[] =
{
...
LTE_MIPI_EVENT_TABLE_T LTE_TAS_CAT_A_CONFIG1_MIPI_EVENT_Set2[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
...
LTE_MIPI_EVENT_TABLE_T LTE_TAS_CAT_A_CONFIG2_MIPI_EVENT_Set2[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
...
LTE_MIPI_EVENT_TABLE_T LTE_TAS_CAT_A_CONFIG3_MIPI_EVENT_Set2[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
...
LTE_MIPI_DATA_TABLE_T LTE_TAS_CAT_A_CONFIG0_MIPI_DATA_Set2[] =
{
...
LTE_MIPI_DATA_TABLE_T LTE_TAS_CAT_A_CONFIG1_MIPI_DATA_Set2[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID                       , addr, data 
...
LTE_MIPI_DATA_TABLE_T LTE_TAS_CAT_A_CONFIG2_MIPI_DATA_Set2[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID                       , addr, data 
...
LTE_MIPI_DATA_TABLE_T LTE_TAS_CAT_A_CONFIG3_MIPI_DATA_Set2[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID                       , addr, data 
...
LTE_MIPI_EVENT_TABLE_T LTE_TAS_CAT_B_CONFIG0_MIPI_EVENT_Set2[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
...
LTE_MIPI_EVENT_TABLE_T LTE_TAS_CAT_B_CONFIG1_MIPI_EVENT_Set2[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
...
LTE_MIPI_EVENT_TABLE_T LTE_TAS_CAT_B_CONFIG2_MIPI_EVENT_Set2[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
...
LTE_MIPI_EVENT_TABLE_T LTE_TAS_CAT_B_CONFIG3_MIPI_EVENT_Set2[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
...
LTE_MIPI_DATA_TABLE_T LTE_TAS_CAT_B_CONFIG0_MIPI_DATA_Set2[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID                       , addr, data 
   { /* 0  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_TAS_Set2   , 0xFF, 0x01 } ,
   { /* 1  */ LTE_MIPI_NULL, 0                 , 0             , 0                          , 0   , 0    } ,
...
LTE_MIPI_DATA_TABLE_T LTE_TAS_CAT_B_CONFIG1_MIPI_DATA_Set2[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID                       , addr, data 
   { /* 0  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_TAS_Set2   , 0xFF, 0x11 } ,
   { /* 1  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_TAS_Set2   , 0xFF, 0x12 } ,
...
LTE_MIPI_DATA_TABLE_T LTE_TAS_CAT_B_CONFIG2_MIPI_DATA_Set2[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID                       , addr, data 
   { /* 0  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_TAS_Set2   , 0xFF, 0x21 } ,
   { /* 1  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_TAS_Set2   , 0xFF, 0x22 } ,
...
LTE_MIPI_DATA_TABLE_T LTE_TAS_CAT_B_CONFIG3_MIPI_DATA_Set2[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID                       , addr, data 
   { /* 0  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_TAS_Set2   , 0xFF, 0x31 } ,
   { /* 1  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_TAS_Set2   , 0xFF, 0x32 } ,
...
LTE_MIPI_EVENT_TABLE_T LTE_TAS_CAT_C_CONFIG0_MIPI_EVENT_Set2[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   { /* 0  */ LTE_MIPI_TAS , { 0    , 0    }, LTE_MIPI_TRX_ON    , LTE_MIPI_TAS_ON_Set2 },
...
LTE_MIPI_EVENT_TABLE_T LTE_TAS_CAT_C_CONFIG1_MIPI_EVENT_Set2[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   { /* 0  */ LTE_MIPI_TAS , { 0    , 0    }, LTE_MIPI_TRX_ON    , LTE_MIPI_TAS_ON_Set2 },
...
LTE_MIPI_EVENT_TABLE_T LTE_TAS_CAT_C_CONFIG2_MIPI_EVENT_Set2[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   { /* 0  */ LTE_MIPI_TAS , { 0    , 0    }, LTE_MIPI_TRX_OFF    , LTE_MIPI_TAS_ON_Set2 },
...
LTE_MIPI_EVENT_TABLE_T LTE_TAS_CAT_C_CONFIG3_MIPI_EVENT_Set2[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   { /* 0  */ LTE_MIPI_TAS , { 0    , 3    }, LTE_MIPI_TRX_ON    , LTE_MIPI_TAS_ON_Set2 },
...
LTE_MIPI_DATA_TABLE_T LTE_TAS_CAT_C_CONFIG0_MIPI_DATA_Set2[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID                       , addr, data 
   { /* 0  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_TAS_Set2   , 0xFF, 0x01 } ,
...
LTE_MIPI_DATA_TABLE_T LTE_TAS_CAT_C_CONFIG1_MIPI_DATA_Set2[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID                       , addr, data 
   { /* 0  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_TAS_Set2   , 0xFF, 0x11 } ,
   { /* 1  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_TAS_Set2   , 0xFF, 0x12 } ,
...
LTE_MIPI_DATA_TABLE_T LTE_TAS_CAT_C_CONFIG2_MIPI_DATA_Set2[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID                       , addr, data 
   { /* 0  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_TAS_Set2   , 0xFF, 0x31 } ,
   { /* 1  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_TAS_Set2   , 0xFF, 0x32 } ,
...
LTE_MIPI_DATA_TABLE_T LTE_TAS_CAT_C_CONFIG3_MIPI_DATA_Set2[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID                       , addr, data 
...
LTE_MIPI_EVENT_TABLE_T LTE_TAS_CAT_CONFIG_NULL_MIPI_EVENT_Set2[] =                         
{                                                                                               
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */    
   /*                        { start, stop },                      ( us )                 */    
   { /* 1  */ LTE_MIPI_NULL, { 0    , 0    }, LTE_MIPI_EVENT_NULL, 0                          },
...
LTE_MIPI_DATA_TABLE_T LTE_TAS_CAT_CONFIG_NULL_MIPI_DATA_Set2[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             , addr, data 
