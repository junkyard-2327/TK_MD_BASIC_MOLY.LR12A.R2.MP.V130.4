...
LTE_MIPI_EVENT_TABLE_T LTE_Route25_MIPI_TX_EVENT_Set1[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Route25_MIPI_TX_DATA_Set1[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID                        ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
LTE_MIPI_EVENT_TABLE_T LTE_Route26_MIPI_TX_EVENT_Set1[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Route26_MIPI_TX_DATA_Set1[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID                       ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
/* TPC */
LTE_MIPI_EVENT_TABLE_T LTE_Route25_MIPI_TPC_EVENT_Set1[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset    */
   /*                        { start, stop },                      ( us )        */
...
LTE_MIPI_DATA_TABLE_T LTE_Route25_MIPI_TPC_DATA_Set1[] =
{
...
LTE_MIPI_TPC_SECTION_TABLE_T LTE_Route25_MIPI_PA_SECTION_DATA_Set1[] =
{
   {
      18800, /*100kHz*/
