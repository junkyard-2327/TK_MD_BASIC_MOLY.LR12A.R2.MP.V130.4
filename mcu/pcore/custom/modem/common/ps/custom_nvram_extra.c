...
kal_bool custom_sat_clear_loci_rplmn_on_sat_refresh(void)
{
     ...
     * KAL_FALSE: don't clear RPLMN while clearing LOCI files
     */
    return KAL_FALSE;
}
...
kal_uint16 sml_Nvram_get_lid_size(kal_uint16 file_idx)
{
    ...
    switch(file_idx)
    {
        ...
        return sizeof(sml_sl_odm_data_struct);
...
void sml_init_sml_obj(kal_uint8 source)
{
	...
	if (sbp_query_md_feature_by_ps(SBP_ENABLE_SUBSIDY_LOCK, PROTOCOL_1) == KAL_TRUE)
	{
