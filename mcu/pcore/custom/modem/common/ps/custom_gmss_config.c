...
const kal_uint16 GMSS_CUSTOM_SPRINT_MPSR_TIMER_VALUE_SECS  = 2*60; // default 2 mintues
const kal_uint16 GMSS_CUSTOM_NON_SRLTE_MPSR_TIMER_VALUE_SECS[CUSTOM_NON_SRLTE_MPSR_TIMER_NUM] = 
{
    //The unit is seconds
    2*60, 15*60, 60*60
}; 
