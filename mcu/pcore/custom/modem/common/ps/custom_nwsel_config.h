...
extern const nwsel_rat_enum custom_power_on_search_rat[NWSEL_RAT_ENTRY_NUM];
extern const nwsel_rat_enum custom_roaming_fullband_rat[NWSEL_RAT_ENTRY_NUM];
extern const nwsel_rat_enum custom_quick_search_rat[NWSEL_RAT_ENTRY_NUM];
...
extern const kal_uint8 NWSEL_ECC_SEARCH_DURING_SUSPEND_SEARCH_RETRY_COUNTER_MAX; 
...
extern kal_bool nwsel_custom_allow_rplmn_hplmn_combined_search(kal_uint8 sim_interface); 
...
extern kal_bool nwsel_custom_is_disable_eutran_after_reject_with_cause(nwsel_disable_eutran_cause_enum cause, mm_cause_enum emm_cause);
...
extern kal_bool nwsel_custom_trigger_ivsr_after_sim_invalid(kal_bool is_registered_before, kal_bool is_trigger_ivsr_needed, kal_bool is_ivsr_after_guard_timer, kal_bool is_test_sim, mm_cause_enum cause);
