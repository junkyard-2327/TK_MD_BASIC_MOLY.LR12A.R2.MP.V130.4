													        ...
													        kal_char	*mccmnc )
{
	...
	kal_uint32 atcmd_request_ps_only_table[] = {01, 02, 03, 05, 06, 07, 9, 15, 16, 18, 19, 50, 107, 117, 120, 148, 154, 157, 201, 204, 221, 224, 238};
	kal_uint32 index;
    ...
    /*Special case for H3G-Sweden/H3G-Denmark/H3G-Austria/Rogers-Canada  Entel/Chile TIM/Brazil: support XCAP only or 2/3/4G*/
    if ((0 == (kal_mem_cmp(mccmnc, "24002", 5))) || (0 == (kal_mem_cmp(mccmnc, "23806", 5))) || (0 == (kal_mem_cmp(mccmnc, "22201", 5)))||
        (0 == (kal_mem_cmp(mccmnc, "21603", 5))) ||
        (0 == (kal_mem_cmp(mccmnc, "23205", 5))) || (0 == (kal_mem_cmp(mccmnc, "23210", 5))) || (0 == (kal_mem_cmp(mccmnc, "23203", 5))) ||
        (0 == (kal_mem_cmp(mccmnc, "23207", 5))) || (0 == (kal_mem_cmp(mccmnc, "73001", 5))) || (0 == (kal_mem_cmp(mccmnc, "73010", 5))) ||
        (0 == (kal_mem_cmp(mccmnc, "72402", 5))) || (0 == (kal_mem_cmp(mccmnc, "72403", 5))) || (0 == (kal_mem_cmp(mccmnc, "72404", 5))) ||
        (0 == (kal_mem_cmp(mccmnc, "29341", 5))))
    {
        ret_value = KAL_TRUE;
    }
...
kal_bool  _custom_ssds_cs_only_path_variable( kal_uint32 op_id,
                                              kal_char   *mccmnc)
{
    kal_uint32 atcmd_request_cs_only_table[] = { 12, 17, 20, 100, 101, 102, 104, 106, 108, 110, 111, 112, 114, 115, 116, 122,
                                                 125, 126, 127, 131, 135, 143, 147, 149, 151, 163, 165, 176, 183, 184, 185, 187,
                                                 189, 191, 192, 210, 211, 245, 216, 275, 282};
    kal_uint32    index;
    kal_bool      ret_value = KAL_FALSE;
    ...
    if ((0 == (kal_mem_cmp(mccmnc, "26003", 5))) || (0 == (kal_mem_cmp(mccmnc, "28602", 5))) ||
        ...
        (0 == (kal_mem_cmp(mccmnc, "74807", 5))) || (0 == (kal_mem_cmp(mccmnc, "28405", 5))) ||
        (0 == (kal_mem_cmp(mccmnc, "334090", 6)))|| (0 == (kal_mem_cmp(mccmnc, "334050", 6)))||
        (0 == (kal_mem_cmp(mccmnc, "41006", 5))) || (0 == (kal_mem_cmp(mccmnc, "26001", 5))) ||
        (0 == (kal_mem_cmp(mccmnc, "24214", 5))) || (0 == (kal_mem_cmp(mccmnc, "37001", 5))) ||
        (0 == (kal_mem_cmp(mccmnc, "23201", 5))))
    {
        ret_value = KAL_TRUE;
    }
                                             ...
                                             )
{
    ...
    if ((op_id == 3) || ((op_id == 7)&&(0!=(kal_mem_cmp(mccmnc, "334090", 6)))&&(0!=(kal_mem_cmp(mccmnc, "334050", 6)))) || (op_id == 8) ||
        (op_id == 15) || (op_id == 16) || (op_id == 50) || (op_id == 107) || (op_id == 113) || (op_id == 157) ||
        (op_id == 117) || (op_id == 118) || (op_id == 121) || (op_id == 124) || (op_id == 127) || (op_id == 128) || (op_id == 134) ||
        (op_id == 135) || (op_id == 148) || (op_id == 150) || (op_id == 152) || (op_id == 161) || (op_id == 103) ||
        (op_id == 154) || (op_id == 162) || (op_id == 181) || (op_id == 183) || (op_id == 199) || (op_id == 204) || (op_id == 219) ||
        (op_id == 238) || (op_id == 279) || (0 == (kal_mem_cmp(mccmnc, "24201", 5))))
    {
        if (CUSTOM_SSDS_ATCMD_TYPE_SET_CLIR == atcmd_info->atcmd_type)
        {
            *atcmd_req_type = CUSTOM_SSDS_PATH_TYPE_CS_ONLY_ALWAYS;
    ...
    {/* For Voda-IND, Airtel-IND, BSNL-IND, Mobitel-Srilanka:
                                           ...
                                           )
{
    ...
    else if((op_id == 8)||(op_id == 114)||(op_id == 115)||(op_id == 116)||(op_id == 148)||(op_id == 157)||
        (op_id == 201)||(op_id == 204) || (op_id == 216) || (op_id == 238)||(0 == (kal_mem_cmp(mccmnc, "25020", 5))))
    {/* Per TMOUS Spec and Rogers/Canada and KPN Netherlands, Zong-Pakistan Call barring should not be supported in XCAP/Ut and CS domain */
        *atcmd_req_type = CUSTOM_SSDS_PATH_TYPE_OPERATION_NOT_SUPPORTED_4;
        return  KAL_TRUE;
    }
    else if((op_id == 139)||(0 == (kal_mem_cmp(mccmnc, "73002", 5)))||(0 == (kal_mem_cmp(mccmnc, "20416", 5)))||
        (0 == (kal_mem_cmp(mccmnc, "20420", 5)))||(0 == (kal_mem_cmp(mccmnc, "20404", 5)))||(0 == (kal_mem_cmp(mccmnc, "732123", 6)))||
        (0 == (kal_mem_cmp(mccmnc, "22001", 5))))
    {/* Per Bouygues/France,Movistar/Chile,Movistar/Colombia,DTAG/Netherlands,VDF/Netherlands,Telenor/Serbia Call barring is supported just in CS domain */
        *atcmd_req_type = CUSTOM_SSDS_PATH_TYPE_CS_ONLY;
        return  KAL_TRUE;
    }
                                           ...
                                           )
{
    ...
    if (is_ims_registered == KAL_TRUE)
    {
        if (((op_id == 7)&&(0!=(kal_mem_cmp(mccmnc, "334090", 6)))&&(0!=(kal_mem_cmp(mccmnc, "334050", 6))))||
           (op_id == 50) || ((op_id == 137)&&(0!=(kal_mem_cmp(mccmnc, "24007", 5)))) || (op_id == 103) ||
           (op_id == 113) || (op_id == 152) || (op_id == 178) || (op_id == 186) || (op_id == 195) ||
           (op_id == 202) || (op_id == 219) || (op_id == 232) ||
           ...
           (0 == (kal_mem_cmp(mccmnc, "25915", 5))) || (0 == (kal_mem_cmp(mccmnc, "21601", 5)))||
           (0 == (kal_mem_cmp(mccmnc, "26006", 5))) || (0 == (kal_mem_cmp(mccmnc, "23806", 5))))
        {
            *atcmd_req_type = CUSTOM_SSDS_PATH_TYPE_PS_ONLY;
        }
        ...
        else if (0 == (kal_mem_cmp(mccmnc, "71606", 5)))
        {
            ...
            (op_id == 176) || (op_id == 151) || (op_id == 210) || (op_id == 183) ||
            (0 == (kal_mem_cmp(mccmnc, "20610", 5))) || (0 == (kal_mem_cmp(mccmnc, "21403", 5))) ||
            (0 == (kal_mem_cmp(mccmnc, "23101", 5))) || (0 == (kal_mem_cmp(mccmnc, "334030", 6)))||
            (0 == (kal_mem_cmp(mccmnc, "33403", 5))) || (0 == (kal_mem_cmp(mccmnc, "74810", 5))) ||
            (0 == (kal_mem_cmp(mccmnc, "722310", 6)))|| (0 == (kal_mem_cmp(mccmnc, "722320", 6)))||
            (0 == (kal_mem_cmp(mccmnc, "722330", 6)))|| (0 == (kal_mem_cmp(mccmnc, "722010", 6)))||
            (0 == (kal_mem_cmp(mccmnc, "722070", 6)))|| (0 == (kal_mem_cmp(mccmnc, "72207", 5))) ||
        ...
        {/* terminal based when ims registered for non CS only operator and
          * OP176/OP151/Telenor BG/A1 Austria/Orange Belgium, Slovakia */
    ...
    {/* cs only default if ims not registered  */
        *atcmd_req_type = CUSTOM_SSDS_PATH_TYPE_CS_ONLY;
        ...
        else if (((op_id == 7)&& (0 != (kal_mem_cmp(mccmnc, "334090", 6))) && (0 != (kal_mem_cmp(mccmnc, "334050", 6)))) || (op_id == 50) ||
            (0 == (kal_mem_cmp(mccmnc, "23205", 5))) || (0 == (kal_mem_cmp(mccmnc, "23210", 5))))
        {
            *atcmd_req_type = CUSTOM_SSDS_PATH_TYPE_PS_ONLY;
        }
        else if ((op_id == 3) || ((op_id == 6) && (0 != (kal_mem_cmp(mccmnc, "22210", 5)))) || (op_id == 15) || (op_id == 107) || (op_id == 151) ||(op_id == 160) ||
     ...
     * MTS/Russia(135), KPN Netherlands(201), Telus/Canada(157), JTL/Kenya(200), C&W/Panama(211), TurkCell/Turkey(143), Lifecell/Ukraine(275)
     * Digi/Malaysia(50216), Telcel/Mexico(334020), Claro/Colombia(732101), Telenor Sweden(24008), Claro Chile(73003),
     * Telefonica Spain (21405/21407), TIM/Italy(22201), VHA(153, if WFC registered and RF OFF) , Telkomsel/Indonesia(224)*/
    if ((op_id == 16) || (op_id == 104) || (op_id == 109) || (op_id == 122) || (op_id == 125) || (op_id == 131) ||
        (op_id == 135) || (op_id == 143) ||(op_id == 157) || (op_id == 164) ||  (op_id == 200) || (op_id == 201) ||
        (op_id == 211) || (op_id == 224) || (op_id == 238) || (op_id == 275) || (op_id == 279) || (op_id == 282) ||
        ...
        (0 == (kal_mem_cmp(mccmnc, "51503", 5)))  || (0 == (kal_mem_cmp(mccmnc, "24601", 5))) || 
        (0 == (kal_mem_cmp(mccmnc, "21405", 5)))  || (0 == (kal_mem_cmp(mccmnc, "21407", 5))) ||
                                           ...
                                           )
{
    ...
    {/* Telenor-Pakistan:
        1) Set CF: terminal based; CME Error:4 greys out COLP settings
        2) Get CF: NW based to avoid invalid pop-up on MMI query */
    ...
    if (KAL_FALSE == is_ims_registered)
    {
        ...
        else if (op_id == 5)
        {
            ...
            else
            {
                ...
                else if (atcmd_info->atcmd_type == CUSTOM_SSDS_ATCMD_TYPE_GET_CLIR)
                {
                    *csfb_type = CUSTOM_SSDS_CSFB_TYPE_NO_832;
                }
            }
                                                         ...
                                                         )
{
   ...
   if(KAL_TRUE == _custom_ssds_ps_only_path_variable(op_id, req_info->mccmnc))
   {
    ...
    ret_value = _custom_ssds_get_path_variable(op_id, req_info->mccmnc, is_ims_registered, ims_domain, roaming_status, rf_status,is_mobile_data_setting_enabled, ps_status, atcmd_info, &special_atcmd_req_type);
	...
	{
	  /* Movistar Argentina will chose CS when data off*/
    ...
    {
        /*2.CT roaming to HK;3.Umobile not support Ut/XCAP in roaming NW;
          4.Optus-Australia ; 5.Avantel/Colombia; 6.Wind/Italy; 7.Vodafone/Egypt not support Ut/XCAP in roaming NW
          8.Freedom/Canada; 9.Mobitel-Srilanka 10.Movistar/Colombia not support Ut/XCAP in roaming NW */
        if((op_id == 152)||(op_id == 162)||(op_id == 164)||(op_id == 189)||(op_id == 209)||(op_id == 219)||(op_id == 232)||
		  ((KAL_TRUE == req_info->is_ct_card) && (0 == (kal_mem_cmp(req_info->mccmnc, "20404", 5)))) ||
		  (0 == (kal_mem_cmp(req_info->mccmnc, "22288", 5))) || (0 == (kal_mem_cmp(req_info->mccmnc, "60202", 5))) ||
                                                         ...
                                                         )
{
	...
	req_path_type = _custom_ssds_get_req_path_variable(req_info, op_id, is_ims_registered, ims_domain, roaming_status, rf_status, is_mobile_data_setting_enabled, ps_status, atcmd_info);
                                           ...
                                           kal_bool                     *trigger_ims_dereg)
{
    ...
    /* Special case for SmartFren(CDMA solution) and RJIL(4G only solution), Seatel(4G only solution), TPG-Singapore(4G only solution) */
                                          ...
                                          module_type module_id)
{
    *pdn_rat_type = CUSTOM_SSDS_PDN_RAT_TYPE_ANY;
    ...
    else if ((0 == (kal_mem_cmp(req_info->mccmnc, "72207", 5))) || ((136==op_id) && (0 != (kal_mem_cmp(req_info->mccmnc, "73001", 5))) &&
    ...
    else if ((0 == (kal_mem_cmp(req_info->mccmnc, "33403", 5)))|| (0 == (kal_mem_cmp(req_info->mccmnc, "334030", 6))))
    {
        *pdn_type = CUSTOM_SSDS_PDN_TYPE_INTERNET;
        return;
    }
