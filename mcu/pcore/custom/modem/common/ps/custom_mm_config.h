...
extern kal_uint8 mm_custom_get_customize_cause(protocol_id_enum ps_id,kal_uint8 cause, mm_custom_proc_type proc, kal_bool is_on_hplmn, kal_bool is_test, kal_bool convert_vplmn_ps_cause7to15);
...
extern kal_uint8 mm_custom_get_cs_reg_identity_count_value(void);

extern kal_uint8 gmm_custom_get_ps_reg_identity_count_value(void);
