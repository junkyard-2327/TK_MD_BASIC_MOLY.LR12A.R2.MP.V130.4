...
iwlan_cust_cfg_t iwlan_cust_init(kal_uint32 op_id, protocol_id_enum ps_id, kal_char *sim_mcc, kal_char *sim_mnc, kal_bool *nv_valid)
{
    ...
    switch(op_id)
    {
        ...
        case 145: /* Cricket */			
        {
            ...
            cfg.wans_cfg.sig_cfg.md_sig_thr_cfg.wans_lte_rssnr_fair_th = -3;  
    		...
    		cfg.wans_cfg.sig_cfg.md_sig_thr_cfg.wans_umts_ecno_fair_th      = -15;
			cfg.wans_cfg.sig_cfg.md_sig_thr_cfg.wans_gsm_rssi_poor_th   = -102;
            cfg.wans_cfg.sig_cfg.md_sig_thr_cfg.wans_gsm_rssi_fair_th   = -94;
            ...
            cfg.wans_cfg.qos_cfg.qos_rtp_cfg.wans_rtp_qos_enable                = KAL_TRUE;
            cfg.wans_cfg.qos_cfg.qos_rtp_cfg.wans_ims_rtp_wlan_qos_bkoff_t      = 120; //s
        ...
        case 8: /* TMOUS */
        {
            ...
            cfg.wans_cfg.wans_ims_evs_call_thr_offset = -2; // -2 dbm
        ...
        case 20: /* Sprint */
        {
            cfg.wans_cfg.wans_ims_md_supporting_rat           = 0x21; // LTE and eHRPD
            cfg.wans_cfg.wans_ims_vops_barring_enable   = KAL_FALSE; //for SMS
            cfg.wans_cfg.wans_ims_vops_setup_barring_enable         = KAL_FALSE;
            cfg.wans_cfg.throttling_cfg.wans_throttling_wlan_enable = KAL_TRUE;
            cfg.wans_cfg.throttling_cfg.wans_wrovein_throttling_t = 120;
            cfg.wans_cfg.wans_ims_roaming_barring_enable      = KAL_TRUE;
            cfg.wans_cfg.loc_cfg.wans_location_enable         = KAL_FALSE;
            cfg.wans_cfg.loc_cfg.wans_ims_wlan_no_location_barring_enable         = KAL_TRUE;
		...
		case 213: /* Motiv */
		{
			/* Russia */
			cfg.wans_cfg.wans_xcap_epdg_connected_epdg_barring_enable = KAL_TRUE;  
			cfg.wans_cfg.wans_xcap_cell_only_barring_enable			  = KAL_TRUE; 
			break;
		}
        case 214: /* IDC */
        {
        ...
        case 1001: /* Ericsson IMS IWLAN */
        {
            ...
            cfg.wans_cfg.wans_ims_23G_setup_barring_enable = KAL_FALSE;
            cfg.wans_cfg.qos_cfg.qos_rtp_cfg.wans_rtp_qos_enable                = KAL_TRUE;
            cfg.wans_cfg.qos_cfg.qos_rtp_cfg.wans_wlan_rtp_sampling_duration    = 5; //if default turn off, it should be 0
            break;
        }
