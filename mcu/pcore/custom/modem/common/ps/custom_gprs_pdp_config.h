...
extern kal_bool custom_need_to_modify_user_configured_qos_delivery_order_value(pdp_addr_type_enum pdp_type, kal_bool is_use_test_sim, kal_uint8 * suggested_value, kal_bool is_qos_subscribed);
