...
#define UMTS_MIPI_ETM_CUSTOM_DATA(sET)    \
{                                         \
   UMTS_MIPI_ETM_TX_EVENT_TABLE_##sET,    \
   UMTS_MIPI_ETM_TX_DATA_TABLE_##sET,     \
   UMTS_MIPI_ETM_TPC_EVENT_TABLE_##sET,   \
   UMTS_MIPI_ETM_TPC_DATA_TABLE_##sET     \
}
...
extern const Ul1CustomDynamicInitMipiEtmData ul1CustomMipiEtmData[ UL1CUSTOM_TOTAL_REAL_SET_NUMS ];
#endif
