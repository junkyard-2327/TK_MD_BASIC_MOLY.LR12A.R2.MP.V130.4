 ...
 ***************************************************************************/
#if( defined( IS_MML1_ETM_FRONT_END_ENABLE_Set2 ) && ( IS_MML1_ETM_FRONT_END_ENABLE_Set2 == 1 ) )

// Do not modify MML1_ETM_INFO_TABLE context directly, please modify the settings in the header file.
const MML1_ETM_INFORMATION_T MML1_ETM_INFO_TABLE_Set2[ MML1_MIPI_ETM_MAX_SUPPORT_NUM ] =
{
   { { MML1_ETM0_MIPI_PORT_Set2, MIPI_ETM0_USID_Set2 }, MML1_ETM0_ET_DAC_INDEX_Set2 },
};

const MML1_MIPI_SIMPLE_INITIAL_CW_T MML1_MIPI_ETM_INITIAL_CW_Set2[ MML1_MIPI_ETM_MAX_INITIAL_CW_NUM ] =
{
...
const MML1_ETM_INFORMATION_T MML1_ETM_INFO_TABLE_Set2[ MML1_MIPI_ETM_MAX_SUPPORT_NUM ] =
{
   { { MML1_ETM0_MIPI_PORT_Set2, MIPI_ETM0_USID_Set2 }, ET_DAC_INDEX_NULL },
};
...
#endif   // #if( defined( IS_MML1_ETM_FRONT_END_ENABLE_Set2 ) && ( IS_MML1_ETM_FRONT_END_ENABLE_Set2 == 1 ) )
