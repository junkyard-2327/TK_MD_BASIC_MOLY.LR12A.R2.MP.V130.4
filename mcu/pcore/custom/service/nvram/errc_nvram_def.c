...
#error "ROHC_MAX_NUMBER_CONTEXT_SESSION_ENUM should lie in [0, 13]"
    ...
    //__LTE_R11__
        ...
        {//otdoa_pos_cap_r10
            ...
            0x00, //otdoa_ue_assisted_r10, not turn on until MP2
            0x00  //inter_freq_rstd_meas_r10, not turn on until MP2
#else
        ...
        0xC03C0000, //feature_group_ind_r10_fdd
        0xC03C0000, //feature_group_ind_r10_tdd
