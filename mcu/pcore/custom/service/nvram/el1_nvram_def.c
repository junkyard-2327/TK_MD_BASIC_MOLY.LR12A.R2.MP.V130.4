...
ltable_entry_struct logical_data_item_table_el1[] =
{
   ...
   #if __IS_EL1D_ET_SUPPORT__
   {
      ...
      NVRAM_EF_EL1_LTE_ET_CAL_DATA_TOTAL,
      NVRAM_EF_EL1_LTE_ET_CAL_DATA_SIZE,
      NVRAM_NORMAL(NVRAM_EF_ZERO_DEFAULT),
      NVRAM_CATEGORY_CALIBRAT,
      NVRAM_ATTR_AVERAGE,
      "EL50",
      VER(NVRAM_EF_EL1_LTE_ET_CAL_DATA_LID)
   },
   {
      NVRAM_EF_EL1_LTE_ET_CAL_DATA_CCA_LID,
      NVRAM_EF_EL1_LTE_ET_CAL_DATA_CCA_TOTAL,
      NVRAM_EF_EL1_LTE_ET_CAL_DATA_CCA_SIZE,
      NVRAM_NORMAL(NVRAM_EF_ZERO_DEFAULT),
      NVRAM_CATEGORY_CALIBRAT,
      NVRAM_ATTR_AVERAGE,
      "EL51",
      VER(NVRAM_EF_EL1_LTE_ET_CAL_DATA_CCA_LID)
   },
   {
      NVRAM_EF_EL1_LTE_ET_CAL_DATA_FILTER_LID,
      NVRAM_EF_EL1_LTE_ET_CAL_DATA_FILTER_TOTAL,
      NVRAM_EF_EL1_LTE_ET_CAL_DATA_FILTER_SIZE,
      NVRAM_NORMAL(NVRAM_EF_ZERO_DEFAULT),
      NVRAM_CATEGORY_CALIBRAT,
      NVRAM_ATTR_AVERAGE,
      "EL52",
      VER(NVRAM_EF_EL1_LTE_ET_CAL_DATA_FILTER_LID)
   },
   {
      NVRAM_EF_EL1_LTE_ET_CAL_DATA_FILTER_CCA_LID,
      NVRAM_EF_EL1_LTE_ET_CAL_DATA_FILTER_CCA_TOTAL,
      NVRAM_EF_EL1_LTE_ET_CAL_DATA_FILTER_CCA_SIZE,
      NVRAM_NORMAL(NVRAM_EF_ZERO_DEFAULT),
      NVRAM_CATEGORY_CALIBRAT,
      NVRAM_ATTR_AVERAGE,
      "EL53",
      VER(NVRAM_EF_EL1_LTE_ET_CAL_DATA_FILTER_CCA_LID)
   },
   
   //MANUAL PARAMETER
   {
      NVRAM_EF_EL1_LTE_ET_MANUAL_PARAMETER_LID,
      NVRAM_EF_EL1_LTE_ET_MANUAL_PARAMETER_TOTAL,
      NVRAM_EF_EL1_LTE_ET_MANUAL_PARAMETER_SIZE,
      NVRAM_DEFAULT_FUNC(nvram_get_eL1_default_value_to_write_with_record),
      NVRAM_CATEGORY_USER,
      NVRAM_ATTR_OTA_RESET,
      "EL54",
      VER(NVRAM_EF_EL1_LTE_ET_MANUAL_PARAMETER_LID)
   },
   {
      NVRAM_EF_EL1_LTE_ET_MANUAL_PARAMETER_CCA_LID,
      NVRAM_EF_EL1_LTE_ET_MANUAL_PARAMETER_CCA_TOTAL,
      NVRAM_EF_EL1_LTE_ET_MANUAL_PARAMETER_CCA_SIZE,
      NVRAM_DEFAULT_FUNC(nvram_get_eL1_default_value_to_write_with_record),
      NVRAM_CATEGORY_USER,
      NVRAM_ATTR_OTA_RESET,
      "EL55",
      VER(NVRAM_EF_EL1_LTE_ET_MANUAL_PARAMETER_CCA_LID)
   },
   {
      NVRAM_EF_EL1_LTE_ET_MANUAL_PARAMETER_FILTER_LID,
      NVRAM_EF_EL1_LTE_ET_MANUAL_PARAMETER_FILTER_TOTAL,
      NVRAM_EF_EL1_LTE_ET_MANUAL_PARAMETER_FILTER_SIZE,
      NVRAM_DEFAULT_FUNC(nvram_get_eL1_default_value_to_write_with_record),
      NVRAM_CATEGORY_USER,
      NVRAM_ATTR_OTA_RESET,
      "EL56",
      VER(NVRAM_EF_EL1_LTE_ET_MANUAL_PARAMETER_FILTER_LID)
   },
   {
      NVRAM_EF_EL1_LTE_ET_MANUAL_PARAMETER_FILTER_CCA_LID,
      NVRAM_EF_EL1_LTE_ET_MANUAL_PARAMETER_FILTER_CCA_TOTAL,
      NVRAM_EF_EL1_LTE_ET_MANUAL_PARAMETER_FILTER_CCA_SIZE,
      NVRAM_DEFAULT_FUNC(nvram_get_eL1_default_value_to_write_with_record),
      NVRAM_CATEGORY_USER,
      NVRAM_ATTR_OTA_RESET,
      "EL57",
      VER(NVRAM_EF_EL1_LTE_ET_MANUAL_PARAMETER_FILTER_CCA_LID)
   },
   #endif
