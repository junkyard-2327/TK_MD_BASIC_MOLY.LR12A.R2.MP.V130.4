...
ltable_entry_struct logical_data_item_table_l1[] =
{
   ...
   },
   {
    ...
    {
        NVRAM_EF_L1_GMSK_ADJUST_TPO_GSM850_LID,
        NVRAM_EF_L1_GMSK_ADJUST_TPO_GSM850_TOTAL,
        NVRAM_EF_L1_GMSK_ADJUST_TPO_GSM850_SIZE,
        NVRAM_DEFAULT_FUNC(nvram_get_L1_default_value_to_write),
        NVRAM_CATEGORY_CALIBRAT | NVRAM_CATEGORY_FUNC_DEFAULT,
        NVRAM_ATTR_AVERAGE | NVRAM_ATTR_GEN_DEFAULT,
        "LA27",
        VER(NVRAM_EF_L1_GMSK_ADJUST_TPO_GSM850_LID),
    },
    {
        NVRAM_EF_L1_GMSK_ADJUST_TPO_GSM900_LID,
        NVRAM_EF_L1_GMSK_ADJUST_TPO_GSM900_TOTAL,
        NVRAM_EF_L1_GMSK_ADJUST_TPO_GSM900_SIZE,
        NVRAM_DEFAULT_FUNC(nvram_get_L1_default_value_to_write),
        NVRAM_CATEGORY_CALIBRAT | NVRAM_CATEGORY_FUNC_DEFAULT,
        NVRAM_ATTR_AVERAGE | NVRAM_ATTR_GEN_DEFAULT,
        "LA28",
        VER(NVRAM_EF_L1_GMSK_ADJUST_TPO_GSM900_LID),
    },
    {
        NVRAM_EF_L1_GMSK_ADJUST_TPO_DCS_LID,
        NVRAM_EF_L1_GMSK_ADJUST_TPO_DCS_TOTAL,
        NVRAM_EF_L1_GMSK_ADJUST_TPO_DCS_SIZE,
        NVRAM_DEFAULT_FUNC(nvram_get_L1_default_value_to_write),
        NVRAM_CATEGORY_CALIBRAT | NVRAM_CATEGORY_FUNC_DEFAULT,
        NVRAM_ATTR_AVERAGE | NVRAM_ATTR_GEN_DEFAULT,
        "LA29",
        VER(NVRAM_EF_L1_GMSK_ADJUST_TPO_DCS_LID),
    },
    {
        NVRAM_EF_L1_GMSK_ADJUST_TPO_PCS_LID,
        NVRAM_EF_L1_GMSK_ADJUST_TPO_PCS_TOTAL,
        NVRAM_EF_L1_GMSK_ADJUST_TPO_PCS_SIZE,
        NVRAM_DEFAULT_FUNC(nvram_get_L1_default_value_to_write),
        NVRAM_CATEGORY_CALIBRAT | NVRAM_CATEGORY_FUNC_DEFAULT,
        NVRAM_ATTR_AVERAGE | NVRAM_ATTR_GEN_DEFAULT,
        "LA2A",
        VER(NVRAM_EF_L1_GMSK_ADJUST_TPO_PCS_LID),
    },
    #if defined(__EPSK_ADJUST_TPO_SUPPORT__)
    {
        NVRAM_EF_L1_EPSK_ADJUST_TPO_GSM850_LID,
        NVRAM_EF_L1_EPSK_ADJUST_TPO_GSM850_TOTAL,
        NVRAM_EF_L1_EPSK_ADJUST_TPO_GSM850_SIZE,
        NVRAM_DEFAULT_FUNC(nvram_get_L1_default_value_to_write),
        NVRAM_CATEGORY_CALIBRAT | NVRAM_CATEGORY_FUNC_DEFAULT,
        NVRAM_ATTR_AVERAGE | NVRAM_ATTR_GEN_DEFAULT,
        "LA2B",
        VER(NVRAM_EF_L1_EPSK_ADJUST_TPO_GSM850_LID),
    },
    {
        NVRAM_EF_L1_EPSK_ADJUST_TPO_GSM900_LID,
        NVRAM_EF_L1_EPSK_ADJUST_TPO_GSM900_TOTAL,
        NVRAM_EF_L1_EPSK_ADJUST_TPO_GSM900_SIZE,
        NVRAM_DEFAULT_FUNC(nvram_get_L1_default_value_to_write),
        NVRAM_CATEGORY_CALIBRAT | NVRAM_CATEGORY_FUNC_DEFAULT,
        NVRAM_ATTR_AVERAGE | NVRAM_ATTR_GEN_DEFAULT,
        "LA2C",
        VER(NVRAM_EF_L1_EPSK_ADJUST_TPO_GSM900_LID),
    },
    {
        NVRAM_EF_L1_EPSK_ADJUST_TPO_DCS_LID,
        NVRAM_EF_L1_EPSK_ADJUST_TPO_DCS_TOTAL,
        NVRAM_EF_L1_EPSK_ADJUST_TPO_DCS_SIZE,
        NVRAM_DEFAULT_FUNC(nvram_get_L1_default_value_to_write),
        NVRAM_CATEGORY_CALIBRAT | NVRAM_CATEGORY_FUNC_DEFAULT,
        NVRAM_ATTR_AVERAGE | NVRAM_ATTR_GEN_DEFAULT,
        "LA2D",
        VER(NVRAM_EF_L1_EPSK_ADJUST_TPO_DCS_LID),
    },
    {
        NVRAM_EF_L1_EPSK_ADJUST_TPO_PCS_LID,
        NVRAM_EF_L1_EPSK_ADJUST_TPO_PCS_TOTAL,
        NVRAM_EF_L1_EPSK_ADJUST_TPO_PCS_SIZE,
        NVRAM_DEFAULT_FUNC(nvram_get_L1_default_value_to_write),
        NVRAM_CATEGORY_CALIBRAT | NVRAM_CATEGORY_FUNC_DEFAULT,
        NVRAM_ATTR_AVERAGE | NVRAM_ATTR_GEN_DEFAULT,
        "LA2E",
        VER(NVRAM_EF_L1_EPSK_ADJUST_TPO_PCS_LID),
    },
