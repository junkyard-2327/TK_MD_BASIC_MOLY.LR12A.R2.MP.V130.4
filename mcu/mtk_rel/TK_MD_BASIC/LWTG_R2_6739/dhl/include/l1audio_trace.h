...
#include "L1Trc.h"
...
#if defined(L1_CATCHER)
	#define L1Audio_Msg_AM_Resync_L(v1, v2) do {\
		{\
			TRC_START_FILTER_CHECK_L1(L1Audio_Trace_Filter, 1, 0x02);\
			TRC_PREPROCESS_DATA_SECTION1_L1(cgen_local_v1,v1);\
			TRC_PREPROCESS_DATA_SECTION1_L1(cgen_local_v2,v2);\
...
#else
	#define L1Audio_Msg_AM_Resync_L(v1, v2)
#endif
	...
	#define L1Audio_Msg_AM_Reset_Time_Drift() do {\
		{\
			TRC_START_FILTER_CHECK_L1(L1Audio_Trace_Filter, 1, 0x02);\
			TRC_START_FILL_L1();\
			TRC_OUTPUT_16_SINGLE_WRAPPER_L1(0x262E,0x262E);\
			TRC_END_FILL_L1();\
			TRC_END_FILTER_CHECK_L1(L1Audio_Trace_Filter, 1, 0x02);\
		}\
	} while(0)
...
#if defined(L1_CATCHER)
	#define L1Audio_Msg_AM_Reset_Time_Drift_L() do {\
		{\
			TRC_START_FILTER_CHECK_L1(L1Audio_Trace_Filter, 1, 0x02);\
			TRC_START_FILL_L1();\
...
#else
	#define L1Audio_Msg_AM_Reset_Time_Drift_L()
#endif
...
#if defined(L1_CATCHER)
	#define L1Audio_Msg_AM_Update_Time_Drift_L(v1) do {\
		{\
			TRC_START_FILTER_CHECK_L1(L1Audio_Trace_Filter, 1, 0x02);\
			TRC_PREPROCESS_DATA_SECTION1_L1(cgen_local_v1,v1);\
			TRC_START_FILL_L1();\
...
#else
	#define L1Audio_Msg_AM_Update_Time_Drift_L(v1)
#endif
	...
	#define L1Audio_Msg_AM_3G_Reset_Time_Drift() do {\
		{\
			TRC_START_FILTER_CHECK_L1(L1Audio_Trace_Filter, 1, 0x02);\
			TRC_START_FILL_L1();\
			TRC_OUTPUT_16_SINGLE_WRAPPER_L1(0x2A2E,0x2A2E);\
			TRC_END_FILL_L1();\
			TRC_END_FILTER_CHECK_L1(L1Audio_Trace_Filter, 1, 0x02);\
		}\
	} while(0)
	...
	#define L1Audio_Msg_SP4G_GSeriesCall_Open_OK() do {\
		{\
			TRC_START_FILTER_CHECK_L1(L1Audio_Trace_Filter, 1, 0x02);\
			TRC_START_FILL_L1();\
			TRC_OUTPUT_16_SINGLE_WRAPPER_L1(0x462E,0x462E);\
			TRC_END_FILL_L1();\
			TRC_END_FILTER_CHECK_L1(L1Audio_Trace_Filter, 1, 0x02);\
		}\
	} while(0)
	...
	#define L1Audio_Msg_SP4G_EVSSeriesCall_Open_OK() do {\
		{\
			TRC_START_FILTER_CHECK_L1(L1Audio_Trace_Filter, 1, 0x02);\
			TRC_START_FILL_L1();\
			TRC_OUTPUT_16_SINGLE_WRAPPER_L1(0x482E,0x482E);\
			TRC_END_FILL_L1();\
			TRC_END_FILTER_CHECK_L1(L1Audio_Trace_Filter, 1, 0x02);\
		}\
	} while(0)
...
#define ChkL1MsgFltr_L1Audio_Msg_AM_Resync_L()	ChkL1ClsFltr_L1Audio_AM_Inf_H()
#define ChkL1MsgFltr_L1Audio_Msg_AM_Reset_Time_Drift()	ChkL1ClsFltr_L1Audio_AM_Inf_H()
#define ChkL1MsgFltr_L1Audio_Msg_AM_Reset_Time_Drift_L()	ChkL1ClsFltr_L1Audio_AM_Inf_H()
#define ChkL1MsgFltr_L1Audio_Msg_AM_Update_Time_Drift()	ChkL1ClsFltr_L1Audio_AM_Inf_H()
#define ChkL1MsgFltr_L1Audio_Msg_AM_Update_Time_Drift_L()	ChkL1ClsFltr_L1Audio_AM_Inf_H()
