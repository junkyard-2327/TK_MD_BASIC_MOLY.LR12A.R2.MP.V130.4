...
#define PWR_INJECT_Str(v1)  (unsigned char)(v1+195)
...
#if defined(L1_CATCHER)
	#define EL1_LCE_INFO3(v1, v2, v3, v4) do {\
		{\
			TRC_START_FILTER_CHECK_L1(EL1_MAIN_Trace_Filter, 1, 0x01);\
			TRC_PREPROCESS_DATA_SECTION1_L1(cgen_local_v1,v1);\
			TRC_PREPROCESS_DATA_SECTION1_L1(cgen_local_v2,v2);\
...
#else
	#define EL1_LCE_INFO3(v1, v2, v3, v4)
#endif
...
#define ChkL1MsgFltr_EL1_LCE_INFO3()	ChkL1ClsFltr_EL1_MAIN_el1_trace_1_H()
