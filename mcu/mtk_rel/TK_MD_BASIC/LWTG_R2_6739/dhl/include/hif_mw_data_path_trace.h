...
#include "L1Trc.h"
	...
	#define IPC_FRAG_QUE_LAST_FRAG() do {\
		{\
			TRC_START_FILTER_CHECK_L2(HIF_MW_Trace_Filter, 2, 0x10);\
			TRC_START_FILL_L2();\
			TRC_OUTPUT_16_SINGLE_WRAPPER_L2(0x742B,0x742B);\
			TRC_END_FILL_L2();\
			TRC_END_FILTER_CHECK_L2(HIF_MW_Trace_Filter, 2, 0x10);\
		}\
	} while(0)
	...
	#define IPC_FRAG_RECYCLE_NO_SPACE(v1, v2) do {\
		{\
			...
			TRC_PREPROCESS_DATA_SECTION2_L2(cgen_local_v1,v1);\
			TRC_PREPROCESS_DATA_SECTION2_L2(cgen_local_v2,v2);\
			TRC_OUTPUT_16_FIRST_WRAPPER_L2(0x762B,0x762B);\
			TRC_OUTPUT_8_MID_WRAPPER_L2(cgen_local_v1,v1);\
			TRC_OUTPUT_32_LAST_WRAPPER_L2(cgen_local_v2,v2);\
			TRC_END_FILL_L2();\
			TRC_END_FILTER_CHECK_L2(HIF_MW_Trace_Filter, 2, 0x10);\
...
#define ChkL1MsgFltr_NMU_UTIL_SET_HOST_MAC()	ChkL1ClsFltr_HIF_MW_DATA_PATH_SENSITIVE()
#define ChkL1MsgFltr_NMU_UTIL_GET_HOST_MAC()	ChkL1ClsFltr_HIF_MW_DATA_PATH_SENSITIVE()
#define ChkL1MsgFltr_NMU_UTIL_SET_GW_MAC()	ChkL1ClsFltr_HIF_MW_DATA_PATH_SENSITIVE()
#define ChkL1MsgFltr_NMU_UTIL_GET_GW_MAC()	ChkL1ClsFltr_HIF_MW_DATA_PATH_SENSITIVE()
