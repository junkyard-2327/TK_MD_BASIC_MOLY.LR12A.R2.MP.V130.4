...
#include "L1Trc.h"
...
#if defined(L1_CATCHER)
	#define UL1D_TRC_PICH_PCH_STOP_STATUS(v1, v2, v3, v4, v5, v6) do {\
		{\
			TRC_START_FILTER_CHECK_L1(UL1D_SEC_Trace_Filter, 1, 0x04);\
			TRC_PREPROCESS_DATA_SECTION1_L1(cgen_local_v1,v1);\
			TRC_PREPROCESS_DATA_SECTION1_L1(cgen_local_v2,v2);\
...
#else
	#define UL1D_TRC_PICH_PCH_STOP_STATUS(v1, v2, v3, v4, v5, v6)
#endif
	...
	#define UL1D_TRC_FACH_SET_RPT_FOR_DEDICATED_FACH() do {\
		{\
			TRC_START_FILTER_CHECK_L1(UL1D_SEC_Trace_Filter, 1, 0x04);\
			TRC_START_FILL_L1();\
			TRC_OUTPUT_16_SINGLE_WRAPPER_L1(0x388D,0x388D);\
			TRC_END_FILL_L1();\
			TRC_END_FILTER_CHECK_L1(UL1D_SEC_Trace_Filter, 1, 0x04);\
		}\
	} while(0)
...
#if defined(L1_CATCHER)
	#define UL1D_TRC_IDLE_MODE_RXD(v1, v2, v3) do {\
		{\
...
#else
	#define UL1D_TRC_IDLE_MODE_RXD(v1, v2, v3)
#endif
	...
	#define UL1D_TRC_PICH_PI_POSITION(v1, v2, v3, v4, v5) do {\
		{\
			...
			TRC_PREPROCESS_DATA_SECTION2_L1(cgen_local_v4,v4);\
			TRC_PREPROCESS_DATA_SECTION2_L1(cgen_local_v5,v5);\
			TRC_OUTPUT_16_FIRST_WRAPPER_L1(0x548D,0x548D);\
			TRC_OUTPUT_8_MID_WRAPPER_L1(cgen_local_v1,v1);\
			TRC_OUTPUT_8_MID_WRAPPER_L1(cgen_local_v2,v2);\
			TRC_OUTPUT_8_MID_WRAPPER_L1(cgen_local_v3,v3);\
			TRC_OUTPUT_16_MID_WRAPPER_L1(cgen_local_v4,v4);\
	...
	#define UL1D_TRC_SRCHR_PI_SCHEDULE(v1, v2, v3, v4, v5) do {\
		{\
			...
			TRC_OUTPUT_16_FIRST_WRAPPER_L1_NON_SMP(0x568D,0x568D);\
			TRC_OUTPUT_16_MID_WRAPPER_L1_NON_SMP(cgen_local_v1,v1);\
...
#if defined(L1_CATCHER)
	#define UL1D_TRC_PCH_ARX_EVAL_OB(v1, v2, v3, v4, v5, v6, v7, v8) do {\
		{\
			TRC_START_FILTER_CHECK_L1(UL1D_SEC_Trace_Filter, 1, 0x40);\
			TRC_PREPROCESS_DATA_SECTION1_L1(cgen_local_v1,v1);\
			TRC_PREPROCESS_DATA_SECTION1_L1(cgen_local_v2,v2);\
			...
			TRC_PREPROCESS_DATA_SECTION2_L1(cgen_local_v7,v7);\
			TRC_PREPROCESS_DATA_SECTION2_L1(cgen_local_v8,v8);\
			TRC_OUTPUT_16_FIRST_WRAPPER_L1(0x638D,0x638D);\
			TRC_OUTPUT_16_MID_WRAPPER_L1(cgen_local_v1,v1);\
			TRC_OUTPUT_32_MID_WRAPPER_L1(cgen_local_v2,v2);\
			TRC_OUTPUT_32_MID_WRAPPER_L1(cgen_local_v3,v3);\
			TRC_OUTPUT_32_MID_WRAPPER_L1(cgen_local_v4,v4);\
...
#else
	#define UL1D_TRC_PCH_ARX_EVAL_OB(v1, v2, v3, v4, v5, v6, v7, v8)
#endif
	...
	#define UL1D_TRC_PCH_ARX_MODE(v1, v2) do {\
		{\
			...
			TRC_PREPROCESS_DATA_SECTION2_L1_NON_SMP(cgen_local_v1,v1);\
			TRC_PREPROCESS_DATA_SECTION2_L1_NON_SMP(cgen_local_v2,v2);\
			TRC_OUTPUT_16_FIRST_WRAPPER_L1_NON_SMP(0x658D,0x658D);\
			TRC_OUTPUT_16_MID_WRAPPER_L1_NON_SMP(cgen_local_v1,v1);\
	...
	#define UL1D_TRC_PCH_ARX_EVAL_RF_SNR(v1, v2, v3, v4) do {\
		{\
			...
			TRC_PREPROCESS_DATA_SECTION2_L1(cgen_local_v3,v3);\
			TRC_PREPROCESS_DATA_SECTION2_L1(cgen_local_v4,v4);\
			TRC_OUTPUT_16_FIRST_WRAPPER_L1(0x668D,0x668D);\
			TRC_OUTPUT_16_MID_WRAPPER_L1(cgen_local_v1,v1);\
			TRC_OUTPUT_32_MID_WRAPPER_L1(cgen_local_v2,v2);\
			TRC_OUTPUT_32_MID_WRAPPER_L1(cgen_local_v3,v3);\
			TRC_OUTPUT_32_LAST_WRAPPER_L1(cgen_local_v4,v4);\
	...
	#define UL1D_TRC_PCH_ADAPTIVE_SW_INIT(v1, v2, v3) do {\
		{\
			...
			TRC_PREPROCESS_DATA_SECTION2_L1_NON_SMP(cgen_local_v2,v2);\
			TRC_PREPROCESS_DATA_SECTION2_L1_NON_SMP(cgen_local_v3,v3);\
			TRC_OUTPUT_16_FIRST_WRAPPER_L1_NON_SMP(0x688D,0x688D);\
			TRC_OUTPUT_16_MID_WRAPPER_L1_NON_SMP(cgen_local_v1,v1);\
...
#define ChkL1MsgFltr_UL1D_TRC_PICH_PCH_STOP_STATUS()	ChkL1ClsFltr_UL1D_SEC_SM_H()
...
#define ChkL1MsgFltr_UL1D_TRC_IDLE_MODE_RXD()	ChkL1ClsFltr_UL1D_SEC_PICH_H()
...
#define ChkL1MsgFltr_UL1D_TRC_HWTPC_WTXUPC_ASPOW()	ChkL1ClsFltr_UL1D_SEC_HWTPC_L()
