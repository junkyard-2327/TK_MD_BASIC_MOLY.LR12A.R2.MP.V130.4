...
#define UL1D_TRC_STR_DD_START_FROM(v1)  (unsigned char)(v1+62)
...
#include "L1Trc.h"
...
#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 2) )
	#define UL1D_TRC_ABNORMAL_IOEST_RES_DBG(v1, v2) do {\
		{\
			TRC_START_FILTER_CHECK_L1(UL1D_THIRD_Trace_Filter, 1, 0x02);\
			TRC_PREPROCESS_DATA_SECTION1_L1(cgen_local_v1,v1);\
			TRC_PREPROCESS_DATA_SECTION1_L1(cgen_local_v2,v2);\
...
#else
	#define UL1D_TRC_ABNORMAL_IOEST_RES_DBG(v1, v2)
#endif

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 2) )
	#define UL1D_TRC_ABNORMAL_IOEST_DBG(v1, v2) do {\
		{\
			TRC_START_FILTER_CHECK_L1(UL1D_THIRD_Trace_Filter, 1, 0x02);\
			TRC_PREPROCESS_DATA_SECTION1_L1(cgen_local_v1,v1);\
			TRC_PREPROCESS_DATA_SECTION1_L1(cgen_local_v2,v2);\
...
#else
	#define UL1D_TRC_ABNORMAL_IOEST_DBG(v1, v2)
#endif

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 2) )
	#define Ul1D_TRC_IO_EST_RSSI_DEBUG(v1, v2) do {\
		{\
			TRC_START_FILTER_CHECK_L1(UL1D_THIRD_Trace_Filter, 1, 0x02);\
			TRC_PREPROCESS_DATA_SECTION1_L1(cgen_local_v1,v1);\
			TRC_PREPROCESS_DATA_SECTION1_L1(cgen_local_v2,v2);\
...
#else
	#define Ul1D_TRC_IO_EST_RSSI_DEBUG(v1, v2)
#endif

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 2) )
	#define Ul1D_TRC_IO_EST_RSSI_FN_DEBUG(v1, v2, v3, v4) do {\
		{\
			TRC_START_FILTER_CHECK_L1(UL1D_THIRD_Trace_Filter, 1, 0x02);\
			TRC_PREPROCESS_DATA_SECTION1_L1(cgen_local_v1,v1);\
			TRC_PREPROCESS_DATA_SECTION1_L1(cgen_local_v2,v2);\
...
#else
	#define Ul1D_TRC_IO_EST_RSSI_FN_DEBUG(v1, v2, v3, v4)
#endif

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 2) )
	#define UL1D_TRC_ABNORMAL_RSSI_DBG(v1, v2) do {\
		{\
			TRC_START_FILTER_CHECK_L1(UL1D_THIRD_Trace_Filter, 1, 0x02);\
			TRC_PREPROCESS_DATA_SECTION1_L1(cgen_local_v1,v1);\
			TRC_PREPROCESS_DATA_SECTION1_L1(cgen_local_v2,v2);\
...
#else
	#define UL1D_TRC_ABNORMAL_RSSI_DBG(v1, v2)
#endif

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 2) )
	#define UL1D_TRC_ABNORMAL_IOEST_RSSI_DBG(v1, v2, v3) do {\
		{\
			TRC_START_FILTER_CHECK_L1(UL1D_THIRD_Trace_Filter, 1, 0x02);\
			TRC_PREPROCESS_DATA_SECTION1_L1(cgen_local_v1,v1);\
			TRC_PREPROCESS_DATA_SECTION1_L1(cgen_local_v2,v2);\
...
#else
	#define UL1D_TRC_ABNORMAL_IOEST_RSSI_DBG(v1, v2, v3)
#endif

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 2) )
	#define UL1D_TRC_ABNORMAL_IOEST_CHECK(v1) do {\
		{\
			TRC_START_FILTER_CHECK_L1(UL1D_THIRD_Trace_Filter, 1, 0x02);\
			TRC_PREPROCESS_DATA_SECTION1_L1(cgen_local_v1,v1);\
			TRC_START_FILL_L1();\
...
#else
	#define UL1D_TRC_ABNORMAL_IOEST_CHECK(v1)
#endif
	...
	#define UL1D_TRC_SFN_UPDATE_CM_DATABASE() do {\
		{\
			TRC_START_FILTER_CHECK_L1(UL1D_THIRD_Trace_Filter, 2, 0x02);\
			TRC_START_FILL_L1();\
			TRC_OUTPUT_16_SINGLE_WRAPPER_L1(0x4A8E,0x4A8E);\
			TRC_END_FILL_L1();\
			TRC_END_FILTER_CHECK_L1(UL1D_THIRD_Trace_Filter, 2, 0x02);\
		}\
	} while(0)
...
#define ChkL1MsgFltr_UL1D_TRC_ABNORMAL_IOEST_RES_DBG()	ChkL1ClsFltr_UL1D_THIRD_MEAS_M()
#define ChkL1MsgFltr_UL1D_TRC_ABNORMAL_IOEST_DBG()	ChkL1ClsFltr_UL1D_THIRD_MEAS_M()
#define ChkL1MsgFltr_Ul1D_TRC_IO_EST_RSSI_DEBUG()	ChkL1ClsFltr_UL1D_THIRD_MEAS_M()
#define ChkL1MsgFltr_Ul1D_TRC_IO_EST_RSSI_FN_DEBUG()	ChkL1ClsFltr_UL1D_THIRD_MEAS_M()
#define ChkL1MsgFltr_UL1D_TRC_ABNORMAL_RSSI_DBG()	ChkL1ClsFltr_UL1D_THIRD_MEAS_M()
#define ChkL1MsgFltr_UL1D_TRC_ABNORMAL_IOEST_RSSI_DBG()	ChkL1ClsFltr_UL1D_THIRD_MEAS_M()
#define ChkL1MsgFltr_UL1D_TRC_ABNORMAL_IOEST_CHECK()	ChkL1ClsFltr_UL1D_THIRD_MEAS_M()
