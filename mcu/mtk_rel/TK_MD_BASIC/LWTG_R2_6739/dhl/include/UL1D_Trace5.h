...
#include "L1Trc.h"
...
#if defined(L1_CATCHER)
	#define UL1D_TRC_ARX_VOTER_EVAL_OB(v1, v2, v3, v4, v5, v6, v7) do {\
		{\
			TRC_START_FILTER_CHECK_L1(UL1D_SIXTH_Trace_Filter, 3, 0x40);\
			TRC_PREPROCESS_DATA_SECTION1_L1(cgen_local_v1,v1);\
			TRC_PREPROCESS_DATA_SECTION1_L1(cgen_local_v2,v2);\
...
#else
	#define UL1D_TRC_ARX_VOTER_EVAL_OB(v1, v2, v3, v4, v5, v6, v7)
#endif
...
#if defined(L1_CATCHER)
	#define UL1D_TRC_ARX_ARBITRATOR_CHANGE_IS_LPM(v1, v2, v3, v4, v5, v6, v7, v8) do {\
		{\
			TRC_START_FILTER_CHECK_L1(UL1D_SIXTH_Trace_Filter, 3, 0x40);\
			TRC_PREPROCESS_DATA_SECTION1_L1(cgen_local_v1,v1);\
			TRC_PREPROCESS_DATA_SECTION1_L1(cgen_local_v2,v2);\
...
#else
	#define UL1D_TRC_ARX_ARBITRATOR_CHANGE_IS_LPM(v1, v2, v3, v4, v5, v6, v7, v8)
#endif

#if defined(L1_CATCHER)
	#define UL1D_TRC_ARX_LATEST_DECISION(v1, v2, v3, v4, v5, v6, v7) do {\
		{\
			TRC_START_FILTER_CHECK_L1(UL1D_SIXTH_Trace_Filter, 3, 0x40);\
			TRC_PREPROCESS_DATA_SECTION1_L1(cgen_local_v1,v1);\
			TRC_PREPROCESS_DATA_SECTION1_L1(cgen_local_v2,v2);\
...
#else
	#define UL1D_TRC_ARX_LATEST_DECISION(v1, v2, v3, v4, v5, v6, v7)
#endif
...
#if defined(L1_CATCHER)
	#define UL1D_TRC_ARX_PERF_CHECK_TOGGLE_ARX_MODE(v1, v2) do {\
		{\
			TRC_START_FILTER_CHECK_L1(UL1D_SIXTH_Trace_Filter, 3, 0x40);\
			TRC_PREPROCESS_DATA_SECTION1_L1(cgen_local_v1,v1);\
			TRC_PREPROCESS_DATA_SECTION1_L1(cgen_local_v2,v2);\
...
#else
	#define UL1D_TRC_ARX_PERF_CHECK_TOGGLE_ARX_MODE(v1, v2)
#endif
...
#if defined(L1_CATCHER)
	#define UL1D_TRC_ARX_DECIDE_COMMITTEE_ONOFF_91(v1, v2, v3, v4, v5, v6, v7) do {\
		{\
			TRC_START_FILTER_CHECK_L1(UL1D_SIXTH_Trace_Filter, 3, 0x40);\
			TRC_PREPROCESS_DATA_SECTION1_L1(cgen_local_v1,v1);\
			TRC_PREPROCESS_DATA_SECTION1_L1(cgen_local_v2,v2);\
...
#else
	#define UL1D_TRC_ARX_DECIDE_COMMITTEE_ONOFF_91(v1, v2, v3, v4, v5, v6, v7)
#endif
	...
	#define UL1D_TRC_RXCRP_CHCFG_DLDCH_STOP() do {\
		{\
			TRC_START_FILTER_CHECK_L1(UL1D_SIXTH_Trace_Filter, 2, 0x40);\
			TRC_START_FILL_L1();\
			TRC_OUTPUT_16_SINGLE_WRAPPER_L1(0x3891,0x3891);\
			TRC_END_FILL_L1();\
			TRC_END_FILTER_CHECK_L1(UL1D_SIXTH_Trace_Filter, 2, 0x40);\
		}\
	} while(0)
	...
	#define UL1D_TRC_RXCRP_CHCFG_rl0_STOP() do {\
		{\
			TRC_START_FILTER_CHECK_L1(UL1D_SIXTH_Trace_Filter, 2, 0x40);\
			TRC_START_FILL_L1();\
			TRC_OUTPUT_16_SINGLE_WRAPPER_L1(0x3E91,0x3E91);\
			TRC_END_FILL_L1();\
			TRC_END_FILTER_CHECK_L1(UL1D_SIXTH_Trace_Filter, 2, 0x40);\
		}\
	} while(0)
	...
	#define UL1D_TRC_DSP_SM_RUN(v1, v2) do {\
		{\
			...
			TRC_OUTPUT_16_FIRST_WRAPPER_L1_NON_SMP(0x7391,0x7391);\
	...
	#define UL1D_TRC_DSP_SM_MML1_REC_RAT_INFO(v1, v2, v3, v4) do {\
		{\
			...
			TRC_PREPROCESS_DATA_SECTION2_L1(cgen_local_v3,v3);\
			TRC_PREPROCESS_DATA_SECTION2_L1(cgen_local_v4,v4);\
			TRC_OUTPUT_16_FIRST_WRAPPER_L1(0x7691,0x7691);\
			TRC_OUTPUT_8_MID_WRAPPER_L1(cgen_local_v1,v1);\
			TRC_OUTPUT_8_MID_WRAPPER_L1(cgen_local_v2,v2);\
			TRC_OUTPUT_8_MID_WRAPPER_L1(cgen_local_v3,v3);\
			TRC_OUTPUT_16_LAST_WRAPPER_L1(cgen_local_v4,v4);\
...
#if defined(L1_CATCHER)
	#define UL1D_TRC_DSP_STATUS(v1, v2, v3, v4, v5, v6, v7, v8) do {\
		{\
			TRC_START_FILTER_CHECK_L1(UL1D_SIXTH_Trace_Filter, 3, 0x01);\
			TRC_PREPROCESS_DATA_SECTION1_L1(cgen_local_v1,v1);\
			TRC_PREPROCESS_DATA_SECTION1_L1(cgen_local_v2,v2);\
...
#else
	#define UL1D_TRC_DSP_STATUS(v1, v2, v3, v4, v5, v6, v7, v8)
#endif
	...
	#define UL1D_TRC_SLEEP_EL1D_HRT_MARGIN_EVAL(v1, v2, v3) do {\
		{\
			...
			TRC_OUTPUT_16_FIRST_WRAPPER_L1_NON_SMP(0x9D91,0x9D91);\
			TRC_OUTPUT_8_MID_WRAPPER_L1_NON_SMP(cgen_local_v1,v1);\
	...
	#define UL1D_TRC_FAKE_LOCK_SLEEP_END(v1, v2) do {\
		{\
			...
			TRC_PREPROCESS_DATA_SECTION2_L1(cgen_local_v1,v1);\
			TRC_PREPROCESS_DATA_SECTION2_L1(cgen_local_v2,v2);\
			TRC_OUTPUT_16_FIRST_WRAPPER_L1(0xA091,0xA091);\
			TRC_OUTPUT_32_MID_WRAPPER_L1(cgen_local_v1,v1);\
			TRC_OUTPUT_16_LAST_WRAPPER_L1(cgen_local_v2,v2);\
			TRC_END_FILL_L1();\
			TRC_END_FILTER_CHECK_L1(UL1D_SIXTH_Trace_Filter, 3, 0x01);\
...
#define ChkL1MsgFltr_UL1D_TRC_ARX_DECIDE_COMMITTEE_ONOFF_91()	ChkL1ClsFltr_UL1D_SIXTH_ARX_H()
