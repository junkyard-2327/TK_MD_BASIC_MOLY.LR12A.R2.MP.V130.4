...
#include "L1Trc.h"
...
#if defined(L1_CATCHER)
	#define UL1D_TRC_RFM_TIMING_UPDATED_INFO(v1, v2) do {\
		{\
			TRC_START_FILTER_CHECK_L1(UL1D_FOURTH_Trace_Filter, 1, 0x04);\
			TRC_PREPROCESS_DATA_SECTION1_L1(cgen_local_v1,v1);\
			TRC_PREPROCESS_DATA_SECTION1_L1(cgen_local_v2,v2);\
...
#else
	#define UL1D_TRC_RFM_TIMING_UPDATED_INFO(v1, v2)
#endif
	...
	#define UL1D_TRC_CS_DBG_IRQ_SISR(v1, v2, v3, v4) do {\
		{\
			TRC_START_FILTER_CHECK_L1(UL1D_FOURTH_Trace_Filter, 1, 0x80);\
			TRC_PREPROCESS_DATA_SECTION1_L1(cgen_local_v1,v1);\
			TRC_PREPROCESS_DATA_SECTION1_L1(cgen_local_v2,v2);\
			TRC_PREPROCESS_DATA_SECTION1_L1(cgen_local_v3,v3);\
			TRC_PREPROCESS_DATA_SECTION1_L1(cgen_local_v4,v4);\
			...
			TRC_OUTPUT_8_LAST_WRAPPER_L1(cgen_local_v4,v4);\
			TRC_END_FILL_L1();\
			TRC_END_FILTER_CHECK_L1(UL1D_FOURTH_Trace_Filter, 1, 0x80);\
		}\
	} while(0)
#else
	...
	#define UL1D_TRC_PS_Stage1_Finish() do {\
		{\
			TRC_START_FILTER_CHECK_L1(UL1D_FOURTH_Trace_Filter, 1, 0x10);\
			TRC_START_FILL_L1();\
			TRC_OUTPUT_16_SINGLE_WRAPPER_L1(0x9A8F,0x9A8F);\
			TRC_END_FILL_L1();\
			TRC_END_FILTER_CHECK_L1(UL1D_FOURTH_Trace_Filter, 1, 0x10);\
		}\
	} while(0)
...
#define ChkL1MsgFltr_UL1D_TRC_RFM_TIMING_UPDATED_INFO()	ChkL1ClsFltr_UL1D_FOURTH_RFM_H()
...
#define ChkL1MsgFltr_UL1D_TRC_CS_DBG_IRQ_SISR()	ChkL1ClsFltr_UL1D_FOURTH_CS_L()
