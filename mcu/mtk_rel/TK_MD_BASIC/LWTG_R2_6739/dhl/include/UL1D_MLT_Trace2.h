...
#if defined(L1_CATCHER)
	#define UL1D_TRC_RXBRP_DEBUG_FOR_DMA_MISS(v1, v2, v3, v4) do {\
		{\
			TRC_START_FILTER_CHECK_L1(UL1D_MLT_SET2_Trace_Filter, 1, 0x04);\
			TRC_PREPROCESS_DATA_SECTION1_L1(cgen_local_v1,v1);\
			TRC_PREPROCESS_DATA_SECTION1_L1(cgen_local_v2,v2);\
...
#else
	#define UL1D_TRC_RXBRP_DEBUG_FOR_DMA_MISS(v1, v2, v3, v4)
#endif
...
#define ChkL1MsgFltr_UL1D_TRC_RXBRP_DEBUG_FOR_DMA_MISS()	ChkL1ClsFltr_UL1D_MLT_SET2_RX_Mod_H()
