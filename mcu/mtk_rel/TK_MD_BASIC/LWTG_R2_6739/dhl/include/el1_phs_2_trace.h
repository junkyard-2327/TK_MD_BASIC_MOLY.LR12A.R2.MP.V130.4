...
#define PHS_SIM_IDX_STRING_2(v1)  (unsigned char)(v1+212)
#define PHS_TAS_STATUS_STRING(v1)  (unsigned char)(v1+216)
#define PHS_INTER_SIM_CONFLICT_STRING(v1)  (unsigned char)(v1+223)
#define PHS_PARAM_TYPE_STRING(v1)  (unsigned char)(v1+228)
