...
#define PHS_ISR_MSG_STRING(v1)  (unsigned char)(v1+155)
#define PHS_TASK_TX_MSG_STRING(v1)  (unsigned char)(v1+180)
#define PHS_RX_STATE_STRING(v1)  (unsigned char)(v1+182)
#define PHS_L1D_HRT_RPT_STRING(v1)  (unsigned char)(v1+187)
#define PHS_MIB_RLT_STRING(v1)  (unsigned char)(v1+193)
#define PHS_PRESYNC_TYPE_STRING(v1)  (unsigned char)(v1+196)
#define PHS_NBR_GET_TYPE_STRING(v1)  (unsigned char)(v1+201)
#define PHS_RSVAS_ST_STRING(v1)  (unsigned char)(v1+203)
#define PHS_SCHDL_FAIL_CAUSE(v1)  (unsigned char)(v1+206)
#define PHS_ISR_CTRL_REQ_SRC(v1)  (unsigned char)(v1+229)
#define PHS_SIM_IDX_STRING_1(v1)  (unsigned char)(v1+239)
...
#include "L1Trc.h"
	...
	#define PHS_LOG_I_STOP_EXE_EVT(v1, v2, v3, v4) do {\
		{\
			...
			TRC_SEND_N_DATA_L1_COND(2, TRC_MERGE_1S2C(0x2403, (unsigned char)(cgen_local_v1), (unsigned char)(cgen_local_v2)), TRC_MERGE_4C((unsigned char)(cgen_local_v3), (unsigned char)(cgen_local_v4), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
			TRC_END_FILL_L1_COND();\
	...
	#define PHS_LOG_I_STOP_PRESYNC_EVT(v1, v2, v3, v4, v5) do {\
		{\
			...
			TRC_PREPROCESS_DATA_SECTION2_L1(cgen_local_v4,v4);\
			TRC_PREPROCESS_DATA_SECTION2_L1(cgen_local_v5,v5);\
			TRC_OUTPUT_16_FIRST_WRAPPER_L1(0x2503,0x2503);\
			TRC_OUTPUT_8_MID_WRAPPER_L1(cgen_local_v1,v1);\
			TRC_OUTPUT_16_MID_WRAPPER_L1(cgen_local_v2,v2);\
			TRC_OUTPUT_8_MID_WRAPPER_L1(cgen_local_v3,v3);\
			TRC_OUTPUT_8_MID_WRAPPER_L1(cgen_local_v4,v4);\
...
#if defined(L1_CATCHER)
	#define PHS_LOG_I_PCH_TIME_SKIP_GAP(v1, v2, v3) do {\
		{\
			TRC_START_FILTER_CHECK_L1(EL1_PHS_1_Trace_Filter, 1, 0x01);\
			TRC_PREPROCESS_DATA_SECTION1_L1(cgen_local_v1,v1);\
			TRC_PREPROCESS_DATA_SECTION1_L1(cgen_local_v2,v2);\
...
#else
	#define PHS_LOG_I_PCH_TIME_SKIP_GAP(v1, v2, v3)
#endif
...
#if defined(L1_CATCHER)
	#define PHS_LOG_I_POS_TIME_GET(v1, v2, v3, v4, v5, v6) do {\
		{\
			TRC_START_FILTER_CHECK_L1(EL1_PHS_1_Trace_Filter, 1, 0x01);\
			TRC_PREPROCESS_DATA_SECTION1_L1(cgen_local_v1,v1);\
			TRC_PREPROCESS_DATA_SECTION1_L1(cgen_local_v2,v2);\
...
#else
	#define PHS_LOG_I_POS_TIME_GET(v1, v2, v3, v4, v5, v6)
#endif
...
#if defined(L1_CATCHER)
	#define PHS_LOG_I_BCCH_SI_TIM_GET(v1, v2, v3, v4, v5, v6, v7, v8, v9) do {\
		{\
			TRC_START_FILTER_CHECK_L1(EL1_PHS_1_Trace_Filter, 1, 0x01);\
			TRC_PREPROCESS_DATA_SECTION1_L1(cgen_local_v1,v1);\
			TRC_PREPROCESS_DATA_SECTION1_L1(cgen_local_v2,v2);\
...
#else
	#define PHS_LOG_I_BCCH_SI_TIM_GET(v1, v2, v3, v4, v5, v6, v7, v8, v9)
#endif

#if defined(L1_CATCHER)
	#define PHS_LOG_I_DL_CHNG_RPT(v1) do {\
		{\
			TRC_START_FILTER_CHECK_L1(EL1_PHS_1_Trace_Filter, 1, 0x01);\
			TRC_PREPROCESS_DATA_SECTION1_L1(cgen_local_v1,v1);\
			TRC_START_FILL_L1();\
...
#else
	#define PHS_LOG_I_DL_CHNG_RPT(v1)
#endif
...
#if defined(L1_CATCHER)
	#define PHS_LOG_I_PCH_REUSE_BMP(v1, v2) do {\
		{\
			TRC_START_FILTER_CHECK_L1(EL1_PHS_1_Trace_Filter, 1, 0x01);\
			TRC_PREPROCESS_DATA_SECTION1_L1(cgen_local_v1,v1);\
			TRC_PREPROCESS_DATA_SECTION1_L1(cgen_local_v2,v2);\
...
#else
	#define PHS_LOG_I_PCH_REUSE_BMP(v1, v2)
#endif
...
#define ChkL1MsgFltr_PHS_LOG_I_EVT_BUFF_TIME_GET()	ChkL1ClsFltr_EL1_PHS_1_el1_trace_3_M()
...
#define ChkL1MsgFltr_PHS_LOG_I_PCH_TIME_SKIP_GAP()	ChkL1ClsFltr_EL1_PHS_1_el1_trace_1_H()
...
#define ChkL1MsgFltr_PHS_LOG_I_BCCH_SI_TIM_GET()	ChkL1ClsFltr_EL1_PHS_1_el1_trace_1_H()
