...
#include "L1Trc.h"
	...
	#define EL1TX_LOG_D4U5_FORCE_16QAM_GRANT() do {\
		{\
			TRC_START_FILTER_CHECK_L1(EL1_TX_2_Trace_Filter, 1, 0x01);\
			TRC_START_FILL_L1();\
			TRC_OUTPUT_16_SINGLE_WRAPPER_L1(0x400A,0x400A);\
			TRC_END_FILL_L1();\
			TRC_END_FILTER_CHECK_L1(EL1_TX_2_Trace_Filter, 1, 0x01);\
		}\
	} while(0)
	...
	#define EL1TX_LOG_D4U5_MON_UPDATE(v1, v2) do {\
		{\
			...
			TRC_PREPROCESS_DATA_SECTION2_L1(cgen_local_v1,v1);\
			TRC_PREPROCESS_DATA_SECTION2_L1(cgen_local_v2,v2);\
			TRC_OUTPUT_16_FIRST_WRAPPER_L1(0x440A,0x440A);\
	...
	#define EL1TX_LOG_D4U5_FORCE_16QAM_ON() do {\
		{\
			TRC_START_FILTER_CHECK_L1(EL1_TX_2_Trace_Filter, 1, 0x01);\
			TRC_START_FILL_L1();\
			TRC_OUTPUT_16_SINGLE_WRAPPER_L1(0x450A,0x450A);\
			TRC_END_FILL_L1();\
			TRC_END_FILTER_CHECK_L1(EL1_TX_2_Trace_Filter, 1, 0x01);\
		}\
	} while(0)
	...
	#define EL1TX_LOG_D4U5_RCV_ERRC_CAT(v1) do {\
		{\
			...
			TRC_START_FILL_L1();\
			TRC_PREPROCESS_DATA_SECTION2_L1(cgen_local_v1,v1);\
			TRC_OUTPUT_16_FIRST_WRAPPER_L1(0x470A,0x470A);\
