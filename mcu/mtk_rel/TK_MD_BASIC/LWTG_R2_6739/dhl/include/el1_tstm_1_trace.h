...
#define TSTM_Func_String_Dummy_Emac(v1)  (unsigned char)(v1+48)
#define TSTM_Main_St_String(v1)  (unsigned char)(v1+66)
#define TSTM_DL_Rx_St_String(v1)  (unsigned char)(v1+75)
#define TSTM_UL_Tx_St_String(v1)  (unsigned char)(v1+79)
#define TSTM_Tx_Rx_St_String(v1)  (unsigned char)(v1+83)
#define TSTM_DL_Cs_St_String(v1)  (unsigned char)(v1+87)
#define TSTM_Rx_Fsm_St_String(v1)  (unsigned char)(v1+92)
#define TSTM_Reset_Tstm_St_String(v1)  (unsigned char)(v1+97)
#define TSTM_MB_MIB_DC_St_String(v1)  (unsigned char)(v1+109)
#define TSTM_Nrml_MIB_DC_St_String(v1)  (unsigned char)(v1+114)
#define TSTM_SI_DC_St_String(v1)  (unsigned char)(v1+120)
#define TSTM_DL_CS_Sub_St_String(v1)  (unsigned char)(v1+126)
#define TSTM_Error_St_String(v1)  (unsigned char)(v1+134)
#define TSTM_Rx_Fsm_Mod_String(v1)  (unsigned char)(v1+152)
#define TSTM_Pcell_St_String(v1)  (unsigned char)(v1+164)
#define TSTM_Scell_St_String(v1)  (unsigned char)(v1+177)
#define TSTM_Nbr_Cmd_Type_String(v1)  (unsigned char)(v1+190)
#define TSTM_Nbr_Cell_String(v1)  (unsigned char)(v1+195)
#define TSTM_Nbr_Mode_String(v1)  (unsigned char)(v1+200)
#define TSTM_SFBD_Mode_String(v1)  (unsigned char)(v1+203)
#define TSTM_Rpt_String(v1)  (unsigned char)(v1+207)
