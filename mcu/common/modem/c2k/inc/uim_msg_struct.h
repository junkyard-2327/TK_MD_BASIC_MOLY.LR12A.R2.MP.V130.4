...
/* MSG_ID_UIM_3GPD_IPV6_CAP_GET_MSG */
typedef struct
{   LOCAL_PARA_HDR
    Uim3GPDIpV6CapGetMsgT msg;
} uim_3gpd_ipv6_cap_get_msg_struct;

/* MSG_ID_UIM_3GPD_MIP_FLAGS_GET_MSG */
typedef struct
{   LOCAL_PARA_HDR
    Uim3GPDMobileIPFlagsGetMsgT msg;
} uim_3gpd_mip_flags_get_msg_struct;

/* MSG_ID_UIM_3GPD_TCP_CONFIG_GET_MSG */
typedef struct
{   LOCAL_PARA_HDR
    Uim3GPDTCPConfigsGetMsgT msg;
} uim_3gpd_tcp_config_get_msg_struct;

/* MSG_ID_UIM_3GPD_DATA_GENERIC_CONFIG_GET_MSG */
typedef struct
{   LOCAL_PARA_HDR
    Uim3GPDDataGenericConfigsGetMsgT msg;
} uim_3gpd_data_generic_config_get_msg_struct;
...
/* MSG_ID_UIM_PUZL_CONFIGURATION_REQUEST_MSG */
typedef struct
{   LOCAL_PARA_HDR
    UimPuzlConfigurationRequestMsgT msg;
} uim_puzl_configuration_request_msg_struct;

/* MSG_ID_UIM_PUZL_DOWNLOAD_REQUEST_MSG */
typedef struct
{   LOCAL_PARA_HDR
    UimPuzlDownloadRequestMsgT msg;
} uim_puzl_download_request_msg_struct;
...
/* MSG_ID_UIM_MMD_CONFIGURATION_REQUEST_MSG */
typedef struct
{   LOCAL_PARA_HDR
    UimMmdConfigurationRequestMsgT msg;
} uim_mmd_configuration_request_msg_struct;

/* MSG_ID_UIM_MMD_DOWNLOAD_REQUEST_MSG */
typedef struct
{   LOCAL_PARA_HDR
    UimMmdDownloadRequestMsgT msg;
} uim_mmd_download_request_msg_struct;

/* MSG_ID_UIM_MMS_CONFIGURATION_REQUEST_MSG */
typedef struct
{   LOCAL_PARA_HDR
    UimMmsConfigurationRequestMsgT msg;
} uim_mms_configuration_request_msg_struct;

/* MSG_ID_UIM_MMS_DOWNLOAD_REQUEST_MSG */
typedef struct
{   LOCAL_PARA_HDR
    UimMmsDownloadRequestMsgT msg;
} uim_mms_download_request_msg_struct;

/* MSG_ID_UIM_SYSTEM_TAG_CONFIGURATION_REQUEST_MSG */
typedef struct
{   LOCAL_PARA_HDR
    UimSystemTagConfigurationRequestMsgT msg;
} uim_system_tag_configuration_request_msg_struct;

/* MSG_ID_UIM_SYSTEM_TAG_DOWNLOAD_REQUEST_MSG */
typedef struct
{   LOCAL_PARA_HDR
    UimSystemTagDownloadRequestMsgT msg;
} uim_system_tag_download_request_msg_struct;

/* MSG_ID_UIM_MMSS_CONFIGURATION_REQUEST_MSG */
typedef struct
{   LOCAL_PARA_HDR
    UimMmssConfigurationRequestMsgT msg;
} uim_mmss_configuration_request_msg_struct;

/* MSG_ID_UIM_MMSS_DOWNLOAD_REQUEST_MSG */
typedef struct
{   LOCAL_PARA_HDR
    UimMmssDownloadRequestMsgT msg;
} uim_mmss_download_request_msg_struct;

/* MSG_ID_UIM_SECURE_MODE_MSG */
typedef struct
{   LOCAL_PARA_HDR
    UimSecureModeMsgT msg;
} uim_secure_mode_msg_struct;

/* MSG_ID_UIM_FRESH_MSG */
typedef struct
{   LOCAL_PARA_HDR
    UimFreshMsgT msg;
} uim_fresh_msg_struct;

/* MSG_ID_UIM_SERVICE_KEY_GENERATION_REQUEST_MSG */
typedef struct
{   LOCAL_PARA_HDR
    UimServiceKeyGenerationRequestMsgT msg;
} uim_service_key_generation_request_msg_struct;

/* MSG_ID_UIM_BCMCS_MSG */
typedef struct
{   LOCAL_PARA_HDR
    UimBcmcsMsgT msg;
} uim_bcmcs_msg_struct;

/* MSG_ID_UIM_APPLICATION_AUTHENTION_MSG */
typedef struct
{   LOCAL_PARA_HDR
    UimApplicationAuthentionMsgT msg;
} uim_application_authention_msg_struct;

/* MSG_ID_UIM_UMAC_GENERATION_MSG */
typedef struct
{   LOCAL_PARA_HDR
    UimUmacGenerationMsgT msg;
} uim_umac_generation_msg_struct;

/* MSG_ID_UIM_CONFIRM_KEYS_MSG */
typedef struct
{   LOCAL_PARA_HDR
    UimConfirmKeysMsgT msg;
} uim_confirm_keys_msg_struct;
...
/* MSG_ID_UIM_PROACTIVE_REGISTER_MSG */
typedef struct
{   LOCAL_PARA_HDR
    UimProactiveRegiserMsgT msg;
} uim_proactive_register_msg_struct;
...
typedef struct
{   LOCAL_PARA_HDR
    Uim3GAkaReadEfKeysPSMsgT msg;
} uim_3g_aka_read_efkeysps_msg_struct;

/* UIM_3G_AKA_UPDATE_EFKEYSPS_MSG */
typedef struct
{   LOCAL_PARA_HDR
    Uim3GAkaUpdateEfKeysPSMsgT msg;
} uim_3g_aka_update_efkeysps_msg_struct;

/* MSG_ID_UIM_GET_EFPL_MSG */
typedef struct
{   LOCAL_PARA_HDR
    UimGetEfPlMsgT msg;
} uim_get_efpl_msg_struct;


/* MSG_ID_UIM_GET_ISIM_IMPU_MSG */
typedef struct
{   LOCAL_PARA_HDR
    UimIsimImpuReadMsgT msg;
} uim_get_isim_impu_msg_struct;
