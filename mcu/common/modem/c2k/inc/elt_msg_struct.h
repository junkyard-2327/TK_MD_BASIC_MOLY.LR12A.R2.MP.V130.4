...
#endif
#include "../fcp/inc/fcpdefs.h"
#include "../rmc/inc/rmcdrcdefs.h"
#include "../fcp/inc/pafrlp.h"
#include "../rmc/inc/rmcfmp.h"
#include "../rmc/inc/rmcsch.h"
#include "../rmc/inc/rmcrupmsp.h"
#include "../val/valgps.h"
#include "hlpdef.h"
#include "hlpapi.h"
#include "hlpmip.h"

#include "do_rcpapi.h"
#include "../rcp/inc/rtm.h"
#include "../rcp/inc/rtmqos.h"
#include "../rcp/inc/ParRlp.h"
#include "../rlp/isotel/rlpe/inc/rlp_data.h"
#include "../ps/isotel/inc/scc_prot.h"
#include "pswapi.h"
#include "../l1d/inc/l1dlists.h"
#include "../lmd/inc/lmdtdso.h"
#include "valsmsapi.h"
#include "do_slcapi.h"
#include "do_clcapi.h"
#include "../clc/inc/clcidp.h"
#include "../lmd/inc/lmddefs.h"
...
#include "lecapi.h"
#include "hscapi.h"
#include "../cl1tst/inc/cl1tstmetaif.h"
#include "../cl1tst/inc/cl1tsteltif.h"
#include "../evl1/inc/evl1shtxsthphyut.h"
#include "../cl1/inc/cl1tstphyutmain.h"
#include "../cl1tst/inc/cl1tstl1psif.h"
...
#if 0 /* temperaly remove to fix build error */
/* under construction !*/
/* under construction !*/
/* under construction !*/
/* under construction !*/
...
typedef struct
{
    LOCAL_PARA_HDR
    DRCSpyDataT  msg;
    /* --GlobalAdjHw kal_int16, scale= Q7, format=%2.3f, indent=1
       --DRCC2I kal_int16, scale=Q6, format=%2.3f, indent = 1
       --C2ILong, kal_uint16, scale=Q9, format=%2.3f, log10=true, logscale=10
       (------FtmTypeCcMacId = CcMacId|(FTMSubType<<4);)
       ...
       --MacJammer, kal_uint8, base=enum:0 InAct/1 Act

    msg.DRCTable:
    C2IThrSW(dB), kal_int16, scale=Q7, format=%2.3f
    ThrAWGnHW, kal_int16, scale=Q6, format=%2.3f

    */
} uts_cp_fcp_drc_table_msg_struct;
...
}elt_lec_tst_gps_pgps_on_off_rsp_msg_strut;
...
/* MSG_ID_ELT_HWD_TST_PLL_CHANNEL_CONFIG_CMD_MSG*/
typedef enum
{
    Automatic_mode= 0,
    Disable_mode = 1,
...
{
    LOCAL_PARA_HDR
    HwdCtrlModeUtsT CtrlMode;
//  HwdCtrlUnitT CtrlUnit;   /* bit-map field */
    SysAirInterfaceT RfMode;
    RfRxPathsTypeT        MdmMain;      /* Main, Div or Sec */
    RfRxPathsTypeT        MdmDiv;       /* Main, Div or Sec */
    SysCdmaBandT Band;
    kal_uint16       Channel;
} elt_hwd_tst_pll_channel_config_cmd_msg_struct;

/* MSG_ID_ELT_HWD_TST_PLL_CHANNEL_CONFIG_RSP_MSG*/
typedef struct
{
    LOCAL_PARA_HDR
} elt_hwd_tst_pll_channel_config_rsp_msg_struct;

/* MSG_ID_ELT_HWD_TST_PLL_CHANNEL_GET_CMD_MSG*/
typedef struct
{
    LOCAL_PARA_HDR
    RfRxPathsTypeT    RfPath;
} elt_hwd_tst_pll_channel_get_cmd_msg_struct;

/* MSG_ID_ELT_HWD_TST_PLL_CHANNEL_GET_RSP_MSG*/
typedef struct
{
    LOCAL_PARA_HDR
    SysCdmaBandT Band;
    kal_uint16 Channel;
} elt_hwd_tst_pll_channel_get_rsp_msg_struct;
...
} l4c_enter_normal_mode_req_struct;
