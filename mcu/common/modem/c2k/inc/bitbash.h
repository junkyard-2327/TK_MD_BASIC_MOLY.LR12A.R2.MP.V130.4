...
#define putDword( Data, StartBit, NumBits, Value)\
  ...
  BYTE  __getByte( const char *moduleName, unsigned lineNumber, BYTE *Data, WORD StartBit, BYTE NumBits );
  WORD  __getWord( const char *moduleName, unsigned lineNumber, BYTE *Data, WORD StartBit, BYTE NumBits );
  DWORD __getDword( const char *moduleName, unsigned lineNumber, BYTE *Data, WORD StartBit, BYTE NumBits );

  void  __putByte( const char *moduleName, unsigned lineNumber, BYTE *Data, WORD StartBit, BYTE NumBits, BYTE Value );
  void  __putWord( const char *moduleName, unsigned lineNumber, BYTE *Data, WORD StartBit, BYTE NumBits, WORD Value );
  void  __putDword( const char *moduleName, unsigned lineNumber, BYTE *Data, WORD StartBit, BYTE NumBits, DWORD Value );

#else
  BYTE  getByte( BYTE *Data, WORD StartBit, BYTE NumBits );
  WORD  getWord( BYTE *Data, WORD StartBit, BYTE NumBits );
  DWORD getDword( BYTE *Data, WORD StartBit, BYTE NumBits );

  void  putByte( BYTE *Data, WORD StartBit, BYTE NumBits, BYTE Value );
  void  putWord( BYTE *Data, WORD StartBit, BYTE NumBits, WORD Value );
  void  putDword( BYTE *Data, WORD StartBit, BYTE NumBits, DWORD Value );
