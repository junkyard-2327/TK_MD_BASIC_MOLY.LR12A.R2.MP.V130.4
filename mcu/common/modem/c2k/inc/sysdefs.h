...
typedef kal_bool            Bool;         /* Boolean                        */
typedef kal_bool            BOOL;         /* Boolean                        */
typedef kal_uint8           BYTE;         /* Unsigned 8-bit quantity        */
typedef kal_uint8           UBYTE;        /* Unsigned 8-bit quantity        */
typedef kal_uint16          UWORD;        /* Unsigned 16-bit quantity       */
typedef kal_uint16          WORD;         /* Unsigned 16-bit quantity       */
typedef kal_int16           SWORD;        /* Signed 16-bit quantity         */
typedef kal_uint32          DWORD;        /* Unsigned 32-bit quantity       */
