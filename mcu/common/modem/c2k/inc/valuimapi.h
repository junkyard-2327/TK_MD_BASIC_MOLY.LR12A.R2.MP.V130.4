...
*********************************************************************************/
void ValUimPollingReq(kal_uint16 Interval);
...
*********************************************************************************/
kal_bool ValUimSpecCmd(ValUimCmdT Cmd, kal_uint16 FileId, kal_uint8 P1, 
    kal_uint8 P2, kal_uint8 P3, kal_uint8 *DataP, ExeRspMsgT* RspInfo, kal_uint8 Dfid, kal_uint8 sessionId);
...
*****************************************************************************/
  void ValUimEnvelope(uint8 len, uint8 *data,bool is_ap_envelope);
...
*****************************************************************************/
extern kal_bool ValUimUtkRefreshProcess(kal_uint8 *BufDataP,kal_uint8 Len, uint8 *ApIndicator);
