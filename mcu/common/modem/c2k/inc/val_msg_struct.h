...
#include "valpswapi.h"
#include "valat.h"
#include "../val/valgpsrpccomm.h"
#include "../val/valiratapi.h"
#include "valsmsapi.h"
#include "../val/atc/valatcdefs.h"
#include "../val/val_trace_parse.h"
#include "do_clcapi.h"
#include "valdbmapi.h"
#include "../val/valsmsdandcn.h"
#include "uim_msg_struct.h"
#include "../val/valmpcapi.h"
#include "../val/valgpsrpccomm.h"
...
{
    LOCAL_PARA_HDR
} val_sms_dandcn_read_nvram_rsp_struct;

typedef struct
{
    LOCAL_PARA_HDR
} val_sms_dandcn_write_nvram_rsp_struct;
...
}val_uim1_get_mdn_cnf_msg_struct;
...
typedef struct
{
    LOCAL_PARA_HDR
    uim_get_mdn_cnf_struct msg;
}val_uim2_get_mdn_cnf_msg_struct;
...
}val_uim1_at_card_error_ind_struct;

typedef val_uim1_at_card_error_ind_struct val_uim2_at_card_error_ind_struct;
...
}val_uim1_at_card_type_ind_struct;

typedef val_uim1_at_card_type_ind_struct val_uim2_at_card_type_ind_struct;
...
}val_uim1_get_home_sid_nid_cnf_msg_struct;
...
typedef struct
{
    LOCAL_PARA_HDR
    uim_get_home_sid_nid_cnf_struct msg;
}val_uim2_get_home_sid_nid_cnf_msg_struct;
...
}val_uim1_get_iccid_msg_struct;

typedef struct
{
    LOCAL_PARA_HDR
    uim_get_iccid_cnf_struct msg;
}val_uim2_get_iccid_msg_struct;

typedef struct
{
    LOCAL_PARA_HDR
    uim_get_card_app_info_cnf_struct msg;
}val_uim1_get_app_info_rsp_msg_struct;

typedef struct
{
    LOCAL_PARA_HDR
    uim_get_card_app_info_cnf_struct msg;
}val_uim2_get_app_info_rsp_msg_struct;
...
typedef struct
{
  ...
  IMSIType        IMSI_Tp;
  uint8                   hrpd_NAI[C2K_HRPD_NAI_LEN];
  uint8                   hrpd_NAI_len;
...
}val_uim1_get_uimid_cnf_msg_struct;

typedef struct
{
    LOCAL_PARA_HDR
    uim_get_uimid_cnf_struct msg;
}val_uim2_get_uimid_cnf_msg_struct;
...
}val_uim1_get_cst_info_rsp_msg_struct;

typedef struct
{
    LOCAL_PARA_HDR
    UimGetCstRspMsgT msg;
}val_uim2_get_cst_info_rsp_msg_struct;
...
}val_uim1_cache_mdn_rec_ind_msg_struct;

typedef struct
{
    LOCAL_PARA_HDR
    cuim_mdn_ef_data_struct msg;
}val_uim2_cache_mdn_rec_ind_msg_struct;
