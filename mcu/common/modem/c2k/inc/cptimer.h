 ...
 *
 *  06 27 2019 tina.ma
 *  [MOLY00417064] 【minidump】【TOP3】【市场反馈】【错误用户3/错误次数3】(MCU_core1,vpe0,tc0(VPE2)) [ASSERT] file:mcu/pcore/modem/lte_sec/errc/assert/errc_el1_assert_csr.c line:81
 *  	
 *  	.
 *
 *  09 04 2017 tina.ma
 ...
 *  	
 *  	R2 MP: Expends 180ms Idle HO delay timer length to 200ms
 *
 *  05 24 2017 gavin.zhang
...
#endif
    CP_ACCESS_PROTECTION_TIMER,       /* 73 access protection timer */
...
CPFrameTimerId;
  ...
  typedef struct
  {
    ...
    DWORD       frameCount;       /* Current frame count                */
#ifdef TRACEON
 ...
 ****************************************************************************/
  ...
  kal_bool cpStartTimer (CPTimerId timer, DWORD interval);
