...
kal_uint8 QoMGetResvLabelByMatchingTFT(kal_uint8* startingAddr, kal_uint16 frameType);
...
QosSubScriberProfileT*  QOMGetSubScribeQoSByProfileId(kal_uint16 ProfileID);
void QOMUpdateFwdSubScribTable(QoMPktFilterContentT *pTft, QosSubBlobT *pBlob, kal_uint8 PdnId);
QoMPktFilterContentT*  QOMGetTftByLabel(kal_uint8 Label);
void QOMSetFlowPortNum(kal_uint8 ReservationLabel, kal_uint16 PortNum);
