...
typedef struct
{
    bool isMoCall;              /* to indicate the released call is MO call or MT call
                                                         TRUE: MO call
                                                         FALSE:MT call
                                                     */
...
extern void ValCsRegStatusNotifyIndMsg(void);
