...
kal_bool VdmSetDcEnable(Bool enable);
kal_bool VdmSetPrlEnable(Bool enable);
kal_bool VdmSetFumoEnable(Bool enable);
kal_bool VdmSetLogEnable(Bool enable);
...
void VdmSetHFAEnable(Bool enable);
