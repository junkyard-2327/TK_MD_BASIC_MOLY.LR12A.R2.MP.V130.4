 ...
 * [MOLY00344631] [Rose][SYLVIA][O1][BSP+]Can not dial 911 successfully when only insert ct3g card
 * 	
 * 	.R2
 *
 * 08 08 2018 derek.yang
 ...
 * 	.R2
 *
 * 09 22 2017 aric.chiu
 * [MOLY00279906] [Low Power]插卡熄屏待机每30s有一次?醒。?卡熄屏待机，波形????律
 * [mll1-xl1] add cell_list_status_bitmap in measure_done_ind_struct.
 *
 * 09 01 2017 raphael.tsai
 * [MOLY00275259] [Gen93][Network Search Optimization] Code Merge from LR11 to UMOLYA LR12A.R2.
 * Check-in C2K interface first for C2K ADZ
 *
 * 08 08 2017 raphael.tsai
