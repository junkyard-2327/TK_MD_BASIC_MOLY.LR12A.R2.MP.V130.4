...
/* This structure for MSG_ID_LPP_EL1MPC_OTDOA_ASSIST_DATA_REQ */
typedef struct
{
    LOCAL_PARA_HDR
    kal_uint16                           transactionID;
...
} lpp_el1mpc_otdoa_assist_data_req_struct;


/* This structure for MSG_ID_LPP_EL1MPC_OTDOA_MEAS_ABORT_REQ */
typedef struct
{
    LOCAL_PARA_HDR
    kal_uint16  transactionID;
} lpp_el1mpc_otdoa_meas_abort_req_struct;


/* This structure for MSG_ID_LPP_EL1MPC_OTDOA_ASSIST_DATA_CLEAR_NTF  */
typedef struct
{
    LOCAL_PARA_HDR
    /* empty */
} lpp_el1mpc_otdoa_assist_data_clear_ntf_struct;
...
/* This structure for MSG_ID_LPP_EL1MPC_OTDOA_MEAS_CNF */
typedef struct
{
    LOCAL_PARA_HDR
    kal_uint16                      transactionID;
    lpp_otdoa_measured_info_struct  measurementResult;
} lpp_el1mpc_otdoa_meas_cnf_struct;


/* This structure for MSG_ID_LPP_EL1MPC_OTDOA_ASSIST_DATA_CNF */
typedef struct
{
    LOCAL_PARA_HDR
    kal_uint16  transactionID;
} lpp_el1mpc_otdoa_assist_data_cnf_struct;


/* This structure for MSG_ID_LPP_EL1MPC_OTDOA_ADDITIONAL_ASSIST_DATA_IND*/
typedef struct
{
    LOCAL_PARA_HDR
    kal_uint16  transactionID;   /* assoicated measurement transaction ID */
    kal_uint16  physCellId;      /* [0..503] */
} lpp_el1mpc_otdoa_additional_assist_data_ind_struct;
