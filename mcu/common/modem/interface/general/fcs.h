...
#define FCS_CG_SET2 ((volatile kal_uint16*)(L1_BASE_MADDR_L1INFRA_CONF+0x0004))/* FCS gate clock */
#define FCS_CG_CLR2 ((volatile kal_uint16*)(L1_BASE_MADDR_L1INFRA_CONF+0x0008))/* FCS ungate clock */
...
#define FCS_CLK_OFF() HW_WRITE(FCS_CG_SET2,(1 << 3))
#define FCS_CLK_ON() HW_WRITE(FCS_CG_CLR2,(1 << 3))
