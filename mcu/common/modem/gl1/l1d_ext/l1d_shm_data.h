...
MMRF_CUSTOM_DECLARE_SHARED_ARRAY(sNSFT_ADJUST_TPO*, Adjust_TPO_GMSK_SHM_TABLE, FrequencyBandCount);
   #if IS_EPSK_TX_SUPPORT   
     #if IS_EPSK_ADJUST_TPO_SUPPORT
MMRF_CUSTOM_DECLARE_SHARED_ARRAY(sNSFT_ADJUST_TPO*, Adjust_TPO_EPSK_SHM_TABLE, FrequencyBandCount);
