...
#define  IS_CHIP_MT6293                       ((CHIP_ID==CHIP_ID_MT6293) || (CHIP_ID==CHIP_ID_MT6763) || (CHIP_ID==CHIP_ID_MT6739) || (CHIP_ID==CHIP_ID_MT6771) || (CHIP_ID==CHIP_ID_MT6765) || (CHIP_ID==CHIP_ID_MT6761))
...
#if (IS_RF_MT6177L && defined(__IS_2G_6DB_DYNAMIC_GAINTABLE_SWITCH_SUPPORT__))
#define IS_2G_6DB_DYNAMIC_GAINTABLE_SWITCH_SUPPORT    1  //Boost 6dB LPF2 Gain for Pin=-96~-102dBm
#define IS_2G_DYNAMIC_GAINTABLE_SWITCH_SUPPORT        0
#elif ((IS_RF_MT6177L || IS_RF_MT6177M) && defined(__IS_2G_DYNAMIC_GAINTABLE_SWITCH_SUPPORT__))
#define IS_2G_6DB_DYNAMIC_GAINTABLE_SWITCH_SUPPORT    0
#define IS_2G_DYNAMIC_GAINTABLE_SWITCH_SUPPORT        1  //Boost 3dB LPF2 Gain for Pin=-96~-102dBm
#else
#define IS_2G_6DB_DYNAMIC_GAINTABLE_SWITCH_SUPPORT    0
#define IS_2G_DYNAMIC_GAINTABLE_SWITCH_SUPPORT        0
#endif
...
#define IS_DUAL_LOOP_AFC_CONTROL_SUPPORT           0
   ...
   #if IS_CHIP_TK6291 || IS_CHIP_MT6755 || IS_CHIP_MT6292 || IS_CHIP_MT6293
      #if defined(L1D_TEST)
#define IS_DSP_RX_NBIC_SUPPORT                     0 /* Exclude for HW SIM */
      #else
#define IS_DSP_RX_NBIC_SUPPORT                     1 /* Target and xL1Sim  */
      #endif
   #else
...
#if IS_ANT_RXPWR_OFFSET_SUPPORT || IS_SAR_TX_POWER_BACKOFF_DB_SUPPORT
...
#define IS_2G_RX_DIVERSITY_PATH_SUPPORT             1
#define IS_GL1D_RXD_SUPPORT                         1
#define IS_2G_RXD_SUPPORT                           1
#define IS_2G_RAS_SUPPORT                           1

#define IS_GSM_RX_RXD_MODE_FIXED                    0 //Force RXD mode before GL1C RAS involve 

#else
#define IS_2G_RX_DIVERSITY_PATH_SUPPORT             0
#define IS_GL1D_RXD_SUPPORT                         0
#define IS_2G_RXD_SUPPORT                           0
#define IS_2G_RAS_SUPPORT                           0

#define IS_GSM_RX_RXD_MODE_FIXED                    0
#endif

#if defined(__2G_RX_DIVERSITY_PATH_SUPPORT__) && defined(__2G_RXD_ENHANCEMENT_SUPPORT__)
...
#if defined (__MTK_TARGET__) && IS_CHIP_MT6761
