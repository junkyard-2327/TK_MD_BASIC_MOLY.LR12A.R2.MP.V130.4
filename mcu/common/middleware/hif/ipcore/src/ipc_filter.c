 ...
 */
static INLINE kal_bool
ipc_shift_did_content_ptr(
    kal_uint8  *base_addr_p,
    upcm_did   *did,
    kal_uint32  base_si_idx,
    kal_uint32  offset,
    kal_uint8 **offset_addr_pp,
    kal_uint32 *offset_si_idx_p
)
{
    ...
    if (UPCM_DID_SI_GET_EOL(curr_si)) {
        ...
        *offset_si_idx_p = base_si_idx;
        ...
        offset_addr_p = base_addr_p;
        remaining_offset = offset;
        remaining_si_length = (kal_uint32)(UPCM_DID_SI_GET_LEN(curr_si)) -
                              (kal_uint32)(base_addr_p - ((kal_uint8*)UPCM_DID_SI_GET_DATAPTR(curr_si) + UPCM_DID_SI_GET_OFFSET(curr_si)));
 ...
 */
static INLINE kal_bool
ipc_get_continuous_content_did(
    kal_uint8  *base_addr_p,
    kal_uint32  offset,
    upcm_did   *did,
    kal_uint32  base_si_idx,
...
)
{
    ...
    *cont_addr_pp = NULL;
    ...
    if (UPCM_DID_SI_GET_LEN(curr_si) >= ( (kal_uint32)((kal_uint8*)base_addr_p -
                                          ((kal_uint8*)UPCM_DID_SI_GET_DATAPTR(curr_si) + UPCM_DID_SI_GET_OFFSET(curr_si))) + offset + length) )
    ...
    /* Copy content to alternative buffer */
    {
        ...
        /* Copy data from source (sit) to destination (single buffer) */
        {
            ...
            remaining_length = length;
            remaining_si_length = (kal_uint32)(UPCM_DID_SI_GET_LEN(curr_si)) -
                                  (kal_uint32)(data_src_p - ((kal_uint8*)UPCM_DID_SI_GET_DATAPTR(curr_si) + UPCM_DID_SI_GET_OFFSET(curr_si)));
            ...
            while (remaining_length)
            {
                ...
                } else
                {
                    ...
                    data_dst_p = (kal_uint8*)(data_dst_p + remaining_si_length);
...
/*
 * ipc_get_packet_info() functions for different descriptor type.
 * Please see ipc_func_get_packet_content.h for more information.
 */
#define __IPC_DES_DID__
#include "func_prototype/ipc_func_get_packet_content.h"
#undef __IPC_DES_DID__

#define __IPC_DES_GPD__
#include "func_prototype/ipc_func_get_packet_content.h"
#undef __IPC_DES_GPD__
    ...
    ipc_filter_info_t  *filter_info)
{
    ...
    ipc_pkt_do_filter_result_e  matched = KAL_FALSE;
