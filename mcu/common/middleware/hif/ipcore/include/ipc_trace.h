...
BEGIN_TRACE_MAP(MOD_IPCORE)
    ...
    TRC_MSG(IPC_TR_GET_INFO_DID_V4_IPV4_HDR_FAILED, "[IPCORE] ipc_get_packet_info_did(): V4 get IPv4 header continuous content failed: ip_packet(0x%x), offset(%d), did(0x%x), base_si_idx(0x%x), length(%d)")
    TRC_MSG(IPC_TR_GET_INFO_DID_V4_UDP_HDR_FAILED, "[IPCORE] ipc_get_packet_info_did(): V4 get UDP header continuous content failed: ip_packet(0x%x), offset(%d), did(0x%x), base_si_idx(%d), length(%d)")
    TRC_MSG(IPC_TR_GET_INFO_DID_V4_TCP_HDR_FAILED, "[IPCORE] ipc_get_packet_info_did(): V4 get TCP header continuous content failed: ip_packet(0x%x), offset(%d), did(0x%x), base_si_idx(%d), length(%d)")
    TRC_MSG(IPC_TR_GET_INFO_DID_V4_ICMP_HDR_FAILED, "[IPCORE] ipc_get_packet_info_did(): V4 get ICMP header continuous content failed: ip_packet(0x%x), offset(%d), did(0x%x), base_si_idx(%d), length(%d)")
    TRC_MSG(IPC_TR_GET_INFO_DID_V6_IPV6_HDR_FAILED, "[IPCORE] ipc_get_packet_info_did(): V6 get IPv6 header continuous content failed: ip_packet(0x%x), offset(%d), did(0x%x), base_si_idx(%d), length(%d)")
    TRC_MSG(IPC_TR_GET_INFO_DID_V6_UDP_HDR_FAILED, "[IPCORE] ipc_get_packet_info_did(): V6 get UDP header continuous content failed: ip_packet(0x%x), offset(%d), did(0x%x), base_si_idx(%d), length(%d)")
    TRC_MSG(IPC_TR_GET_INFO_DID_V6_TCP_HDR_FAILED, "[IPCORE] ipc_get_packet_info_did(): V6 get TCP header continuous content failed: ip_packet(0x%x), offset(%d), did(0x%x), base_si_idx(%d), length(%d)")
    TRC_MSG(IPC_TR_GET_INFO_DID_V6_ICMP_HDR_FAILED, "[IPCORE] ipc_get_packet_info_did(): V6 get ICMP header continuous content failed: ip_packet(0x%x), offset(%d), did(0x%x), base_si_idx(%d), length(%d)")
    TRC_MSG(IPC_TR_GET_INFO_DID_FIND_V6_EXT_HDR_FAILED, "[IPCORE] ipc_get_packet_info_did(): V6 extension header continuous content get failed: did(0x%x) base_si_idx(%d) next_header(0x%x) offset(%d) curr_si_idx(%d)")
    TRC_MSG(IPC_TR_GET_INFO_DID_FIND_V6_EXT_HDR_SHIFT_FAILED, "[IPCORE] ipc_get_packet_info_did(): V6 header next header shift failed: did(0x%x) base_si_idx(%d) ip_packet(0x%x) offset(%d) next_header(0x%x) curr_si_idx(%d)")
