 ...
 * $Log$
 *
 * 04 18 2019 yulong.chang
 * [MOLY00399644] [Ben181020-045][FT-Indonesia-Jakarta][System Function] DUT can not access Smartfren SIM Toolkit (10/10)
 * 	
 * 	STK call over IMS (VDM part)
 *
 * 05 22 2018 jerry.cheng
 * [MOLY00327538] [Cervino][O1 BSP+][SRLTE][om c2k6m][FT][CT hVoLTE][SH][Auto][CAT] md1:(MCU_core0,vpe0,tc0(VPE0)) [ASSERT] file:mcu/pcore/modem/atp/src/atp_other_funcs.c line:134 (VDM R2.MP)
 * .[R2] .AT+EHVOLTE always return cnf success, VDM should resume ads when receives +EGMSSC2K: 1
 *
...
MSG_ID_VDM_ATP_SIGNAL_POWER_LEVEL_IND,
...
MSG_ID_VDM_CTRL_ADS_RF_STATE_IND,
MSG_ID_VDM_CTRL_ADS_SIGNAL_POWER_LEVEL_IND,
