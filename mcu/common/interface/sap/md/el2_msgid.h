 ...
 * $Log$
 *
 * 01 04 2019 tina-yt.wang
 * [MOLY00376395] 4G´å??©µÉ¬¤Æ«H®§¥Ó?
 ...
 * [MOLY00299100] [MT6771][Sylvia][O1][WW FT][Russia][Moscow][4GMM][SIM1:Megafon][SIM2:Beeline][Overnight][SWIFT]Modem Warning,927,950,99,/data/vendor/core/,2,,Modem Warning: +EWARNING: [1][823] upcm.c #4447
 * sending pdcp invalid control pdu to avoid entering sleep. (R2) - common files
 *
 ...
 * [R2] LCID vs. support release handling
 *
 * 08 22 2017 cammie.yang
 * [MOLY00272777] [Gen93]TPB/Mobility Ctrl patch check in
 * [R2][Merged from R1][EPDCP][HST] set vip bit and notify VoLTE bearer for ERLCUL
 *
 ...
 * [R2.MP] move LMAC HARQ reset to el2pow
 *
 ...
 * [R2.MP] fix Poll control of TXLISR and EL2POW
 *
 ...
 * [R2.MP] power on Copro before TXLISR handle SCH_CLOSE (for LMAC HARQ RESET)
 *
 * 07 17 2017 peter.yu
 ...
 * 	
 * 	[UMOLYA][LR12A.MP1] API update for LTECSR VoLTE EBI indication
 *
