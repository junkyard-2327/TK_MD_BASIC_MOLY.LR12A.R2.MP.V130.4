...
#ifdef __SEC_TEST__
//msg id define for SECTEST
MODULE_MSG_BEGIN( MSG_ID_SECTEST_CODE_BEGIN )
MSG_ID_L4C_SECTEST_TEST_REQ = MSG_ID_SECTEST_CODE_BEGIN,
MODULE_MSG_END( MSG_ID_SECTEST_CODE_TAIL )
#endif
   /*---------------L4_MSG_CODE_END---------------------*/
