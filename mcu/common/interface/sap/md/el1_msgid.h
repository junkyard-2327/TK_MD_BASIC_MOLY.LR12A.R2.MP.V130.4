 ...
 * $Log$
 *
 * 05 25 2018 alice.tsai
 * [MOLY00327393][EL1 CH]efuse: 256qam check
 *
 * 04 02 2018 gary.liu
 * [MOLY00316790] eMBMS feature design
 * [EL1C] eMBMS efuse
 *
 ...
 *
 * 09 13 2017 hyper.wang
 * [MOLY00176045] [UMOLYA][EL1 MEAS Development]
 * 	Refine SINR calculation
 * 	.
 *
 ...
 * [MOLY00265905] [EL1_MEAS_Development]
 *
 * 	Remove MEAS pathloss (R2).
 *
 * 08 25 2017 gary.liu
 ...
 * [HST Patch][TPB]EL1 Tx part
 *
 * 08 21 2017 gary.liu
 * [MOLY00207413] EL1C 6293 development
 * [EL1 CH] (R2) add new message to tell tx IDLE DRX config for TAS
 *
 ...
 * [EL1] B71 efuse
 *
 * 07 25 2017 jung-ching.hsieh
 * [MOLY00266605] Verizon' ota antenna infos
 * Porting 91 [VZW] feature to 93
 *
 * 07 11 2017 alex.chung
 * [MOLY00260337] [BIANCO] Enable L+L IDC
 * Enable IDC
 *
 * 07 04 2017 alex.chung
 ...
 *
 * 06 22 2017 hyper.wang
 * [MOLY00176045] [UMOLYA][EL1 MEAS Development]
 * 	Merge UMOLYA to MP1.5
 * 	.
 *
 ...
 *                          Destination: LPP
 ****************************************************************************/
MSG_ID_LPP_EL1MPC_OTDOA_ASSIST_DATA_REQ,
MSG_ID_EL1MPC_LPP_MSG_START               = MSG_ID_LPP_EL1MPC_OTDOA_ASSIST_DATA_REQ,
MSG_ID_LPP_EL1MPC_OTDOA_ASSIST_DATA_CLEAR_NTF,
MSG_ID_LPP_EL1MPC_OTDOA_MEAS_REQ,
MSG_ID_LPP_EL1MPC_OTDOA_MEAS_ABORT_REQ,
