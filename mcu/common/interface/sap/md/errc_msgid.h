 ...
 * $Log$
 *
 * 12 05 2019 srihari.maddipati
 * [MOLY00435321] [B190414-819]???????????????450 (????????????)
 * .
 *
 * 08 20 2019 aaroh.yang
 ...
 * 	
 * 	[LR12A.R2.MP][ERRC/SPV] Occupy CS during IPv6 RS/RA procedure - main part (OA)
 *
 * 07 12 2019 aaroh.yang
 * [MOLY00421181] [ERRC Interface][B190614-1550]【市?投?-PS】[FT-江?][移?+移?]?卡均插入移?4G卡，主卡?4G掉E网?，?致?法上网（在异常地?100%）Paging + local release + TAU
 * 	
 * 	[LR12A.R2.MP][ERRC/SPV] Add PROTECT_TAU_SERVICE_REQ interface and ERRC_API for HPS status query (OA)
 *
 * 10 25 2018 yl.chang
 * [MOLY00358943] [B180719-543]【市?投?】[FT-福建泉州]手机卡1卡2均注?CMCC 4G网?，待机5分?左右，副卡做被叫?法呼入（20/30）
 * [R2] AFC - OA
 *
 * 09 07 2018 yung-chun.lin
 * [MOLY00347533] [Gemini][L+L][Gen93] A2 trigger network release (ERRC part)
 * 	
 * 	[93][ERRC][MOB] new ERRC MSG_ID  for TRIGGER_RELEASE A2 triggering Connection Release
 * 	 - EPS Bearer Info
 * 	 - NAS trigger CONN REL NTF
 *
 * 06 21 2018 aaroh.yang
 * [MOLY00333203] [R2][ERRC] MPS enhancement (occupy HPS for SMS over IMS) - interface
 * [R2.MP][ERRC/SPV] SMS over IMS occupy HPS - interface part (OA)
 *
 * 02 08 2018 aaroh.yang
 * [MOLY00306890] [R2][Volunteer Patch][ERRC]Dual IMS registration enhacement - Interface part
 * [R2][ERRC/SPV] Occupy HPS/CS during IMS Service, Occupy CS during ESM Service - interface part (OA)
 *
 * 01 24 2018 tereasa.huang
 * [MOLY00277987] [UMOLYA][MOB][Interface]SRVCC收集
 * [R2][Interface] ERRC MOB SRVCC (OA).
 *
 ...
 * [R2][ERRC][SPV] SMS procedure with CS semaphore - EVAL/ERRC Interface (OA).
 *
 * 12 07 2017 tereasa.huang
 * [MOLY00290347] 238721【品??力】卡1?信4G》宿舍?王者?耀?程中》?繁出?网?460》5s左右恢复???2台机，2台3局游?共出?16次?(ERRC Interface)
 *
 * 12 07 2017 ke-ting.lee
 * [MOLY00294627] [Sylvia][O1][SRLTE][CT 6M C][VoLTE][FT][GZ][HW][CAT][Fatal error(buf)] err_code1:0x00000823 err_code2:0x00004000 err_code3:0xCCCCCCCC MD Offender:ERRC
 *
 * 12 07 2017 ke-ting.lee
 * [MOLY00294627] [Sylvia][O1][SRLTE][CT 6M C][VoLTE][FT][GZ][HW][CAT][Fatal error(buf)] err_code1:0x00000823 err_code2:0x00004000 err_code3:0xCCCCCCCC MD Offender:ERRC
 * .
 *
 * 11 15 2017 aaroh.yang
 ...
 * [MOLY00249711] [MT6293]Code sync from LR12 (W20, phase 26)- bug only
 ...
 * [MOLY00164081] 【CA】在配置有?波聚合的?域???据网?，???仍然?示4G+
 * OPPO 4G+ icon
