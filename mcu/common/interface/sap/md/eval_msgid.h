 ...
 * Sync ALPS04799724 - Peer SIM PLMN List handling (Interface).
 *
 * 12 23 2019 po-hung.lin
 * [MOLY00426354] (NWSEL interface part)新Feature需求：查?周?网?信?
 * 	
 * 	.
 *
 * 12 05 2019 zhe-hao.zhang
 * [MOLY00435269] [Interface][B190414-819]王者?耀游??程卡?，网?延?450 (?常出?，或?日多次复?) Protect MT SMS
 * 	
 * 	.
 *
 * 09 18 2019 rex.li
 ...
 *
 * 11 02 2018 zhe-hao.zhang
 * [MOLY00362078] [Operator][U3A PLUS 4G][VF][][R22][LTE_Voice_over_LTE]12010 SIP Registration - IMS reject - non-VoLTE SIM: ME will continue to send PDN request after recieve the netwrork reject
 * 	
 * 	[MOLY00357936] [Operator][U3A PLUS 4G][VF][][R22][LTE_Voice_over_LTE]12010 SIP Registration - IMS reject - non-VoLTE SIM: ME will continue to send PDN request after recieve the netwrork reject
 * 	
 * 	.
 *
 * 08 21 2018 kuan-hua.lin
 ...
 * 	.
 *
 * 08 20 2018 kuan-hua.lin
 * [MOLY00346768] [Msg_id][Cervino][P0][BSP+]VoLTE is not registered in this case
 * 	
 * 	.
 *
 * 06 07 2018 zanya.peng
 * [MOLY00330562] [R2][COMMON][Telephony PPM][Merlot][TC163]T1: network registration time is worse than ref phone and not stable
 * 	
 * 	.
 *
 * 04 03 2018 andy.huang
 * [MOLY00317712] [MT6758][Vinson][N1][Cat7][Performance index][FDD][SZ][SIM1:CU][SIM2:CU][4GMM][NWSEL-Interface]DUT performance worse than REF on 4G recovery time from no service
 * PLMN Loss Opt :  interface
 *
 * 03 20 2018 po-hung.lin
 * [MOLY00312153] [LR12A.R2.MP] Change IMEISV during RF OFF state - Interface
 *
 * 02 09 2018 xiaoting.wang
 ...
 *  SMS/EVAL
 *
 * 12 20 2017 zanya.peng
 * [MOLY00297241] SAR RB test mode_ETC part (header)
 * 	
 * 	.
 *
 * 12 07 2017 lucien.li
 * [MOLY00290363] 203604 【品??力】室?：卡1移?4G、卡2?信4G》??卡2?据》王者?耀游??程中[L4C][.header]
 * 	
 * 	[L4C][.header] AT+EMRO
 *
 * 11 17 2017 kuan-hua.lin
 * [MOLY00289945] [LR12A.R2.MP] L+L New Feature: Occupy HPS for IMS RE-REG (EMM-Common interface)
 * 	
 * 	EVAL/EMM msg id.
 *
 * 11 15 2017 kuan-wei.chen
 ...
 * 	extend AT+EVIVS:...,<rat>
 *
 * 09 01 2017 morning.lee
 * [MOLY00269252] TK/R1/R2 C+E RAC code check-in CR
 * 	
 * 	.
 *
 * 08 24 2017 kelly.lo
 ...
 * [MOLY00271229] [LR12A.R2.MP] [Rose][Vinson][N1]The ECC call will can't be dial out success.(5/5)
 * 	
 * 	.
 *
 * 04 26 2017 morning.lee
 * [MOLY00245171] [Copy MOLY00224343]VOLTE下被叫切?至GSM后?方挂?，切?回4G??有HD??，短??示又消失
 * 	
 * 	.
 *
 ...
 *
 * 10 19 2015 yc.chen
 * [MOLY00145708] [Jade-L][SRLTE][CT OM 6M][LTE IOT][FT][SH][ALU][Random]?搹b3GUAX??PSMCS??
 * 	.
 *
 ...
 * [MOLY00070824] [4G Gemini][FT][BJ][CSFB test][case5.1.1][SIM1 CMCC+SIM2 CMCC][4G,3G,2G蛁嚙踝蕭奀嚙諉橘蕭炡嚙稽
 * .
 *
 * 06 13 2014 aaron.liu
 * [MOLY00067559] [MT6592LTE][CSFB][Single USIM][CMCC FT][case5.1.1][4G,3G,2G嚙窯??嚙踝蕭嚙踝蕭??]
 * .EVAL interface part.
 *
 * 05 16 2014 lt.chang
 ...
 * [MOLY00056483] [MT6582LTE][SGLTE][CMCC FT][GZ]嚙箭?嚙踝蕭2G3G嚙踝蕭??嚙踝蕭b3G嚙皚嚙瘢???
