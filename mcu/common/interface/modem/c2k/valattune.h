 ...
 *   interface.  Set this switch to FALSE for Browser-Only applications.
 *
 * Restrictions:
 *   FALSE, TRUE
 *
 ...
 *
 * Notes:
 *   When this switch is set to FALSE, the following files can be excluded
 *   from the build-set:
 *     - ai_ch.c
 *     - ai_cmd.c
 *     - ai_dh.c
 ...
 *
 * Description:
 *   Setting this switch to TRUE disables EIA-617 extended command body
 ...
 *   TRUE
 */
#define AT_ALLOW_INVALID_BODY_CHARS TRUE
 ...
 *   This switch should only be set to TRUE if the MT software supports
 ...
 *   AT_CPS_SO_4104: TRUE
 */
#define AT_CPS_SO_07 TRUE
#define AT_CPS_SO_08 TRUE
#define AT_CPS_SO_15 TRUE
#define AT_CPS_SO_16 TRUE

#define AT_CPS_SO_22 TRUE
#define AT_CPS_SO_23 TRUE
#define AT_CPS_SO_24 TRUE
#define AT_CPS_SO_25 TRUE

#define AT_CPS_SO_26 FALSE
#define AT_CPS_SO_27 FALSE
#define AT_CPS_SO_28 FALSE
#define AT_CPS_SO_29 FALSE

#define AT_CPS_SO_33   TRUE
#define AT_CPS_SO_59   TRUE
#define AT_CPS_SO_69   TRUE

#define AT_CPS_SO_4103 TRUE
#define AT_CPS_SO_4104 TRUE
