...
typedef struct
{
    ...
    kal_uint16               pppha_push_in;
    kal_uint16               pppha_pull_out;
...
typedef struct
{
    ...
    kal_uint16                  q_rest_space;
    kal_uint16                  q_current_item;
    kal_uint16                  q_in_len;
    kal_uint16                  q_out_len;
