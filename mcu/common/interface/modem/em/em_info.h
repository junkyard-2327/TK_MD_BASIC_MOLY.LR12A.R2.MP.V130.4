...
EM_INFO(RRM_EM_MT_T3126_TIMEOUT_INFO,                       MOD_RRM_FDD, MOD_RRM_TDD, GEMINI_BITMASK, GEMINI_BITMASK, MSG_ID_EM_RRM_MT_T3126_TIMEOUT_IND)
...
EM_INFO(RRM_EM_DOWNLINK_SIGNALLING_COUNTER_INFO,            MOD_RRM_FDD, MOD_RRM_TDD, GEMINI_BITMASK, GEMINI_BITMASK, MSG_ID_EM_RRM_DOWNLINK_SIGNALLING_COUNTER_INFO_IND)
EM_INFO(RRM_EM_RACH_FAIL,                                   MOD_RRM_FDD, MOD_RRM_TDD,     GEMINI_BITMASK, GEMINI_BITMASK, MSG_ID_EM_RRM_RACH_FAIL_IND)
EM_INFO(RRM_EM_N200_EXP,                                    MOD_RRM_FDD, MOD_RRM_TDD,     GEMINI_BITMASK, GEMINI_BITMASK, MSG_ID_EM_RRM_N200_EXP_IND)
EM_INFO(RRM_EM_HO_FAIL,                                     MOD_RRM_FDD, MOD_RRM_TDD,     GEMINI_BITMASK, GEMINI_BITMASK, MSG_ID_EM_RRM_HO_FAIL_IND)
...
EM_INFO(EM_RRCE_3G_CELL_UARFCN_DL_UL_INFO_IND,  	MOD_URR_FDD, MOD_URR_TDD,   WCDMA_BITMASK,	   SINGLE_BITMASK, MSG_ID_EM_RRCE_3G_CELL_UARFCN_DL_UL_INFO_IND)
EM_INFO(EM_RRCE_RACH_FAIL_IND, 						 		 MOD_URR_FDD, MOD_URR_TDD,   WCDMA_BITMASK,		SINGLE_BITMASK, MSG_ID_EM_RRCE_RACH_FAIL_IND)
EM_INFO(EM_RRCE_MO_RLF_IND, 						 		 MOD_URR_FDD, MOD_URR_TDD,   WCDMA_BITMASK,		SINGLE_BITMASK, MSG_ID_EM_RRCE_MO_RLF_IND)
EM_INFO(EM_RRCE_3G3_HO_FAIL_IND, 						 		 MOD_URR_FDD, MOD_URR_TDD,   WCDMA_BITMASK,		SINGLE_BITMASK, MSG_ID_EM_RRCE_3G3_HO_FAIL_IND)
EM_INFO(EM_RRCE_3G2_HO_FAIL_IND, 						 		 MOD_URR_FDD, MOD_URR_TDD,   WCDMA_BITMASK,		SINGLE_BITMASK, MSG_ID_EM_RRCE_3G2_HO_FAIL_IND)
...
EM_INFO(USIME_EM_INFO_CAPABILITY,               MOD_URR_FDD, MOD_NIL,   WCDMA_BITMASK,     ZERO_BITMASK,     MSG_ID_FDD_EM_USIME_CAPABILITY_INFO_IND)
    ...
    /*CSR*/
EM_INFO(EM_CSR_STATUS_IND, MOD_CSR_FDD, MOD_CSR_TDD, WCDMA_BITMASK, SINGLE_BITMASK, MSG_ID_EM_CSR_STATUS_IND)
...
EM_INFO(EMM_L4C_CSFB_INFO,      MOD_EMM, MOD_NIL,   SINGLE_BITMASK,  ZERO_BITMASK, MSG_ID_EM_EMM_L4C_CSFB_INFO_IND)  //report when em_src is RMMI
