...
typedef struct
{
   ...
   LTE_MIPI_DATA_TABLE_T                **TpcDataTable;   /* LTE MIPI Tpc DATA Table                 */
   LTE_MIPI_TPC_SECTION_TABLE_DEFAULT    *PaTpcSecData;   /* LTE MIPI PA Tpc Section DATA Table      */   
   LTE_MIPI_EVENT_TABLE_T               **AntRxEventTable;   /* LTE MIPI Antenna Rx EVENT Table      */
   LTE_MIPI_DATA_SUBBAND_TABLE_T        **AntRxDataTable;    /* LTE MIPI Antenna Rx DATA Table       */
   LTE_MIPI_EVENT_TABLE_T               **AntTxEventTable;   /* LTE MIPI Antenna Tx EVENT Table      */
   LTE_MIPI_DATA_SUBBAND_TABLE_T        **AntTxDataTable;    /* LTE MIPI Antenna Tx DATA Table       */
   LTE_MIPI_EVENT_TABLE_T               **TasCatAEventTable; /* LTE MIPI TAS CAT A EVENT Table       */
   LTE_MIPI_DATA_TABLE_T                **TasCatADataTable;  /* LTE MIPI TAS CAT A DATA Table        */
   LTE_MIPI_EVENT_TABLE_T               **TasCatBEventTable; /* LTE MIPI TAS CAT B EVENT Table       */
   LTE_MIPI_DATA_TABLE_T                **TasCatBDataTable;  /* LTE MIPI TAS CAT B DATA Table        */
      #if IS_4G_TAS_CAT_C_SUPPORT 
   LTE_MIPI_EVENT_TABLE_T               **TasCatCEventTable; /* LTE MIPI TAS CAT C EVENT Table       */
   LTE_MIPI_DATA_TABLE_T                **TasCatCDataTable;  /* LTE MIPI TAS CAT C DATA Table        */
      #endif
   kal_uint32                            *RxEventSize;    /* LTE MIPI Rx EVENT Size Table            */
   kal_uint32                            *RxDataSize;     /* LTE MIPI Rx DATA Size Table             */
   kal_uint32                            *TxEventSize;    /* LTE MIPI Tx EVENT Size Table            */
...
typedef struct
{
   ...
   /* LTE NS INFO to bypass DPD*/   
   const LTE_DPD_BYPASS_DPD_NS_INFO_T     *LteDpdBypassDpdNsInfo;
...
typedef struct
{
   ...
   const LTE_CUSTOM_CA_DAT_LINKAGE_DATABASE_T  *dat_ca_linkage_reorg_database; /* LTE DAT CA LINKAGE DATABASE         */
      #endif
   #endif
   LTE_MIPI_EVENT_TABLE_T                     **ant_cat_a_event_table;         /* LTE MIPI ANT CAT A EVENT Table      */
   LTE_MIPI_DATA_TABLE_T                      **ant_cat_a_data_table;          /* LTE MIPI ANT CAT A DATA Table       */
   LTE_MIPI_EVENT_TABLE_T                     **ant_cat_b_event_table;         /* LTE MIPI ANT CAT B EVENT Table      */
   LTE_MIPI_DATA_TABLE_T                      **ant_cat_b_data_table;          /* LTE MIPI ANT CAT B DATA Table       */
