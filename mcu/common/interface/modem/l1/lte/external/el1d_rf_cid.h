...
#define __EL1D_ET_TEMPORARY_NOT_SUPPORT__      0
#else
#define __IS_EL1D_ET_SUPPORT__                 0
#define __EL1D_ET_TEMPORARY_NOT_SUPPORT__      0
#if defined(MT6771)
#define __EL1D_ET_FEC_INTERFACE_NOT_SUPPORT__  1
#else //#if defined(MT6771)
#define __EL1D_ET_FEC_INTERFACE_NOT_SUPPORT__  0
#endif//#if defined(MT6771)
#endif
