 ...
 * [MOLY00313622] [Cervino] Cont Rx PCS not have signal- for RXD LR12A.R2.MP.
 *
 * 01 19 2018 yungshian.lai
 * [MOLY00303241] [MT6793][MT6795] GSM RXD Development for common part - TST part.
 *
 * 12 07 2017 chia-hung.tsai
 * [MOLY00293975] [GSM] NSFT Adjust Tx Power Offset feature
 * 	
 * 	.
 *
 * 09 05 2017 yungshian.lai
 * [MOLY00275140] [Bianco] 93 2G Cal Time Reduction Development - LR12A.R2.MP.
 *
 ****************************************************************************/
...
typedef enum
{
   ...
   g_get_tpo_value             = RF_TEST_CMD_GET_TPO_VALUE,  // 111
   g_set_tpo_value             = RF_TEST_CMD_SET_TPO_VALUE,  // 112
...
|* GET/SET TPO Command *|
\* ------------------------------------------------------------------------------------ */
typedef RfTestCmdGetTPO                         g_get_tpo_value_req_param_struct;
typedef RfTestResultGetTPO                      g_get_tpo_value_cnf_param_struct;

typedef RfTestCmdSetTPO                         g_set_tpo_value_req_param_struct;
typedef RfTestCmd_NoParam                       g_set_tpo_value_cnf_param_struct;
