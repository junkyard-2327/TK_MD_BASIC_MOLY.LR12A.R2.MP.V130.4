 ...
 *
 * 07 19 2018 yungshian.lai
 * [MOLY00339354] [MMRF] Make sure RF Cal Data accuracy Development- R2 MP.
 *
 ...
 * [MOLY00198691] MMRF MIPI CW set get tst part (R2)
 *
 * 11 08 2017 ming-chien.hung
 * [MOLY00281066] [ET] new create LTE/WCDMA ET.ET normal mode part.
 *
 ...
 * [MOLY00277821][MT6293][DPD][SMT] DPD code update. 3G traditional cal force APT mode.
 *
 * 09 08 2017 lin.cao
 * [MOLY00276517] [MT6293][C2K][DPD]Feature Submit [C2K DPD MML1 change]
 *
 * 09 07 2017 lin.cao
 * [MOLY00276517] [MT6293][C2K][DPD]Feature Submit [C2K DPD MML1 change]
 *
 ...
 * .
 *
 * 06 29 2017 kai-wei.chou
 * [MOLY00256747] [DPD] new create LTE/WCDMA DPD.
 * .
 *
 * 05 25 2017 samuel.yang
...
typedef enum
{
   ...
   MMRF_TEST_CMD_START_ET_PATH_DELAY_SEARCH_V2       = 49,
   ...
   MMRF_TEST_CMD_START_ET_FAC_CAL_V3                 = 68,
   MMRF_TEST_CMD_GET_ET_CAL_RESULT_V3                = 69,
   MMRF_TEST_CMD_SET_ET_CAL_RESULT_V3                = 70,
   MMRF_TEST_CMD_CHECK_ET_PATH_DELAY_SEARCH_V3       = 71,
...
typedef struct
{
   ...
   ERfTestCmd_StartEtFacCal_ReqInfo   start_info;
   
}MMRfTestCmd_StartEtFacCalV3_ReqParam;

typedef struct
{
   ERfTestCmd_StartETFacCal_peer      cal_para;

} MMRfTestCmd_StartETFacCalV3_ReqPdu;

typedef struct
{
   ERfTest_EtFacCal_StatusType          et_status;
   ERfTestCmd_StartEtFacCal_CnfInfo     et_error_msg;
   kal_uint16                           et_rat_idx;

}MMRfTestCmd_StartEtFacCalV3_CnfParam;
...
typedef struct
{
   ...
   /* Request local buffer pointer */
   MMRfTestCmd_StartEtFacCalV3_ReqParam           *p_req_local; 

   /* Confirm local buffer pointer */   
   MMRfTestCmd_StartEtFacCalV3_CnfParam           *p_cnf_local;
   
}MMRfTest_StartEtFacCalV3Mix;
...
}MMRfTestCmd_SetEtCalResultV3_ReqParam;

typedef struct
{   
   kal_uint16                          rat_idx;
   ERfTestCmd_SetEtCalResult_CnfInfo   set_cnf_info;

}MMRfTestCmd_SetEtCalResultV3_CnfParam;

typedef struct
{
   ERfTestCmdEtCalResult_peer cal_data_info;

}MMRfTestCmd_SetLteEtCalResultV3_ReqPdu;
...
typedef struct
{
   ...
   /* Request local buffer pointer */
   MMRfTestCmd_SetEtCalResultV3_ReqParam               *p_req_local; 

   /* Confirm local buffer pointer */   	
   MMRfTestCmd_SetEtCalResultV3_CnfParam               *p_cnf_local;
   
}MMRfTest_SetEtCalResultV3Mix;
...
typedef struct
{
   /* bitmap:(0|0|Lf|Lt|W|C|T|G) */
   kal_uint16                          rat_idx;
   ERfTestCmd_GetEtCalResult_ReqInfo   get_req_info;
   
}MMRfTestCmd_GetEtCalResultV3_ReqParam;

typedef struct
{
   ERfTestCmdEtCalResult_peer cal_data_info;

}MMRfTestCmd_GetLteEtCalResultV3_CnfPdu;
...
}MMRfTestCmd_GetEtCalResultV3_CnfParam;

typedef struct
{
   /* Request local buffer pointer */
   MMRfTestCmd_GetEtCalResultV3_ReqParam               *p_req_local;

   /* Confirm local buffer pointer */   	
   MMRfTestCmd_GetEtCalResultV3_CnfParam               *p_cnf_local;

   /* Confirm peer buffer pointer */
   ilm_struct                                          *p_cnf_ilm;
   
}MMRfTest_GetEtCalResultV3Mix;
...
} MMRfTestCmd_CheckEtPathDelaySearchV3_ReqParam;

typedef struct
{

   ERfTestETPathDelayCheckStatusType et_path_delay_check_status;

   kal_uint16 rat_idx;

} MMRfTestCmd_CheckEtPathDelaySearchV3_CnfParam;

typedef struct
{
   ERfTestCmd_CheckEtPathDelaySearch_peer et_info;
      
}MMRfTestCmd_CheckEtPathDelaySearchV3_CnfPdu;

typedef struct
{
   /* Request local buffer pointer */
   MMRfTestCmd_CheckEtPathDelaySearchV3_ReqParam       *p_req_local;

   /* Confirm local buffer pointer */  
   MMRfTestCmd_CheckEtPathDelaySearchV3_CnfParam       *p_cnf_local;

   /* Confirm peer buffer pointer */
   ilm_struct                                          *p_cnf_ilm;

}MMRfTestETPathDelayCheckV3Mix;
...
}MMRfTestCmd_StartEtPathDelaySearchV2_ReqParam;

typedef struct
{

   ERfTestETPathDelayStartStatusType             et_path_delay_start_status;

   ERfTestETPathDelayStartErrType                et_path_delay_start_error_code;
   
   MMRfTestCmd_StartEtPathDelaySearchV2_ReqParam et_path_delay_start_dim;
   
} MMRfTestCmd_StartEtPathDelaySearchV2_CnfParam;

typedef struct
{
   MMRfTestCmd_StartEtPathDelaySearchV2_ReqParam *p_req_local;
   MMRfTestCmd_StartEtPathDelaySearchV2_CnfParam *p_cnf_local;

}MMRfTestETPathDelayStartV2Mix;
...
{
   kal_uint16                         rat_idx;
   ERfTestSetToolUsageToL1ModeType    et_mode;
   ERfEtSetting                       et_setting;
}MMRfTestCmd_EtModeSetting_ReqParam;

typedef struct 
{
   ERfTestETModeSettingStatusType	et_status;
   ERfTestETModeSettingErrType	   et_error_code;
}MMRfTestCmd_ETModeSetting_CnfParam;

typedef struct
{
   MMRfTestCmd_EtModeSetting_ReqParam       *p_req_local;
   MMRfTestCmd_ETModeSetting_CnfParam       *p_cnf_local;
...
{
   kal_uint16                       rat_idx;
   ERfTestSetToolUsageToL1ModeType  toolUsage; /*0:Normal; 1:Calibration; 2:ET calibration mode*/

}MMRfTestCmd_SetToolUsageToL1_ReqParam;

typedef struct 
{
   ERfTestSetToolUsageToL1StatusType     set_tool_usage_to_l1_status;
   ERfTestSetToolUsageToL1ErrType        set_tool_usage_to_l1_error_code;
   MMRfTestCmd_SetToolUsageToL1_ReqParam set_tool_usage_to_l1_dim;

}MMRfTestCmd_SetToolUsageToL1_CnfParam;

typedef struct
{
   MMRfTestCmd_SetToolUsageToL1_ReqParam    *p_req_local;
   MMRfTestCmd_SetToolUsageToL1_CnfParam    *p_cnf_local;
...
typedef struct
{
   void (*start_func)( MMRfTest_StartEtFacCalV3Mix *p_start_mix );
   void (*get_func)( MMRfTest_GetEtCalResultV3Mix *p_get_mix );
   void (*set_func)( MMRfTest_SetEtCalResultV3Mix *p_set_mix );
   void (*pathcheck_func)( MMRfTestETPathDelayCheckV3Mix *p_pathcheck_mix );
   void (*pathstart_func)( MMRfTestETPathDelayStartV2Mix *p_pathstart_mix );
   void (*modeset_func)( MMRfTestETModeSettingCmdRptMix *p_pathstart_mix );
   void (*settool_func)( MMRfTestSetToolUsageToL1CmdRptMix *p_pathstart_mix );
   
}MMRfTest_ETFaclab_FuncPtr;
...
typedef union
{
   ...
   MMRfTestCmd_EtModeSetting_ReqParam                 mode_et_req;            // for MMRF_TEST_CMD_ET_MODE_SETTING                     = 31
   MMRfTestCmd_SetToolUsageToL1_ReqParam              setToolUsage_req;       // for MMRF_TEST_CMD_SET_TOOL_USAGE_TO_L1                = 32
   ...
   MMRfTestCmd_StartEtFacCalV3_ReqParam               start_et_v3_req;        // for MMRF_TEST_CMD_START_ET_FAC_CAL_V3                 = 68
   MMRfTestCmd_GetEtCalResultV3_ReqParam              get_et_v3_req;          // for MMRF_TEST_CMD_GET_ET_CAL_RESULT_V3                = 69
   MMRfTestCmd_SetEtCalResultV3_ReqParam              set_et_v3_req;          // for MMRF_TEST_CMD_SET_ET_CAL_RESULT_V3                = 70
   MMRfTestCmd_CheckEtPathDelaySearchV3_ReqParam      check_path_v3_req;      // for MMRF_TEST_CMD_CHECK_ET_PATH_DELAY_SEARCH_V3       = 71
   MMRfTestCmd_StartEtPathDelaySearchV2_ReqParam      start_path_v2_req;      // for MMRF_TEST_CMD_START_ET_PATH_DELAY_SEARCH_V2       = 49
...
typedef union
{
   ...
   MMRfTestCmd_ETModeSetting_CnfParam                 mode_et_cnf;            // for MMRF_TEST_CMD_ET_MODE_SETTING                     = 31
   MMRfTestCmd_SetToolUsageToL1_CnfParam              setToolUsage_cnf;       // for MMRF_TEST_CMD_SET_TOOL_USAGE_TO_L1                = 32
   ...
   MMRfTestCmd_StartEtFacCalV3_CnfParam               start_et_v3_cnf;        // for MMRF_TEST_CMD_START_ET_FAC_CAL_V3                 = 68
   MMRfTestCmd_GetEtCalResultV3_CnfParam              get_et_v3_cnf;          // for MMRF_TEST_CMD_GET_ET_CAL_RESULT_V3                = 69
   MMRfTestCmd_SetEtCalResultV3_CnfParam              set_et_v3_cnf;          // for MMRF_TEST_CMD_SET_ET_CAL_RESULT_V3                = 70
   MMRfTestCmd_CheckEtPathDelaySearchV3_CnfParam      check_path_v3_cnf;      // for MMRF_TEST_CMD_CHECK_ET_PATH_DELAY_SEARCH_V3       = 71
   MMRfTestCmd_StartEtPathDelaySearchV2_CnfParam      start_path_v2_cnf;      // for MMRF_TEST_CMD_START_ET_PATH_DELAY_SEARCH_V2       = 49
