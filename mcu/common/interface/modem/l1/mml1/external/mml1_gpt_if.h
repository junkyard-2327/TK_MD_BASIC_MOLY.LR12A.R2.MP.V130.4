...
typedef enum
{
   ...
   ,mm_start_et_fac_cal_v3      = MMRF_TEST_CMD_START_ET_FAC_CAL_V3
   ,mm_get_et_cal_result_v3     = MMRF_TEST_CMD_GET_ET_CAL_RESULT_V3
   ,mm_set_et_cal_result_v3     = MMRF_TEST_CMD_SET_ET_CAL_RESULT_V3
   ,mm_check_et_path_delay_v3   = MMRF_TEST_CMD_CHECK_ET_PATH_DELAY_SEARCH_V3
   ,mm_start_et_path_delay_v2   = MMRF_TEST_CMD_START_ET_PATH_DELAY_SEARCH_V2
   ,mm_et_mode_setting          = MMRF_TEST_CMD_ET_MODE_SETTING
   ,mm_set_tool_usage           = MMRF_TEST_CMD_SET_TOOL_USAGE_TO_L1
...
\* ------------------------------------------------------------------------------------ */
/* start */
typedef MMRfTestCmd_StartEtFacCalV3_ReqParam          mm_start_et_fac_cal_v3_req_param_struct;
typedef MMRfTestCmd_StartETFacCalV3_ReqPdu            mm_start_et_fac_cal_v3_req_pdu_struct;
typedef MMRfTestCmd_StartEtFacCalV3_CnfParam          mm_start_et_fac_cal_v3_cnf_param_struct;

/* get */
typedef MMRfTestCmd_GetEtCalResultV3_ReqParam         mm_get_et_cal_result_v3_req_param_struct;
typedef MMRfTestCmd_GetLteEtCalResultV3_CnfPdu        mm_get_et_cal_result_v3_cnf_pdu_struct;
typedef MMRfTestCmd_GetEtCalResultV3_CnfParam         mm_get_et_cal_result_v3_cnf_param_struct;

/* set */
typedef MMRfTestCmd_SetEtCalResultV3_ReqParam         mm_set_et_cal_result_v3_req_param_struct;
typedef MMRfTestCmd_SetLteEtCalResultV3_ReqPdu        mm_set_et_cal_result_v3_req_pdu_struct;
typedef MMRfTestCmd_SetEtCalResultV3_CnfParam         mm_set_et_cal_result_v3_cnf_param_struct;

/* check ET path dalay search */
typedef MMRfTestCmd_CheckEtPathDelaySearchV3_ReqParam mm_check_et_path_delay_v3_req_param_struct;
typedef MMRfTestCmd_CheckEtPathDelaySearchV3_CnfPdu   mm_check_et_path_delay_v3_cnf_pdu_struct;
typedef MMRfTestCmd_CheckEtPathDelaySearchV3_CnfParam mm_check_et_path_delay_v3_cnf_param_struct;

/* start ET path dalay search */
typedef MMRfTestCmd_StartEtPathDelaySearchV2_ReqParam mm_start_et_path_delay_v2_req_param_struct;
typedef MMRfTestCmd_StartEtPathDelaySearchV2_CnfParam mm_start_et_path_delay_v2_cnf_param_struct;

/* ET MODE SETTING */
typedef MMRfTestCmd_EtModeSetting_ReqParam            mm_et_mode_setting_req_param_struct;
typedef MMRfTestCmd_ETModeSetting_CnfParam            mm_et_mode_setting_cnf_param_struct;

/* set tool usage to l1*/
typedef MMRfTestCmd_SetToolUsageToL1_ReqParam         mm_set_tool_usage_req_param_struct;
typedef MMRfTestCmd_SetToolUsageToL1_CnfParam         mm_set_tool_usage_cnf_param_struct;
