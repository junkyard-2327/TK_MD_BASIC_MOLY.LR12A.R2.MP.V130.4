...
#ifndef L1_SIM
#define __IS_MML1_ETM_SUPPORT__                                      ( 0 )   /* MML1 ETM feature is supported or not */
#else
#define __IS_MML1_ETM_SUPPORT__                                      ( 0 )   /* Disable ETM feature in xL1SIM.          */
#endif   // #ifndef L1_SIM

#if __IS_MML1_ETM_SUPPORT__
#define MML1_MIPI_ETM_MAX_SUPPORT_NUM                                (  1 )
#define MML1_MIPI_ETM_MAX_INITIAL_CW_NUM                             ( 20 )
#else
#define MML1_MIPI_ETM_MAX_SUPPORT_NUM                                (  1 )
#define MML1_MIPI_ETM_MAX_INITIAL_CW_NUM                             (  1 )
#endif   // #if __IS_MML1_ETM_SUPPORT__

#define USE_MIPI_DEVICE_NULL                                         0
#define USE_ETM_INDEX_NULL                                           USE_MIPI_DEVICE_NULL
#define USE_ETM_INDEX_0                                              1
#define USE_ETM_INDEX_1                                              2
...
typedef struct
{
   ...
   MML1_MIPI_ADDR_DATA_T mipi_addr_data; // mipi address & data
   kal_uint32            mipi_wait_time; // mipi wait time
} MML1_MIPI_SIMPLE_INITIAL_CW_T;

typedef struct
{
   MIPI_PORT_T           mipi_port_sel;  // 0:for Port0, 1:for Port1 
   USID_T                mipi_usid;      // usid
} MML1_MIPI_DEVICE_INFORMATION_T;
...
typedef enum
{
   ...
   ET_DAC_INDEX_NOT_USED = 0xFFFF,
} MML1_ET_DAC_INDEX_E;

typedef struct
{
   MML1_MIPI_DEVICE_INFORMATION_T   dev_info;       // MIPI port, USID
   MML1_ET_DAC_INDEX_E              et_dac_index;   // ETM is connected to which ET-DAC, ET-DAC0, ET-DAC1 or not connected.
} MML1_ETM_INFORMATION_T;
