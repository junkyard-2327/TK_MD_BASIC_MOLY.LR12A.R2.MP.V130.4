 ...
 * [MOLY00363579] AT+ERFTX error handling enhancement - R2 Main CR
 * 	
 * 	.
 *
 * 08 02 2018 xiaochi.zhang
 * [MOLY00343673] 【新功能需求】自干扰扫描测试
 * 	
 * 	.
 *
 * 08 02 2018 xiaochi.zhang
 ...
 * 	.
 *
 * 07 10 2018 xiaochi.zhang
 * [MOLY00337954] [MT6761][Merlot][O1][MP1.5][MTBF][HQ][4GMM][Lab][Ericsson][HCR][Fatal error(RESERVED_INSTRUCTION)] err_code1:0x0000000A err_code2:0x91115163 err_code3:0x91115163
 * 	
 * 	[MOLY00337868] [MT6761][Merlot][O1][MP1.5][MTBF][HQ][4GMM][Lab][Ericsson][HCR][Fatal error(RESERVED_INSTRUCTION)] err_code1:0x0000000A err_code2:0x91115163 err_code3:0x91115163
 * 	
 * 	.
 * 	rollback
 *
