...
/*keep MT6291 code*/
#define IS_URF_MT6291_DUAL_CORE_ARCH            1
#define IS_URF_PCORE                            defined(__PCORE__)
#define IS_URF_L1CORE                           defined(__L1CORE__)
#else
...
** RXD & DUAL CELL usage
*******************************************************************************/
#if (IS_URF_MT6176 || IS_URF_MT6179||IS_URF_MT6177L_RX||IS_URF_MT6173_RX)
...
#define IS_3G_DAT_UL1_CUSTOM_SUPPORT         defined (__DYNAMIC_ANTENNA_TUNING__)
#define IS_3G_DAT_RFD_CTRL_EN                defined (__DYNAMIC_ANTENNA_TUNING__)
#define IS_3G_DAT_MMRF_INTERFACE_READY       defined (__DYNAMIC_ANTENNA_TUNING__)
...
#if IS_3G_TAS_SUPPORT && IS_3G_DAT_RFD_CTRL_EN
...
#define IS_3G_RFIC_ADC_CUSTOM_ROUTE_ENABLE   1
...
#define IS_3G_ELNA_IDX_TEST_SUPPORT         (0)
...
#define IS_3G_FDD_INTERFERENCE_CHECK_SUPPORT defined (__WCDMA_INTERFERENCE_CHECK_SUPPORT__)
