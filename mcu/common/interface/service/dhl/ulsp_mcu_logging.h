 ...
 * $Log$
 *
 * 07 17 2017 yancy.chien
 * [MOLY00257978] conditional trace development
 * Code migration from TRUNK.
 *
 * 07 06 2017 yancy.chien
 * [MOLY00253940] [SE2 Internal Test][MT6293][LR12A.MP1][20170525][Overnight Result] Assert fail logseq_drv.c 1156 - 0IDLE
 * Code migration from MP1.
 *
 * 06 01 2017 kenneth.lin
 * [MOLY00253974] [BIANCO][DHL] re-dump dsp log in exception flow
 * .
 * 	redump dsp log on exception flow
 *
