 ...
 * [MOLY00279168] [xL1SIM] Fix conditional trace warning
 * Add empty function body for xL1SIM.
 *
 * 09 14 2017 kenneth.lin
 * [MOLY00257978] conditional trace development
 * 	
 * 	[DHL] fixed conditional trace build error on xl1sim
 *
