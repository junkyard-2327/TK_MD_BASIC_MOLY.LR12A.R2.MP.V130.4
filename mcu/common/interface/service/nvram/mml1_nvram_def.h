...
#define NVRAM_EF_MML1_MIPI_ETM_INFORMATION_LID_VERNO         "000"

#define NVRAM_EF_MML1_MIPI_ETM_INITIAL_CW_LID_VERNO          "000"
...
#define NVRAM_EF_MML1_MIPI_ETM_INFORMATION_SIZE          ( sizeof( MML1_ETM_INFORMATION_T ) * MML1_MIPI_ETM_MAX_SUPPORT_NUM )
#define NVRAM_EF_MML1_MIPI_ETM_INFORMATION_TOTAL         1

#define NVRAM_EF_MML1_MIPI_ETM_INITIAL_CW_SIZE           ( sizeof( MML1_MIPI_SIMPLE_INITIAL_CW_T ) * MML1_MIPI_ETM_MAX_INITIAL_CW_NUM )
#define NVRAM_EF_MML1_MIPI_ETM_INITIAL_CW_TOTAL          1
