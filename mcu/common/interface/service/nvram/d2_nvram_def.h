...
typedef enum
{
        ...
        NVRAM_EF_D2_VZW_APNINFO_LID              = NVRAM_LID_GRP_D2(5),
...
#define NVRAM_EF_D2_VZW_APNINFO_LID_VERNO   "000"
...
#define NVRAM_EF_D2_VZW_APNINFO_SIZE sizeof(nvram_d2_vzw_apninfo_struct)
#define NVRAM_EF_D2_VZW_APNINFO_TOTAL  (8*MAX_SIM_NUM)
