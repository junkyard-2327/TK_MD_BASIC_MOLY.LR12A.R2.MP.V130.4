...
#define NVRAM_EF_ERRC_PERFORMANCE_PARA_LID_VERNO   "019"
...
#define NVRAM_EF_UE_EUTRA_CAP_CSFB_LID_VERNO            "022"
...
#define NVRAM_EF_ERRC_STORED_CARRIER_TOTAL       (1 * NVRAM_MULTI_RECORD_LTE)
...
#define NVRAM_EF_ERRC_PERFORMANCE_PARA_TOTAL     (1 * NVRAM_MULTI_RECORD_LTE)
...
#define NVRAM_EF_ERRC_FINGER_PRINT_TOTAL         (NVRAM_LTE_FINGERPRINT_RECORD_NUM * NVRAM_MULTI_RECORD_LTE)
...
#define NVRAM_EF_LTE_CAP_TOTAL                   (1 * NVRAM_MULTI_RECORD_LTE)
...
#define NVRAM_EF_UE_EUTRA_CAP_CSFB_TOTAL                   (1 * NVRAM_MULTI_RECORD_LTE)

#define NVRAM_EF_LTE_FEATURE_CTRL_SIZE  ( sizeof( nvram_ef_errc_lte_feature_ctrl_struct ) )
#define NVRAM_EF_LTE_FEATURE_CTRL_TOTAL ( 1 * NVRAM_MULTI_RECORD_LTE)

#define NVRAM_EF_ERRC_LTE_SCAN_ENHANCE_SIZE             (sizeof(nvram_ef_errc_lte_scan_enhance_struct))
#define NVRAM_EF_ERRC_LTE_SCAN_ENHANCE_TOTAL            (1 * NVRAM_MULTI_RECORD_LTE)
