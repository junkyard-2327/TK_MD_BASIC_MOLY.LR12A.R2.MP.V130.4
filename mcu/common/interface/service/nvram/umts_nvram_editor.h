...
LID_BIT VER_LID(NVRAM_EF_UMTS_USIME_RRC_DYNAMIC_CAP_FDD_LID) 
nvram_ef_umts_usime_rrc_dynamic_fdd_struct * 
NVRAM_EF_UMTS_USIME_RRC_DYNAMIC_CAP_FDD_TOTAL
{
    ...
    r3_cap3:"r3 cap3"
    {
                ...
                validity_CellPCH_UraPCH : 1 "validity_CellPCH_UraPCH"
                    {
                    	0x0:"CellPCH_UraPCH is not supported";
                      0x1:"CellPCH_UraPCH is supported";
                    };
    };
    r4_cap1:"r4 cap1"
    {
    ...
    r8_cap1:"r8 cap1"
    {
                ...
                supportOfEUTRAFDD : 1 "supportOfEUTRAFDD"
                    {
                      0x0:"EUTRA_FDD is not supported";
                      0x1:"EUTRA_FDD is supported";
                    };
                supportOfInterRATHOToEUTRAFDD : 1 "supportOfInterRATHOToEUTRAFDD"
                    {
                      0x0:"InterRAT Handover to EUTRA_FDD is not supported";
                      0x1:"InterRAT Handover to EUTRA_FDD is supported";
                    };
    ...
    r8_cap2:"r8 cap2"
    {
                ...
                supportOfEUTRATDD : 1 "supportOfEUTRATDD"
                    {
                      0x0:"EUTRA_TDD is not supported";
                      0x1:"EUTRA_TDD is supported";
                    };             
                supportOfInterRATHOToEUTRATDD : 1 "supportOfInterRATHOToEUTRATDD"
                    {
                      0x0:"InterRAT Handover to EUTRA_TDD is not supported";
                      0x1:"InterRAT Handover to EUTRA_TDD is supported";
                    };  
    };
    r10_cap1:"r10 cap1"
    {
    ...
    r10_cap2:"r10 cap2"
    {
                support3CHSDPA : 1 "support3CHSDPA"
                    {
                      0x0:"3 Cell HSDPA is not supported";
                      0x1:"3 Cell HSDPA is supported";
                    };
                support4CHSDPA : 1 "support4CHSDPA"
                    {
                      0x0:"4 Cell HSDPA is not supported";
                      0x1:"4 Cell HSDPA is supported";
                    };              
                ...
                supportOfUTRANANR : 1 "supportOfUTRANANR"
                    {
                      0x0:"UTRAN ANR is not supported";
                      0x1:"UTRAN ANR is supported";
                    };
                ...
                supportofDCHSUPA : 1 "supportofDCHSUPA"
                    {
                      0x0:"Dual Cell HSUPA is not supported";
                      0x1:"Dual Cell HSUPA is supported";
                    };             
                Bit8 : 1 "Bit8"
                    {
                    };  
