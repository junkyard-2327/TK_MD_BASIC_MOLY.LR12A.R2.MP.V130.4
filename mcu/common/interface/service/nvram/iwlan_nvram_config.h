...
#define IWLAN_CFG_L0_TYPE_DCL(_obj0, _type, _enum, _name, _cfg_dflt, _nv_dflt) \
    if ((__IWLAN_NVRAM_PTR__)->_obj0._name != _nv_dflt) { \
        (__IWLAN_CFG_PTR__)->_obj0._name = (__IWLAN_NVRAM_PTR__)->_obj0._name;  \
    }

#define IWLAN_CFG_L1_TYPE_DCL(_obj0, _obj1, _type, _enum, _name, _cfg_dflt, _nv_dflt) \
    if ((__IWLAN_NVRAM_PTR__)->_obj0._obj1._name != _nv_dflt) { \
        (__IWLAN_CFG_PTR__)->_obj0._obj1._name = (__IWLAN_NVRAM_PTR__)->_obj0._obj1._name; \
    }

#define IWLAN_CFG_L2_TYPE_DCL(_obj0, _obj1, _obj2, _type, _enum, _name, _cfg_dflt, _nv_dflt) \
    if ((__IWLAN_NVRAM_PTR__)->_obj0._obj1._obj2._name != _nv_dflt) { \
...
#define IWLAN_CFG_L0_TYPE_ARRAY(_obj0, _type, _enum, _name, _size, _cfg_dflt, _nv_dflt) \
    for (_cfg_idx_ = 0; _cfg_idx_ < _size; ++_cfg_idx_) { \
        if ((__IWLAN_NVRAM_PTR__)->_obj0._name[_cfg_idx_] != _nv_dflt) { \
...
#define IWLAN_CFG_L1_TYPE_ARRAY(_obj0, _obj1, _type, _enum, _name, _size, _cfg_dflt, _nv_dflt) \
    for (_cfg_idx_ = 0; _cfg_idx_ < _size; ++_cfg_idx_) { \
        if ((__IWLAN_NVRAM_PTR__)->_obj0._obj1._name[_cfg_idx_] != _nv_dflt) { \
...
#define IWLAN_CFG_L2_TYPE_ARRAY(_obj0, _obj1, _obj2, _type, _enum, _name, _size, _cfg_dflt, _nv_dflt) \
    for (_cfg_idx_ = 0; _cfg_idx_ < _size; ++_cfg_idx_) { \
        if ((__IWLAN_NVRAM_PTR__)->_obj0._obj1._obj2._name[_cfg_idx_] != _nv_dflt) { \
...
IWLAN_CFG_L0_TYPE_DCL(wans_cfg, kal_uint8,  WANS_IMS_DEREG_DEAD_ZONE_INCALL_BARRING_ENABLE, wans_ims_dereg_dead_zone_incall_barring_enable, KAL_FALSE,   UNDEF_CONFIG_8)
...
IWLAN_CFG_L0_TYPE_DCL(wans_cfg, kal_uint8,  WANS_IMS_ECC_OVER_IMS_HO_WIFI_TO_LTE_ENABLE,    wans_ims_ecc_over_ims_ho_wifi_to_lte_enable,    KAL_TRUE,   UNDEF_CONFIG_8)
    ...
    IWLAN_CFG_L1_TYPE_DCL(wans_cfg, throttling_cfg, kal_uint8,  WANS_THROTTLING_WLAN_ENABLE,             wans_throttling_wlan_enable,             KAL_FALSE, UNDEF_CONFIG_8)
    IWLAN_CFG_L1_TYPE_DCL(wans_cfg, throttling_cfg, kal_uint32, WANS_WROVEIN_THROTTLING_T,               wans_wrovein_throttling_t,               0,         UNDEF_CONFIG_32) // in sec
    IWLAN_CFG_L1_TYPE_DCL(wans_cfg, throttling_cfg, kal_uint8,  WANS_THROTTLING_MD_ENABLE,               wans_throttling_md_enable,               KAL_FALSE, UNDEF_CONFIG_8)
    IWLAN_CFG_L1_TYPE_DCL(wans_cfg, throttling_cfg, kal_uint32, WANS_WROVEOUT_THROTTLING_T,              wans_wroveout_throttling_t,              0,         UNDEF_CONFIG_32) // in sec
    ...
    IWLAN_CFG_L1_TYPE_START(wans_cfg, qos_cfg)
        ...
        IWLAN_CFG_L2_TYPE_DCL(wans_cfg, qos_cfg, qos_rtp_cfg, kal_uint8,  WANS_RTP_QOS_ENABLE,               wans_rtp_qos_enable,               KAL_FALSE,       UNDEF_CONFIG_8)
        IWLAN_CFG_L2_TYPE_DCL(wans_cfg, qos_cfg, qos_rtp_cfg, kal_uint8,  WANS_IMS_RTP_TO_STERRING_ENABLE,   wans_ims_rtp_to_sterring_enable,   KAL_FALSE,       UNDEF_CONFIG_8)
        ...
        IWLAN_CFG_L2_TYPE_DCL(wans_cfg, qos_cfg, qos_rtp_cfg, kal_uint32, WANS_IMS_RTP_WLAN_PKT_LOSS_TH,     wans_ims_rtp_wlan_pkt_loss_th,     UNDEF_CONFIG_32, UNDEF_CONFIG_32)
        IWLAN_CFG_L2_TYPE_DCL(wans_cfg, qos_cfg, qos_rtp_cfg, kal_uint32, WANS_IMS_RTP_WLAN_QOS_BKOFF_T,     wans_ims_rtp_wlan_qos_bkoff_t,     200,             UNDEF_CONFIG_32) // in sec
        ...
        IWLAN_CFG_L2_TYPE_DCL(wans_cfg, qos_cfg, qos_rtp_cfg, kal_uint32, WANS_WLAN_RTP_SAMPLING_DURATION,   wans_wlan_rtp_sampling_duration,   0,               UNDEF_CONFIG_32) // in sec
