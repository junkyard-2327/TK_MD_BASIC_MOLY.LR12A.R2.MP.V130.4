...
/*****************************************************************************
 *
 * Include grouping xxx_nvram_editor.h
 *
 *****************************************************************************/
...
/***********************************************************************
  ***  This is a nvram data item bit level description for meta tools nvram editor
  ***
  ***  Logical Data Item ID : NVRAM_EF_NVRAM_SECURITY_CHECK_LID
  ***
  ***  Module:
  ***
  ***  Description:
  ***
  ***  Maintainer: Shenghui.Shi
  ***
  ***********************************************************************/
#ifdef __NVRAM_SEC_CHECK_EN__
LID_BIT VER_LID(NVRAM_EF_NVRAM_SECURITY_CHECK_LID)
    nvram_ef_nvram_security_check_struct * NVRAM_EF_NVRAM_SECURITY_CHECK_TOTAL
    {
    };
#endif
...
LID_BIT VER_LID(NVRAM_EF_NVRAM_TEST_1_LID)
nvram_ef_nv_test_lid_struct * NVRAM_EF_TEST_LID_RECORD_TOTAL
{
};

LID_BIT VER_LID(NVRAM_EF_NVRAM_TEST_2_LID)
nvram_ef_nv_test_lid_struct * NVRAM_EF_TEST_LID_RECORD_TOTAL
{
};

LID_BIT VER_LID(NVRAM_EF_NVRAM_TEST_3_LID)
nvram_ef_nv_test_lid_struct * NVRAM_EF_TEST_LID_RECORD_TOTAL
{
};

LID_BIT VER_LID(NVRAM_EF_NVRAM_TEST_4_LID)
nvram_ef_nv_test_lid_struct * NVRAM_EF_TEST_LID_RECORD_TOTAL
{
};

LID_BIT VER_LID(NVRAM_EF_NVRAM_TEST_5_LID)
nvram_ef_nv_test_lid_struct * NVRAM_EF_TEST_LID_RECORD_TOTAL
{
};

LID_BIT VER_LID(NVRAM_EF_NVRAM_TEST_6_LID)
nvram_ef_nv_test_lid_struct * NVRAM_EF_TEST_LID_RECORD_TOTAL
{
};

LID_BIT VER_LID(NVRAM_EF_NVRAM_TEST_7_LID)
nvram_ef_nv_test_lid_struct * NVRAM_EF_TEST_LID_RECORD_TOTAL
{
};
...
* DESCRIPTION
*      Only used for NVRAM owner to record info.
* INFOMATION
*      Can OTA Reset: Yes
*      Update Scenario: This LID may update when OTA happen.
*********************************************************************************************/
LID_BIT VER_LID(NVRAM_EF_CHKSUM_RESET_REC_LID)
chksum_rst_rec_struct * NVRAM_EF_CHKSUM_RESET_REC_LID_TOTAL
{
};
#endif
