...
#else
#define NVRAM_EF_L1_RX_POWER_OFFSET_LID_SUBTRAHEND 2
...
#define NVRAM_EF_L1_NSFT_ADJUST_TPO_LID_SUBTRAHEND 0
    #else
#define NVRAM_EF_L1_NSFT_ADJUST_TPO_LID_SUBTRAHEND 4
    #endif//__EPSK_ADJUST_TPO_SUPPORT__
#else
#define NVRAM_EF_L1_NSFT_ADJUST_TPO_LID_SUBTRAHEND 8
...
#define NVRAM_L1CAL_ELEMENT_TOTAL  (NVRAM_EF_L1_END - NVRAM_EF_L1_START + 1 - \
                                    ...
                                    NVRAM_EF_L1_NSFT_ADJUST_TPO_LID_SUBTRAHEND)
...
typedef enum
{
        ...
        /* for 2g NSFT Adjust tx power offset */
        NVRAM_EF_L1_GMSK_ADJUST_TPO_GSM850_LID,                               //54
        NVRAM_EF_L1_GMSK_ADJUST_TPO_GSM900_LID,                               //55
        NVRAM_EF_L1_GMSK_ADJUST_TPO_DCS_LID,                                  //56
        NVRAM_EF_L1_GMSK_ADJUST_TPO_PCS_LID,                                  //57
        NVRAM_EF_L1_EPSK_ADJUST_TPO_GSM850_LID,                               //58
        NVRAM_EF_L1_EPSK_ADJUST_TPO_GSM900_LID,                               //59
        NVRAM_EF_L1_EPSK_ADJUST_TPO_DCS_LID,                                  //60
        NVRAM_EF_L1_EPSK_ADJUST_TPO_PCS_LID,                                  //61

        /* for 2G RXD*/
        NVRAM_EF_L1_AGCPATHLOSS_RXD_LID,                                      //62
        NVRAM_EF_L1_LNAPATHLOSS_RXD_LID,                                      //63
        NVRAM_EF_L1_AGCPATHLOSS_OFFSET_RXD_LID,                               //64
        NVRAM_EF_L1_WCOEF_RXD_LID,                                            //65
        NVRAM_EF_L1_RAS_CUSTOM_PARAMES_LID,                                   //66
        /* for 2G SAR TX POWER BACKOFF DB*/
        NVRAM_EF_L1_SAR_TX_BACKOFF_DB_CUSTOM_PARAMES_LID,                     //67          
...
/* for 2g adjust Tx power Offset */
#define NVRAM_EF_L1_GMSK_ADJUST_TPO_GSM850_LID_VERNO    "000"
#define NVRAM_EF_L1_GMSK_ADJUST_TPO_GSM900_LID_VERNO    "000"
#define NVRAM_EF_L1_GMSK_ADJUST_TPO_DCS_LID_VERNO       "000"
#define NVRAM_EF_L1_GMSK_ADJUST_TPO_PCS_LID_VERNO       "000"
#define NVRAM_EF_L1_EPSK_ADJUST_TPO_GSM850_LID_VERNO    "000"
#define NVRAM_EF_L1_EPSK_ADJUST_TPO_GSM900_LID_VERNO    "000"
#define NVRAM_EF_L1_EPSK_ADJUST_TPO_DCS_LID_VERNO       "000"
#define NVRAM_EF_L1_EPSK_ADJUST_TPO_PCS_LID_VERNO       "000"
...
#if defined (__NSFT_ADJUST_TX_POWER_OFFSET_SUPPORT__)
/**
 * L1 NSFT adjust tx power offset parameter
 */

/**
 * L1 GMSK NSFT adjust tx power offset data for GSM850
 */
#define NVRAM_EF_L1_GMSK_ADJUST_TPO_GSM850_SIZE  sizeof(nsft_adjust_tpo_t)
#define NVRAM_EF_L1_GMSK_ADJUST_TPO_GSM850_TOTAL 1

/**
 * L1 GMSK NSFT adjust tx power offset data for GSM900
 */
#define NVRAM_EF_L1_GMSK_ADJUST_TPO_GSM900_SIZE  sizeof(nsft_adjust_tpo_t)
#define NVRAM_EF_L1_GMSK_ADJUST_TPO_GSM900_TOTAL 1

/**
 * L1 GMSK NSFT adjust tx power offset data for DCS
 */
#define NVRAM_EF_L1_GMSK_ADJUST_TPO_DCS_SIZE     sizeof(nsft_adjust_tpo_t)
#define NVRAM_EF_L1_GMSK_ADJUST_TPO_DCS_TOTAL    1

/**
 * L1 GMSK NSFT adjust tx power offset data for PCS
 */
#define NVRAM_EF_L1_GMSK_ADJUST_TPO_PCS_SIZE     sizeof(nsft_adjust_tpo_t)
#define NVRAM_EF_L1_GMSK_ADJUST_TPO_PCS_TOTAL    1

    #if defined(__EPSK_ADJUST_TPO_SUPPORT__)
/**
 * L1 EPSK NSFT adjust tx power offset data for GSM850
 */
#define NVRAM_EF_L1_EPSK_ADJUST_TPO_GSM850_SIZE  sizeof(nsft_adjust_tpo_t)
#define NVRAM_EF_L1_EPSK_ADJUST_TPO_GSM850_TOTAL 1

/**
 * L1 EPSK NSFT adjust tx power offset data for GSM900
 */
#define NVRAM_EF_L1_EPSK_ADJUST_TPO_GSM900_SIZE  sizeof(nsft_adjust_tpo_t)
#define NVRAM_EF_L1_EPSK_ADJUST_TPO_GSM900_TOTAL 1

/**
 * L1 EPSK NSFT adjust tx power offset data for DCS
 */
#define NVRAM_EF_L1_EPSK_ADJUST_TPO_DCS_SIZE     sizeof(nsft_adjust_tpo_t)
#define NVRAM_EF_L1_EPSK_ADJUST_TPO_DCS_TOTAL    1

/**
 * L1 EPSK NSFT adjust tx power offset data for PCS
 */
#define NVRAM_EF_L1_EPSK_ADJUST_TPO_PCS_SIZE     sizeof(nsft_adjust_tpo_t)
#define NVRAM_EF_L1_EPSK_ADJUST_TPO_PCS_TOTAL    1
    #endif//__EPSK_ADJUST_TPO_SUPPORT__
#endif /* __NSFT_ADJUST_TX_POWER_OFFSET_SUPPORT__*/
