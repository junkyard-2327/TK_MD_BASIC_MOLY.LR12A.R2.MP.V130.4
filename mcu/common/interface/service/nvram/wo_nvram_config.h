...
WO_CFG_L0_TYPE_DCL(wo_cfg, kal_uint32,  WO_CFG_FORCE_DPD_RETRAN_TO,         fdpd_retrans_to,                       1,  UNDEF_CONFIG_32, "@INTERNAL_USE@ Retransmission timeout in seconds for force DPD" {};)
WO_CFG_L0_TYPE_DCL(wo_cfg, kal_uint8,   WO_CFG_FORCE_DPD_RETRAN_TRIES,      fdpd_retrans_tries,                    2,  UNDEF_CONFIG_8, "@INTERNAL_USE@ Maximum number of times a UE shall retransmit a force DPD packet if it does not receive a response" {};)
WO_CFG_L0_TYPE_DCL(wo_cfg, kal_uint8,   WO_CFG_FORCE_DPD_RETRAN_BASE,       fdpd_retrans_base,                     1,  UNDEF_CONFIG_8, "@INTERNAL_USE@ Base to use for force DPD calculating exponential back off" {};)
...
WO_CFG_L0_TYPE_DCL(wo_cfg, kal_uint8,   WO_CFG_TRY_EPDG_POLICY,             try_epdg_policy,         TRY_ALL_EPDG_IP,  UNDEF_CONFIG_8, "@INTERNAL_USE@" {
