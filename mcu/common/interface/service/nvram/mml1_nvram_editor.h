...
typedef struct
{
   MML1_ETM_INFORMATION_T mipi_etm_info_table[ MML1_MIPI_ETM_MAX_SUPPORT_NUM ];
}nvram_mml1_mipi_etm_info_struct;

typedef struct
{
   MML1_MIPI_SIMPLE_INITIAL_CW_T mipi_etm_initial_cw_table[ MML1_MIPI_ETM_MAX_INITIAL_CW_NUM ];
}nvram_mml1_mipi_etm_initial_cw_struct;
...
*      Update Scenario: It will update once during task init.
*********************************************************************************************/
LID_BIT MULTIPLE_LID VER_LID(NVRAM_EF_MML1_MIPI_ETM_INFORMATION_LID)
     nvram_mml1_mipi_etm_info_struct *NVRAM_EF_MML1_MIPI_ETM_INFORMATION_TOTAL
     {
...
* DESCRIPTION
*      MMRF ETM initial CW table.
* INFOMATION
*      Can OTA Reset: Yes
*      Update Scenario: It will update once during task init.
*********************************************************************************************/
LID_BIT MULTIPLE_LID VER_LID(NVRAM_EF_MML1_MIPI_ETM_INITIAL_CW_LID)
     nvram_mml1_mipi_etm_initial_cw_struct *NVRAM_EF_MML1_MIPI_ETM_INITIAL_CW_TOTAL
     {
