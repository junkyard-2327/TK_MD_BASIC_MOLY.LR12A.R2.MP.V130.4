...
/*************************************************************************
* FUNCTION
*  kal_runtime_task_affinity_resume
* DESCRIPTION
*  resume task's affinity attribute to original config value
* PARAMETERS
*  taskID[IN]: taskID
* RETURNS
*  KAL_TRUE or KAL_FALSE
*************************************************************************/
kal_bool kal_runtime_task_affinity_resume(kal_taskid taskID);

/*************************************************************************
* FUNCTION
*  kal_runtime_task_affine_to_current_cpu
* DESCRIPTION
*  Affines the calling task to current CPU.
* PARAMETERS
*  NONE
* RETURNS
*  KAL_TRUE
*************************************************************************/
kal_bool kal_runtime_task_affine_to_current_cpu(void);
