 ...
 *
 * 05 29 2018 owen.ho
 * [MOLY00315748] [ZION][R2.MP][RJIL] MD security related crypto API - header files
 * Add sleep control enum for PBKDF2
 *
 * 03 23 2018 guo-huei.chang
 * [MOLY00315453] [Merlot call for check-in] MD Low Power Monitor
 * add Wall clock and UTC for timing sync
 *
 * 02 07 2018 ej.farn
 * [MOLY00299405] [Gen93]Low Power Monitor
 * MD Low Power Monitor
 *
 * 09 06 2017 jack.tung
 * [MOLY00244698] [Gen93][Zion][Sleep Mode]
 * 	
 * 	Update SleepDrv Handle for SIM
 *
 * 08 15 2017 owen.ho
...
typedef enum
{
    ...
    SLEEP_CTL_PBKDF2        = 39,   // 0x27, For PBKDF2 lock sleep while task temporarily sleep  
    MAX_SLEEP_HANDLE 	    = 46
} SLEEP_CTL_USER;
