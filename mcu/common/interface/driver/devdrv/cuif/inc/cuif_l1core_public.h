...
/*
  ...
  *  @param[in]    nID -the enum of N0, N1, N2, N3, N4
...
/**
  ...
  *
  *  @param[in]  nID -the enum of N0, N1, N2, N3, N4
  *  @param[in]  code  - use enum of `CUIF_U2C_NX_Code_t`, where NX = N0, N1, N2, N3, N4
  *  @param[in]  limit - CUIF_MCU_INT_NX_SOURCES, where NX = N0, N1, N2, N3, N4
  *  @return no return
  *
  */
