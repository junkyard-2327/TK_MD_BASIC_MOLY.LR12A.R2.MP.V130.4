...
void nvram_get_eL1_default_value_to_write_with_record(nvram_lid_core_enum lid, kal_uint16 rec_index, kal_uint8 *buffer, kal_uint16 buffer_size)
{
   ...
   switch (lid)
   {
	  ...
	  case NVRAM_EF_EL1_LTE_ET_CAL_DATA_FILTER_LID:
      {
         #if __IS_EL1D_ET_SUPPORT__
         LTE_ET_NVRAM_CANNOT_OTA_T *p_buffer = (LTE_ET_NVRAM_CANNOT_OTA_T*)buffer;
	     kal_mem_cpy(&(p_buffer->pa_para), &(LTE_FILTER_ET_DRIVER_PARA_SetDefault[index_select]), sizeof(LTE_ET_DRIVER_PARAMETER_NVRAM_CUSTOM_T));
         #endif
      }
      break;

	  case NVRAM_EF_EL1_LTE_ET_CAL_DATA_FILTER_CCA_LID:
      {
         #if __IS_EL1D_ET_SUPPORT__
         LTE_ET_NVRAM_CANNOT_OTA_T *p_buffer = (LTE_ET_NVRAM_CANNOT_OTA_T*)buffer;
	     kal_mem_cpy(&(p_buffer->pa_para), &(LTE_FILTER_CCA_ET_DRIVER_PARA_SetDefault[index_select]), sizeof(LTE_ET_DRIVER_PARAMETER_NVRAM_CUSTOM_T));
         #endif
      }
      break;
	  ...
	  case NVRAM_EF_EL1_LTE_ET_MANUAL_PARAMETER_FILTER_LID:
      {
         #if __IS_EL1D_ET_SUPPORT__
         LTE_ET_MANUAL_PARAMETER_NVRAM_CUSTOM_T *p_buffer = (LTE_ET_MANUAL_PARAMETER_NVRAM_CUSTOM_T*)buffer;
	     kal_mem_cpy(p_buffer, LTE_FILTER_ET_MANUAL_PARA_SetDefault[index_select], sizeof(LTE_ET_MANUAL_PARAMETER_NVRAM_CUSTOM_T));
         #endif  
 	  }
      break;

	  case NVRAM_EF_EL1_LTE_ET_MANUAL_PARAMETER_FILTER_CCA_LID:
      {
         #if __IS_EL1D_ET_SUPPORT__
         LTE_ET_MANUAL_PARAMETER_NVRAM_CUSTOM_T *p_buffer = (LTE_ET_MANUAL_PARAMETER_NVRAM_CUSTOM_T*)buffer;
	     kal_mem_cpy(p_buffer, LTE_FILTER_CCA_ET_MANUAL_PARA_SetDefault[index_select], sizeof(LTE_ET_MANUAL_PARAMETER_NVRAM_CUSTOM_T));
         #endif          
      }
      break;
