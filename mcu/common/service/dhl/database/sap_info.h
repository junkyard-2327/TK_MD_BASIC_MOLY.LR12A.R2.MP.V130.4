...
//#endif __GEMINI_LTE__
    ...
    SAP_INFO(EMM_ESMIF_SV_SAP, MOD_EMM_ESMIF_2, MOD_EMM_PLMNSEL_2)
...
// SAP_INFO(CSS_EVALMP_SAP, MOD_CSS, MOD_EVALMP)
   ...
   SAP_INFO(PS_SIM_SAP,MOD_SIM,MOD_UIM)
   ...
   /* L4B */
    ...
    SAP_INFO(D2RM_IWLAN_SAP, MOD_DAST, MOD_IWLAN)
    SAP_INFO(D2RM_IWLAN_SAP, MOD_DAST_2, MOD_IWLAN_2)
    SAP_INFO(D2RM_IWLAN_SAP, MOD_DAST_3, MOD_IWLAN_3)
    SAP_INFO(D2RM_IWLAN_SAP, MOD_DAST_4, MOD_IWLAN_4)
    SAP_INFO(D2RM_IWLAN_SAP, MOD_IWLAN, MOD_DAST)
    SAP_INFO(D2RM_IWLAN_SAP, MOD_IWLAN_2, MOD_DAST_2)
    SAP_INFO(D2RM_IWLAN_SAP, MOD_IWLAN_3, MOD_DAST_3)
    SAP_INFO(D2RM_IWLAN_SAP, MOD_IWLAN_4, MOD_DAST_4)

    SAP_INFO(D2RM_DDM_SAP, MOD_DAST, MOD_DDM)
    SAP_INFO(D2RM_DDM_SAP, MOD_DAST_2, MOD_DDM_2)
    SAP_INFO(D2RM_DDM_SAP, MOD_DAST_3, MOD_DDM_3)
    SAP_INFO(D2RM_DDM_SAP, MOD_DAST_4, MOD_DDM_4)
    SAP_INFO(D2RM_DDM_SAP, MOD_DDM, MOD_DAST)
    SAP_INFO(D2RM_DDM_SAP, MOD_DDM_2, MOD_DAST_2)
    SAP_INFO(D2RM_DDM_SAP, MOD_DDM_3, MOD_DAST_3)
    SAP_INFO(D2RM_DDM_SAP, MOD_DDM_4, MOD_DAST_4)

    SAP_INFO(D2RM_WO_SAP, MOD_DAST, MOD_WO)
    SAP_INFO(D2RM_WO_SAP, MOD_DAST_2, MOD_WO_2)
    SAP_INFO(D2RM_WO_SAP, MOD_DAST_3, MOD_WO_3)
    SAP_INFO(D2RM_WO_SAP, MOD_DAST_4, MOD_WO_4)
    SAP_INFO(D2RM_WO_SAP, MOD_WO, MOD_DAST)
    SAP_INFO(D2RM_WO_SAP, MOD_WO_2, MOD_DAST_2)
    SAP_INFO(D2RM_WO_SAP, MOD_WO_3, MOD_DAST_3)
    SAP_INFO(D2RM_WO_SAP, MOD_WO_4, MOD_DAST_4)
    ...
    SAP_INFO(D2AM_SAP, ANY, MOD_D2AM)
    SAP_INFO(D2AM_SAP, ANY, MOD_D2AM_2)
    SAP_INFO(D2AM_SAP, ANY, MOD_D2AM_3)
    SAP_INFO(D2AM_SAP, ANY, MOD_D2AM_4)
    SAP_INFO(D2AM_SAP, MOD_D2AM, ANY)
    SAP_INFO(D2AM_SAP, MOD_D2AM_2, ANY)
    SAP_INFO(D2AM_SAP, MOD_D2AM_3, ANY)
    SAP_INFO(D2AM_SAP, MOD_D2AM_4, ANY)
