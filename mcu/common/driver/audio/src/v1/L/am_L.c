...
extern void L1D_Reset_Time_Drift( void );
extern kal_int16 L1D_Get_Time_Drift( void );
                         ...
                         kal_uint32 dummy1, kal_uint32 dummy2, kal_uint32 dummy3, kal_uint32 dummy4 )
{
   ...
   if(kal_if_lisr())
   {
      //Check with Hosen Chen / TH Yeh, CTIRQ do 23G Giant lock protection without HRT DI/EI.
