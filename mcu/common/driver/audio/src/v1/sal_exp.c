...
{
	L1Audio_Msg_SAL_PROC(SAL_PROC_NAME(57), dsp_end, SAL_UNKNOWN, SAL_UNKNOWN, SAL_UNKNOWN);
...
{
	L1Audio_Msg_SAL_PROC(SAL_PROC_NAME(43), dsp_end, SAL_UNKNOWN, SAL_UNKNOWN, SAL_UNKNOWN);
...
{
	L1Audio_Msg_SAL_PROC(SAL_PROC_NAME(47), bDsp_end, SAL_UNKNOWN, SAL_UNKNOWN, SAL_UNKNOWN);
...
{
	L1Audio_Msg_SAL_PROC(SAL_PROC_NAME(45), dsp_end, SAL_UNKNOWN, SAL_UNKNOWN, SAL_UNKNOWN);
