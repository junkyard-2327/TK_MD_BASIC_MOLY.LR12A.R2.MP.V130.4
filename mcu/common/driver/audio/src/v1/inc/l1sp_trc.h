...
BEGIN_TRACE_MAP(MOD_L1SP)
   ...
   TRC_MSG(MIXER_CHECK1, "PcmMixer: unknow syncWord %d")
   TRC_MSG(MIXER_CHECK2, "PcmMixer: unknow type %d")
   TRC_MSG(MIXER_CHECK3, "PcmMixer: incorrect length %d")
...
// 4G speech
   ...
   // CCCI Message
   TRC_MSG(SPCIO_GET_FACTORYINFO, "SPCIO ccci.FeatureMask = %x. factory mode = %x")
   TRC_MSG(SPCIO_FACTORY_DATA_NO_SEND, "SPCIO [factorymode] msg %x is NotSend")
