...
#elif defined(MT6763) || defined(MT6739) || defined(MT6771) || defined(MT6765) || defined(MT6761)
...
#define DCXO_DIV_UPDATE_TH (392*2*2048/50)    /* /5 for WR8 project (~5x echips timing error in 3G); /50 for <10 echips */
...
#define LPM_DIV_OFFSET_23G_VAR2                     300*4
