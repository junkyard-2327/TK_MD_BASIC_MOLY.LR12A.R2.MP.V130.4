...
#define POLL_STATUS(poll_statement)  do{kal_uint32 __cnt=0;while(poll_statement){if(10000<__cnt++){IDC_ASSERT(0);}}}while(0)
...
void drv_idc_schedule_update(kal_uint32 time)
{
	...
	kal_uint32 bitmap32 = 0, scheduler_status = 0, expired_evt_status = 0;
...
DCL_STATUS drv_idc_get_pin_config(IDC_PIN_MODE_T *pin_mode)
{
	...
	#if defined(MT6763) || defined(MT6739)|| defined(MT6765)|| defined(MT6761)
