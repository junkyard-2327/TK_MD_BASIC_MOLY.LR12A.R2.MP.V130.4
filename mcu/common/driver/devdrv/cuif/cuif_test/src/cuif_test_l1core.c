...
void SSDVT_CUIF_U2C_WFI_Test_L1core(){
    ...
    for (mcu_vpe = 0; mcu_vpe < 2; mcu_vpe++)
    {
        if (ssdvt_cuif_usip_core_testing == 0) {
            wfi_check = (mcu_vpe == 0) ? SSDVT_CUIF_USIP0_U2C_N0_WFI_CHECK : SSDVT_CUIF_USIP0_U2C_N4_WFI_CHECK;
        }
        else {
            wfi_check = (mcu_vpe == 0) ? SSDVT_CUIF_USIP1_U2C_N0_WFI_CHECK : SSDVT_CUIF_USIP1_U2C_N4_WFI_CHECK;
        }
