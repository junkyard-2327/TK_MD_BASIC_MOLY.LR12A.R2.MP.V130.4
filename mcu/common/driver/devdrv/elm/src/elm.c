...
#if defined(MT6771) || defined(MT6765) || defined(MT6761)
...
void elmtop_emi_isr_handler()
{
	...
	emi_elm_runtime_lat_history[emi_elm_runtime_lat_history_idx%ELM_RUNTIME_HISTORY_SIZE].w_l2_tot_alat = write_total_count;
...
void elm_dma_isr_handler()
{
	...
	dma_elm_runtime_lat_history[dma_elm_runtime_lat_history_idx%ELM_RUNTIME_HISTORY_SIZE].w_l2_tot_alat = write_total_count;
