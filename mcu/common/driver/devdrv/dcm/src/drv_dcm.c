 ...
 * $Log$
 *
 * 03 21 2018 jun-ying.huang
 * [MOLY00314974] [Merlot call for check-in] [PLL][DCM]Add Macro for MT6761(=Merlot) for R2
 * .
 *
 * 01 09 2018 jun-ying.huang
 * [MOLY00300472] [Cervino bringup merge back][PLL][DCM]Add Macro for MT6765(=Cervino)
 * Add macro for Cervino
 *
...
#else /* other(ZION, SYLVIA, CERVINO, MERLOT) is clock/10 */
    if(en)
    {
        //MDCORE(MDMCU & uSIP) clock DCM enable
