...
static kal_hisrid gpt5_hisrid;
static kal_hisrid gpt6_hisrid;
...
{
    //kal_activate_hisr(gpt6_hisrid);
    kal_hrt_activate_hisr(gpt6_hisrid);
...
//#ifndef GPT_LP_TEST
    ...
    gpt5_hisrid = kal_init_hisr(GPT5_HISR);
    gpt6_hisrid = kal_init_hisr(GPT6_HISR);
