 ...
 *
 * 03 22 2018 yao.xue
 * [MOLY00315422] [Merlot call for check in] Update UART merlot option
 * update  merlot option for uart/IDC
 *
 * 03 22 2018 yao.xue
 * [MOLY00315422] [Merlot call for check in] Update UART merlot option
 * 	
 * 	[Merlot] update  merlot option for uart/IDC
 *
 * 03 22 2018 yao.xue
 * [MOLY00315422] [Merlot call for check in] Update UART merlot option
 * [Merlot] update  merlot option for uart/IDC
 *
 * 01 08 2018 yao.xue
 * [MOLY00300509] [Cervino bring up merge back]merge back IDC& UART
 *
 * 09 15 2017 da.li
 * [MOLY00270315] [System Service][KIR] make ex robust before ex steplog work
 * Replace INT_QueryExceptionStatus with <ex_public.h>.
 *
 * 08 29 2017 da.li
 * [MOLY00274163] [Sylvia] Driver porting
 * UART driver porting on sylvia.
 *
 * 08 28 2017 da.li
 * [MOLY00274163] [Sylvia] Driver porting
 * UART driver porting on MT6771(Sylvia).
 *
 * 06 12 2017 flamingo.wang
 * [MOLY00244966] [ZION][IDC] add chip define of MT6739 in idc driver
 * UART normal mode print log fix
 *
 * 06 12 2017 flamingo.wang
 * [MOLY00244966] [ZION][IDC] add chip define of MT6739 in idc driver
 * add MT6739 chip define
 *
...
#if defined(MT6595)||defined(MT6290)
...
#elif defined(TK6291) || defined(MT6755)|| defined(ELBRUS)||defined(MT6763)||defined(MT6739)||defined(MT6771)||defined(MT6765)||defined(MT6761)
...
#if defined(TK6291) || defined(MT6755)|| defined(ELBRUS)||defined(MT6763)||defined(MT6739)||defined(MT6771)||defined(MT6765)||defined(MT6761)
