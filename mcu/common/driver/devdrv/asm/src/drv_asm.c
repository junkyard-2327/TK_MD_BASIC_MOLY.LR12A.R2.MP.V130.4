...
__MCURW_HWRW_C_ALIGNED_L2CACHE_LOCK_ZI(4) ASM_STRUCT Asm_Infor[ASM_NUM];

__MCURW_HWRW_C_ALIGNED_L2CACHE_LOCK_ZI(4) kal_uint32 Asm_Infor_gen_config[ASM_NUM];
__MCURW_HWRW_C_ALIGNED_L2CACHE_LOCK_ZI(4) kal_uint32 Asm_Infor_context_id[ASM_NUM][ASM_TC_NUM];
__MCURW_HWRW_C_ALIGNED_L2CACHE_LOCK_ZI(4) kal_uint32 Asm_Infor_trigger_cnt[ASM_NUM];
...
__MCURW_HWRW_C_ALIGNED_L2CACHE_LOCK_ROCODE ASM_ERROR_CODE ASM_SetAddon(kal_uint32 core,kal_uint32 tc,kal_uint32* addon_infor,kal_uint32 size,kal_uint32 start_index )
{
	kal_uint32 i;
...
__MCURW_HWRW_C_ALIGNED_L2CACHE_LOCK_ROCODE void ASM_SetTCContextID(kal_uint32 core, kal_uint32 tc,kal_uint32 id)
{
...
*   
*************************************************************************/
__MCURW_HWRW_C_ALIGNED_L2CACHE_LOCK_ROCODE void ASM_SendTrigger(kal_uint32 core,kal_uint32 tc)
{
    if(Asm_Infor_gen_config[core]&ASM_ENABLE_MASK)
    {
