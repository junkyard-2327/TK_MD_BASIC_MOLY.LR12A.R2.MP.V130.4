 ...
 * $Log$
 *
 * 03 22 2018 yen-chun.liu
 * [MOLY00315399] [Merlot call for check-in][MT6761][Gen93][System Service][MDCIRQ][R2] Compile option for MERLOT(MT6761)
 * .
 *
 * 03 22 2018 yen-chun.liu
 * [MOLY00315399] [Merlot call for check-in][MT6761][Gen93][System Service][MDCIRQ][R2] Compile option for MERLOT(MT6761)
 ...
 * .
 *
 * 01 09 2018 yen-chun.liu
 * [MOLY00300551] [Cervino bringup merge back][MT6765][Gen93][System Service][MDCIRQ] Compile option for CERVINO(MT6765)
 * 	
 * 	.
 *
 * 09 28 2017 yen-chun.liu
 * [MOLY00280810] [LR12A.R2.MP] Performance improvement of INT_QueryExceptionStatus
 ...
 * Slyvia(MT6771) chip option check-in.
 *
 ...
 * enable MDCIRQ wait mode to avoid have pending interrupt to enter sleep mode.
 *
...
{
#if ( defined(ELBRUS) || defined(MT6763) || defined(MT6739) || defined(MT6771) || defined(MT6765) || defined(MT6761) )
...
*
*************************************************************************/
__MCURW_HWRW_C_ALIGNED_L2CACHE_LOCK_ROCODE void MDCIRQ_Activate_LISR_dummy_lisr(kal_uint32 TriggerMask)
{
