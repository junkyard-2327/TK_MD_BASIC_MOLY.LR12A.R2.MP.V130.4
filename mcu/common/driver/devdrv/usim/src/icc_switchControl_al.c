...
#if (defined(DRV_SIM_6292_SERIES)||defined(DRV_SIM_6293_SERIES)) && defined(SIM_DRV_SWITCH_MT6306)
...
#elif defined(MT6771)
    // clear R0, Set R1
    DRV_WriteReg32(REG_GPIO_PUPD_0_FOR_SIM, DRV_Reg32(REG_GPIO_PUPD_0_FOR_SIM) & (~0x00700007));
	DRV_WriteReg32(REG_GPIO_PUPD_0_FOR_SIM, DRV_Reg32(REG_GPIO_PUPD_0_FOR_SIM) |(0x00200002));
#endif
    Data_Sync_Barrier();
...
HAVE_REG_EINT:
    ...
    kal_sprintf(hw_cb->dbgStr, "[SIM_DRV:%d]Reset Status: %x\n\r", hw_cb->simInterface, status);
    DRV_ICC_print_str(hw_cb->dbgStr);
