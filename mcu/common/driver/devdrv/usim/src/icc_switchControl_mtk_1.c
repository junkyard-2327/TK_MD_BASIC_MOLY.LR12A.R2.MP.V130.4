...
static void usim_set_speed(usim_speed_enum speed, sim_HW_cb *hw_cb)
{
    ...
    {
        clk_div = DRV_Reg32(SIM0_BASE_ADDR_MTK + SIM_BRR_MTK) & (~0x7FC);
    }
...
#if !defined(ATEST_DRV_ENABLE)
    kal_brief_trace(TRACE_INFO, LOG_SIM_DRV_HISR, hw_cb->simInterface, int_status, DRV_Reg32(SIM0_BASE_ADDR_MTK + SIM_IRQEN_MTK),usim_dcb->ev_status);
#endif
