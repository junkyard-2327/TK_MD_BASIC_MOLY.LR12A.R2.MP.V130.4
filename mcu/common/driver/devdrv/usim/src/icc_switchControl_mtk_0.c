...
void SIM_HISR_Multiple(void)
{
    ...
    DRV_ICC_print_str(hw_cb->hisrDbgStr);
#else
    kal_brief_trace(TRACE_INFO, LOG_SIM_DRV_HISR, hw_cb->simInterface, sim_int, DRV_Reg32(SIM0_BASE_ADDR_MTK + SIM_IRQEN_MTK),SimCard->State);
#endif
...
#if defined(__TC01__) && defined(__KOR_CUSTOMIZATION__)
