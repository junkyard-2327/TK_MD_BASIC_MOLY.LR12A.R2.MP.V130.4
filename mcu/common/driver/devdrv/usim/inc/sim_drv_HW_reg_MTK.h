...
#if defined(SIM_DRV_USE_MDGPIO_I2C)
    #define MD_AP_DUMMY_I2C     (BASE_MADDR_MDPERIMISC+0x000)
    #define AP_MD_DUMMY_I2C     (BASE_MADDR_MDPERIMISC+0x000)
    #define MD_AP_SCL       (1<<0)
    #define MD_AP_SDA       (1<<0)
    #define MD_AP_SDA_OE    (1<<0)
#endif
