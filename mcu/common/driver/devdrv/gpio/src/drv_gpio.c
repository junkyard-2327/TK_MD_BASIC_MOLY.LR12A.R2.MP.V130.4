 ...
 * $Log$
 *
 * 03 22 2018 zhiqiang.yu
 * [MOLY00315488] [Build Error]MT6761 Gpio Driver Check In.
 *
 * 03 22 2018 zhiqiang.yu
 * [MOLY00315488] [Build Error]MT6761 Gpio Driver Check In
 * 	
 * 	.
 *
 * 01 08 2018 zhiqiang.yu
 * [MOLY00300503] [Cervino bringup merge back]call for MT6765 gpio driver check in
 * 	
 * 	.
 *
...
kal_int32 gpio_get_dir_value (gpio_pin_e gpio_pin)
{
	...
	return dir_val;
#elif defined(MT6755)||defined(MT6797)|| defined(ELBRUS) || defined(MT6763)||defined(MT6739)||defined(MT6771) || defined(MT6765)|| defined(MT6761)
	unsigned long pos;
	unsigned long bit;
	unsigned long data;
...
#elif defined(MT6797) || defined(ELBRUS) || defined(MT6763)||defined(MT6739)||defined(MT6771) || defined(MT6765)|| defined(MT6761)
