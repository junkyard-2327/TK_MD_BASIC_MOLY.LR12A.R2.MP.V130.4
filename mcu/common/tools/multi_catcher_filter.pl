...
sub usage {
  print "Usage:\n";
  print "\tperl multi_catcher_filter.pl <BUILD_FOLDER> <MTK_REL> <CGEN_CFG_MODEM> <CGEN> <CODEGEN_DATABASE> <CUSTOMIZATION> <FILTER_INI> <DSP_PROJECT> <DSP_FLAVOR> <MTK_INTERNAL> <log2SD_Catcher_filters_xxx.ini>\n\n";
