...
##########################################################
	...
	my $checksum_value=sprintf("%u", &crc32(&merge_checksum_input(@CUIF_INNER_BRP)));
        ...
        my $checksum_value=sprintf("%u", &crc32(&merge_checksum_input(@CUIF_FEC_WBRP)));
        $checksum_value=join($checksum_value,"","u");
        return $checksum_value;
	...
	my $checksum_value=sprintf("%u", &crc32(&merge_checksum_input(@CUIF_SPEECH)));
        $checksum_value=join($checksum_value,"","u");
        return $checksum_value;
