...
void UL1D_MMRF_RFCAL_STX_CONFIG_BUFFER_2(MMRFC_XL1_BAND_SUPPORT_CAPABILITY_T* band_cap_p,
                                           kal_uint8 band_index,
                                           kal_uint8* length,
                                           MMRFC_STX_CONFIG_BUFFER_T* buffer);

void UL1D_MMRF_RFCAL_TX_CONFIG_BUFFER_2(MMRFC_XL1_BAND_SUPPORT_CAPABILITY_T* band_cap_p,
                                        kal_uint8 band_index,
                                        kal_uint8* length,
                                        MMRFC_TX_CONFIG_BUFFER_T* buffer);

void UL1D_MMRF_RFCAL_LIN_CONFIG_BUFFER_2(MMRFC_XL1_BAND_SUPPORT_CAPABILITY_T* band_cap_p,
                                         kal_uint8 band_index,
                                         kal_uint8* length,
                                         MMRFC_TX_DRV_BIAS_LIN_CONFIG_BUFFER_T* buffer);

void UL1D_MMRF_RFCAL_DPD_CONFIG_BUFFER_2(MMRFC_XL1_BAND_SUPPORT_CAPABILITY_T* band_cap_p,
                                         kal_uint8 band_index,
                                         kal_uint8* length,
