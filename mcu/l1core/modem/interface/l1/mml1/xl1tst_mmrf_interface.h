...
#include "el1d_rf_cid.h"
   ...
   extern void EL1D_ET_Start_Cmd_V3_Handler(MMRfTest_StartEtFacCalV3Mix * p_start_mix);
   extern void EL1D_ET_Set_Cmd_V3_Handler( MMRfTest_SetEtCalResultV3Mix *p_set_mix );
   extern void EL1D_ET_Get_Cmd_V3_Handler( MMRfTest_GetEtCalResultV3Mix *p_get_mix );
   extern void EL1D_ET_Check_Path_Delay_Search_Cmd_V3_Handler( MMRfTestETPathDelayCheckV3Mix *p_check_path_mix );
   extern void EL1D_ET_Fac_Start_PathDelaySearch_Cmd_V2_Handler( MMRfTestETPathDelayStartV2Mix *p_start_path_mix );
   extern void EL1D_ET_Mode_Setting_Cmd_Handler(MMRfTestETModeSettingCmdRptMix* p_et_mode_setting_mix);
   extern void EL1D_Set_Tool_Usage_To_L1_Cmd_Handler(MMRfTestSetToolUsageToL1CmdRptMix* p_set_tool_usage_to_l1_mix);
#else
   #define EL1D_ET_Start_Cmd_V3_Handler                     NULL
   #define EL1D_ET_Set_Cmd_V3_Handler                       NULL
   #define EL1D_ET_Get_Cmd_V3_Handler                       NULL
   #define EL1D_ET_Check_Path_Delay_Search_Cmd_V3_Handler   NULL
   #define EL1D_ET_Fac_Start_PathDelaySearch_Cmd_V2_Handler NULL
