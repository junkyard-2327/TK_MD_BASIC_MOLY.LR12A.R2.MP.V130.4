...
* define
**********************************************************************************/
#define   CL1D_RFC_RECAL_ENABLE                     (1)
...
//void CL1D_MMRF_RFCAL_BIAS_TEMP_CONFIG_BUFFER(MMRFC_XL1_BAND_SUPPORT_CAPABILITY_T* band_cap_p, MML1_RF_BSIMM_PORT_T port_sel);
...
#define CL1D_GetTasStateConfig	NULL
	...
	void CL1D_C2K_Calibration_Data_File_Check_Valid(kal_uint16 *tablePtr);
#endif
