...
//cal default value
extern LTE_sRAMP_DEFAULT_TBL_T              LTE_RampData_Pool[LTE_RAMP_DEFAULT_VALUE_TBL_SIZE];
extern LTE_sPAOCTLVL_DEFAULT_TBL_T          LTE_PaOctLvl_Pool[LTE_PAOCTLVL_DEFAULT_VALUE_TBL_SIZE];
extern LTE_RX_PL_ROUTE_TYPE1_DEFAULT_TBL_T  LTE_RSSIGainTblType1_Pool[LTE_RSSITYPE1_DEFAULT_VALUE_TBL_SIZE];
extern LTE_RX_PL_ROUTE_TYPE2_DEFAULT_TBL_T  LTE_RSSIGainTblType2_Pool[LTE_RSSITYPE2_DEFAULT_VALUE_TBL_SIZE];
extern LTE_sRAMP_DEFAULT_TBL_T              LTE_FILTER_RampData_Pool[LTE_FILTER_DEFAULT_TBL_SIZE];
extern LTE_sPAOCTLVL_DEFAULT_TBL_T          LTE_FILTER_PaOctLevTable_Pool[LTE_FILTER_DEFAULT_TBL_SIZE];
