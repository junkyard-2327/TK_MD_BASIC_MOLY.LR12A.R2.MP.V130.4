...
/*MT6177L*/         )
/*MT6177L*/       {
/*MT6177L*/          /*idx = (int)(((agcptr->setting)>>5)&0x7);*/
/*MT6177L*/    #if IS_2G_EXTERNAL_LNA_SUPPORT
/*MT6177L*/       	if( is_elna_usage )
/*MT6177L*/       	{
/*MT6177L*/          	if( idx==5 )      /* LNA_High    : G5 */
/*MT6177L*/          	{  lna_path_loss_offset = (int)(ofsptr_offset->gain_offset);  }
/*MT6177L*/          	else if( idx==4 ) /* LNA_Middle : G4 */
...
/*MT6177L*/    { /* do nothing */ }
/*MT6177L*/    #if IS_2G_EXTERNAL_LNA_SUPPORT 
/*MT6177L*/        #if IS_2G_RX_DIVERSITY_PATH_SUPPORT 
...
/*MT6173*/         )
/*MT6173*/       {
/*MT6173*/          /*idx = (int)(((agcptr->setting)>>5)&0x7);*/
/*MT6173*/    #if IS_2G_EXTERNAL_LNA_SUPPORT
/*MT6173*/       	if( is_elna_usage )
/*MT6173*/       	{
/*MT6173*/          	if( idx==5 )      /* LNA_High    : G5 */
/*MT6173*/          	{  lna_path_loss_offset = (int)(ofsptr_offset->gain_offset);  }
/*MT6173*/          	else if( idx==4 ) /* LNA_Middle : G4 */
...
/*MT6173*/    { /* do nothing */ }
/*MT6173*/    #if IS_2G_EXTERNAL_LNA_SUPPORT 
/*MT6173*/       #if IS_2G_RX_DIVERSITY_PATH_SUPPORT 
...
/*HAL*/                else                        /* LNA_Low       */
/*HAL*/                {   lna_path_loss_offset.PRX = (Gain)(ofsptr_offset_PRX->gain_offset_low);  } /*BYPASS*/
/*HAL*/                break;
/*HAL*/          }
/*HAL*/          switch( lna_DRX )
/*HAL*/          {
...
/*HAL*/                else                        /* LNA_Low       */
/*HAL*/                {   lna_path_loss_offset.DRX = (Gain)(ofsptr_offset_DRX->gain_offset_low);  } /*BYPASS*/
/*HAL*/                break;
/*HAL*/          }
/*HAL*/       }
/*HAL*/       else
...
/*HAL*/       L1D_RF_RPO_Trace( L1D_CheckIfMetaMode(), meta_rx_power_offset_enable, lna_DRX, rf_band, arfcn, lna_path_loss_offset.DRX);
/*HAL*/    }
/*HAL*/    #endif/*IS_RX_POWER_OFFSET_SUPPORT*/
/*HAL*/
/*HAL*/    #if IS_RX_POWER_OFFSET_SUPPORT
