...
#define TQ_MAXIMUM_MARKER 0x0FFFFFFF
#define TQ_MAXIMUM_IND    0xFFFFFFFF
#endif /* IS_L1D_MMRF_BSIBPIRS_DYNAMIC_ALLOCATION_SUPPORT */

#if IS_GL1D_RXD_SUPPORT
#define BFE_RX_SET_NUM_REG 8
#else
#define BFE_RX_SET_NUM_REG 4
...
#define DPRAM(offset)   ((FD216DMDPRAMADDR)(DPRAM_CPU_base+(offset)*DPRAM_MEM_BYTE_ALIGN))
#define DPRAM2(offset)  ((FD216DMDPRAMADDR)(DPRAM2_CPU_base+(offset)*DPRAM_MEM_BYTE_ALIGN))
#endif
...
#if IS_CHIP_MT6293
typedef volatile unsigned long*  FD216DMDPRAMADDR;                             /* DPRAM addr is 32 bits                         */
typedef volatile signed   long*  FD216DMDPRAMADDR_S;                           /* DPRAM addr is 32 bits                         */
#else
typedef volatile unsigned short* FD216DMDPRAMADDR;                           /* DPRAM addr is 16 bits                         */
typedef volatile signed   short* FD216DMDPRAMADDR_S;                         /* DPRAM addr is 16 bits                         */
#endif
...
#define  BFE1_base   L1_BASE_MADDR_BFE_1
      #endif /* IS_EDGE_CHIP_MT6295_AND_LATTER_VERSION */
   #endif
...
#define  BPI_base    L1_BASE_MADDR_MD2G_BPI_BAS
   #endif
...
#if IS_CHIP_MT6293
/* Short mode access is not supported in MT6293 */
#else
#define IDMA_SHORT_ADDR          ((FD216DMDPRAMADDR)IDMA_SHORT)
#endif /*IS_CHIP_MT6293*/
...
#if IS_DSP_DM_4BYTE_ALIGN_CHIP
#define DSP_DM_ADDR(page,addr)   ((FD216DMDPRAMADDR)(IDMA_DM0+((page)<<16)+((addr)<<2)))
#else
#define DSP_DM_ADDR(page,addr)   ((FD216DMDPRAMADDR)(IDMA_DM0+((page)<<16)+((addr)<<1)))
#endif
...
#define IDMA_SB_RX_FILTER           (FD216DMDPRAMADDR)(IDMA_DM0+(0x1D83<<2))
   #endif
#endif
...
#define SCTRL_WORD( dev_sel, port_sel )  ((unsigned long)(((dev_sel)<<15)                          |((port_sel&0x3)<<16)))
#define SCTRL_IMOD( dev_sel, port_sel )  ((unsigned long)(((dev_sel)<<15)                   |(0x7F)|((port_sel&0x3)<<16)))
...
#define  HW_WRITE_BSI_DATA_26( data_idx, ctrl1,data1, ctrl2,data2, ctrl3,data3, ctrl4,data4, ctrl5,data5, ctrl6,data6, ctrl7,data7 , ctrl8,data8 , ctrl9,data9 , ctrl10,data10 , ctrl11,data11 , ctrl12,data12 , ctrl13,data13, ctrl14,data14 , ctrl15,data15 , ctrl16,data16 , ctrl17,data17 , ctrl18,data18 , ctrl19,data19, ctrl20,data20, ctrl21,data21, ctrl22,data22, ctrl23,data23, ctrl24,data24, ctrl25,data25, ctrl26,data26 )  \
{  long       _d32, _d_idx=data_idx;                                                                                                                                                                                                                                                                                                                                                                                                      \
   APBADDRBSI _reg = BSI_Dn_CON( data_idx );                                                                                                                                                                                                                                                                                                                                                                                              \
   _d32 = ctrl1;  HW_WRITE( _reg, TO_WORD(_d32) );      _reg += BSI_REG_IDX;                                                                                                                                                                                                                                                                                                                                                              \
   _d32 = data1;  HW_WRITE( (APBADDR32)(_reg), _d32 );  _d_idx++;                                                                                                                                                                                                                                                                                                                                                                         \
   ...
   _d32 = data26; HW_WRITE( (APBADDR32)(_reg), _d32 );                                                                                                                                                                                                                                                                                                                                                                                    \
}
...
{  struct
   {  /*-----RX_CON0-----------*/
      unsigned int  lpbk_en           : 1;  // immediately
      unsigned int  rx_iq_swp         : 1;  // immediately
      unsigned int  write_rx_dm_by_sw : 1;  // immediately
      unsigned int  reserved1         : 3;
      unsigned int  rx_dc_notch_en    : 1;  // immediately
      unsigned int  rx_rst_en         : 1;  // immediately
      unsigned int  rx_rpt_en         : 8;  // double buffer by slot
      /*---RX_TIME_CON0--------*/
      unsigned int  rx_null_str_nb    : 7;  // immediately
      unsigned int  rx_dcoc_str_nb    : 7;  // immediately
      unsigned int  reserved2         : 2;
      /*---RX_TIME_CON1--------*/
      unsigned int  rx_ircmpn_sw      : 7;  // immediately
      unsigned int  reserved3         : 9;
      /*---RX_TIME_CON2--------*/
      unsigned int  rx_null_str       : 7;  // immediately
      unsigned int  rx_dcoc_str       : 7;  // immediately
      unsigned int  reserved4         : 2;
      #if IS_2GRXD_CHIP_MT6765_AND_LATTER_VERSION
      /*-----RX_CON0_BFE1-----------*/
      unsigned int  lpbk_en_bfe1           : 1;  // immediately
      unsigned int  rx_iq_swp_bfe1         : 1;  // immediately
      unsigned int  write_rx_dm_by_sw_bfe1 : 1;  // immediately
      unsigned int  reserved1_bfe1         : 3;
      unsigned int  rx_dc_notch_en_bfe1    : 1;  // immediately
      unsigned int  rx_rst_en_bfe1         : 1;  // immediately
      unsigned int  rx_rpt_en_bfe1         : 8;  // double buffer by slot
      /*---RX_TIME_CON0_BFE1--------*/
      unsigned int  rx_null_str_nb_bfe1    : 7;  // immediately
      unsigned int  rx_dcoc_str_nb_bfe1    : 7;  // immediately
      unsigned int  reserved2_bfe1         : 2;
      /*---RX_TIME_CON1_BFE1--------*/
      unsigned int  rx_ircmpn_sw_bfe1      : 7;  // immediately
      unsigned int  reserved3_bfe1         : 9;
      /*---RX_TIME_CON2_BFE1--------*/
      unsigned int  rx_null_str_bfe1       : 7;  // immediately
      unsigned int  rx_dcoc_str_bfe1       : 7;  // immediately
      unsigned int  reserved4_bfe1         : 2;
      #endif /* IS_GL1D_RXD_SUPPORT */
   } field;
   unsigned short  data[BFE_RX_SET_NUM_REG];
} BFERXSET;

typedef  union
{  struct
   {  /*--TX_CON0-----------*/
      unsigned int  mdsel         :  6;  // double buffer and by slot
      unsigned int  reserved1     :  2;
      unsigned int  all_10_gen    :  2;  // double buffer
      unsigned int  reserved2     :  1;
      unsigned int  bcien         :  1;  // double buffer
      unsigned int  reserved3     :  4;
      /*--TX_CON1-----------*/
      unsigned int  tx_cnt_tgt    :  8;  // double buffer
      unsigned int  reserved4     :  8;
      /*--TX_CON2-----------*/
      unsigned int  reserved5     :  8;
      unsigned int  tx_cnt_tgt_sw :  8;  // double buffer
      /*--TX_PWR0-----------*/
      unsigned int  pwr_sel0      :  9;  // double buffer
      unsigned int  reserved6     :  7;
      /*--TX_PWR1-----------*/
      unsigned int  pwr_sel1      :  9;  // double buffer
      unsigned int  reserved7     :  7;
      /*--TX_PWR2-----------*/
      unsigned int  pwr_sel2      :  9;  // double buffer
      unsigned int  reserved8     :  7;
      /*--TX_PWR3-----------*/
      unsigned int  pwr_sel3      :  9;  // double buffer
      unsigned int  reserved9     :  7;
      /*--TX_PWR4-----------*/
      unsigned int  pwr_sel4      :  9;  // double buffer
      unsigned int  reserved10    :  7;
      /*--TX_PWR5-----------*/
      unsigned int  pwr_sel5      :  9;  // double buffer
      unsigned int  reserved11    :  7;
      /*--TX_DLY_CON--------*/
      unsigned int  pm_dly        :  2;  // double buffer
      unsigned int  am_dly        :  2;  // double buffer
      unsigned int  reserved12    :  9;
      unsigned int  crc_ampmiq    :  1;  // double buffer
      unsigned int  crc_txrx      :  1;  // double buffer
      unsigned int  crc_on        :  1;  // double buffer
   } field;
...
#if IS_CHIP_MT6293
#define RX_CON3                  ((APBADDR)(L1_BASE_MADDR_BFE+0x080C))       /*[0:2] RX_resync_stage */
#endif /* IS_CHIP_MT_6293 */
...
#define RX_TIME_CON2             ((APBADDR)(L1_BASE_MADDR_BFE+0x0824))       /* RX non-NB DCOC NULL timing setting                */
      #endif
#if IS_CHIP_MT6292 || IS_CHIP_MT6293
#define TX_SWAP_SEL              ((APBADDR)(L1_BASE_MADDR_BFE+0x0848))       /* TX Swap Selection Control Register                */
#endif 

#define RX_SWAP_SEL(n)           ((APBADDR)(L1_BASE_MADDR_BFE+0x0828+(n)*4)) /* RX Swap Selection Control Register 0 to 7           */
...
#define W_IMMDT_REG              RX_W_IMMDT
      #endif
      #if IS_2GRXD_CHIP_MT6765_AND_LATTER_VERSION
/* RXD mode register definitions */
#define RX_RXD_MODE(n)                ((APBADDR)(L1_BASE_MADDR_BFE+0x0850+(n)*4))/* RXD mode for window n; n = 0 to 7*/
#define RX_RXD_DELAY                  ((APBADDR)(L1_BASE_MADDR_BFE+0x0870))       /* Timing of updating RXD mode */
#define RX_RXD_MODE_BFE1(n)           ((APBADDR)(L1_BASE_MADDR_BFE_1+0x0850+(n)*4))/* RXD mode for window n; n = 0 to 7*/
#define RX_RXD_DELAY_BFE1             ((APBADDR)(L1_BASE_MADDR_BFE_1+0x0870))       /* Timing of updating RXD mode */

#define RX_BFE_HW_LATENCY_CEIL        (5)                                         /* RX_BFE_HW_LATENCY = 4.5; Ceil value = 5 */  
#define BIT_15TO8_MASK                (0xFF00)                                    
#define RIGHT_SHIFT_BY_8              (8)

/* Definition for BFE1 */
#define BFE_CON0_BFE1                 ((APBADDR)(L1_BASE_MADDR_BFE_1+0x0000))       /* This register is for control of BFE top           */
#define BFE_CON1_BFE1                 ((APBADDR)(L1_BASE_MADDR_BFE_1+0x0004))
#define TX_CON0_BFE1                  ((APBADDR)(L1_BASE_MADDR_BFE_1+0x0400))       /* This register is for control of uplink path       */
                                                                                   /* inclusive of control of TX mixed-signal           */
                                                                                   /* module and TX path in Baseband Front End          */
#define TX_CON1_BFE1                  ((APBADDR)(L1_BASE_MADDR_BFE_1+0x0404))       /* This register is for control of TX power and mode switching timing*/
#define TX_CON2_BFE1                  ((APBADDR)(L1_BASE_MADDR_BFE_1+0x0408))       /*                                                   */
#define TX_PWR0_BFE1                  ((APBADDR)(L1_BASE_MADDR_BFE_1+0x0410))       /* This register is for control of uplink path power */
#define TX_PWR1_BFE1                  ((APBADDR)(L1_BASE_MADDR_BFE_1+0x0414))       /* This register is for control of uplink path power */
#define TX_PWR2_BFE1                  ((APBADDR)(L1_BASE_MADDR_BFE_1+0x0418))       /* This register is for control of uplink path power */
#define TX_PWR3_BFE1                  ((APBADDR)(L1_BASE_MADDR_BFE_1+0x041C))       /* This register is for control of uplink path power */
#define TX_PWR4_BFE1                  ((APBADDR)(L1_BASE_MADDR_BFE_1+0x0420))       /* This register is for control of uplink path power */
#define TX_PWR5_BFE1                  ((APBADDR)(L1_BASE_MADDR_BFE_1+0x0424))       /* This register is for control of uplink path power */
#define TX_CON3_BFE1                  ((APBADDR)(L1_BASE_MADDR_BFE_1+0x0428))       /* This register is for TX AM & PM delay             */
      /* --------------------------------------------------------------------------------------------------------------------- */
#define TX_PHASE_COMP_CON_BFE1(n)     ((APBADDR)(L1_BASE_MADDR_BFE_1+0x0434+(n)*4)) /* TX Phase Compensation Control                     */
#define TX_GAIN_COMP_CON_BFE1(n)      ((APBADDR)(L1_BASE_MADDR_BFE_1+0x0440+(n)*4)) /* TX Gain Compensation Control                      */
      /* --------------------------------------------------------------------------------------------------------------------- */
      

         
/* RXD mode register definitions */
#define RX_RXD_MODE_0_BFE1            ((APBADDR)(L1_BASE_MADDR_BFE_1+0x0850))       /* RXD mode for window 0 */
#define RX_RXD_MODE_1_BFE1            ((APBADDR)(L1_BASE_MADDR_BFE_1+0x0854))       /* RXD mode for window 1 */
#define RX_RXD_MODE_2_BFE1            ((APBADDR)(L1_BASE_MADDR_BFE_1+0x0858))       /* RXD mode for window 2 */
#define RX_RXD_MODE_3_BFE1            ((APBADDR)(L1_BASE_MADDR_BFE_1+0x085C))       /* RXD mode for window 3 */
#define RX_RXD_MODE_4_BFE1            ((APBADDR)(L1_BASE_MADDR_BFE_1+0x0860))       /* RXD mode for window 4 */
#define RX_RXD_MODE_5_BFE1            ((APBADDR)(L1_BASE_MADDR_BFE_1+0x0864))       /* RXD mode for window 5 */
#define RX_RXD_MODE_6_BFE1            ((APBADDR)(L1_BASE_MADDR_BFE_1+0x0868))       /* RXD mode for window 6 */
#define RX_RXD_MODE_7_BFE1            ((APBADDR)(L1_BASE_MADDR_BFE_1+0x086C))       /* RXD mode for window 7 */
#define RX_RXD_DELAY_BFE1             ((APBADDR)(L1_BASE_MADDR_BFE_1+0x0870))       /* Timing of updating RXD mode */

         
/* TX_DC_COMP_I/Q reg definitions can be macros since they are not continuous. */
#define TX_DC_COMP_I_0_BFE1           ((APBADDR)(L1_BASE_MADDR_BFE_1+0x044C))       /* TX DC Compensation for Real Part                  */
#define TX_DC_COMP_Q_0_BFE1           ((APBADDR)(L1_BASE_MADDR_BFE_1+0x0450))       /* TX DC Compensation for Imaginary Part             */
#define TX_DC_COMP_I_1_BFE1           ((APBADDR)(L1_BASE_MADDR_BFE_1+0x0454))       /* TX DC Compensation for Real Part                  */
#define TX_DC_COMP_Q_1_BFE1           ((APBADDR)(L1_BASE_MADDR_BFE_1+0x0458))       /* TX DC Compensation for Imaginary Part             */
#define TX_DC_COMP_I_2_BFE1           ((APBADDR)(L1_BASE_MADDR_BFE_1+0x045C))       /* TX DC Compensation for Real Part                  */
#define TX_DC_COMP_Q_2_BFE1           ((APBADDR)(L1_BASE_MADDR_BFE_1+0x0460))       /* TX DC Compensation for Imaginary Part             */
#define TX_DC_COMP_I_3_BFE1           ((APBADDR)(L1_BASE_MADDR_BFE_1+0x0464))       /* TX DC Compensation for Real Part                  */
#define TX_DC_COMP_Q_3_BFE1           ((APBADDR)(L1_BASE_MADDR_BFE_1+0x0468))       /* TX DC Compensation for Imaginary Part             */
#define TX_DC_COMP_I_4_BFE1           ((APBADDR)(L1_BASE_MADDR_BFE_1+0x046C))       /* TX DC Compensation for Real Part                  */
#define TX_DC_COMP_Q_4_BFE1           ((APBADDR)(L1_BASE_MADDR_BFE_1+0x0474))       /* TX DC Compensation for Imaginary Part             */
#define TX_DC_COMP_I_5_BFE1           ((APBADDR)(L1_BASE_MADDR_BFE_1+0x0478))       /* TX DC Compensation for Real Part                  */
#define TX_DC_COMP_Q_5_BFE1           ((APBADDR)(L1_BASE_MADDR_BFE_1+0x047C))       /* TX DC Compensation for Imaginary Part             */
      /* --------------------------------------------------------------------------------------------------------------------- */
#define RX_CON0_BFE1                  ((APBADDR)(L1_BASE_MADDR_BFE_1+0x0800))       /* [0]loopback mode enable,                          */
                                                                                   /* [1]RX IQ SWAP                                     */
                                                                                   /* [7]Reset RX filter as slot change                 */
                                                                                   /* [8:15]repeat enable                               */
#define RX_CON1_BFE1                  ((APBADDR)(L1_BASE_MADDR_BFE_1+0x0804))       /* inclusive of control of RX mixed-signal module    */
#define RX_CON2_BFE1                  ((APBADDR)(L1_BASE_MADDR_BFE_1+0x0808))       /* and RX path in Baseband Front End module          */
      
#define RX_CON3_BFE1                  ((APBADDR)(L1_BASE_MADDR_BFE_1+0x080C))       /*[0:2] RX_resync_stage */
#define RX_TYPE_CON0_BFE1             ((APBADDR)(L1_BASE_MADDR_BFE_1+0x0810))
#define RX_TYPE_CON1_BFE1             ((APBADDR)(L1_BASE_MADDR_BFE_1+0x0814))
#define RX_TIME_CON0_BFE1             ((APBADDR)(L1_BASE_MADDR_BFE_1+0x0818))       /* RX DCOC NULL timing setting                       */
#define RX_TIME_CON1_BFE1             ((APBADDR)(L1_BASE_MADDR_BFE_1+0x081C))       /* RX image rejection factor switch time             */
#define RX_ITD_BFE1                   ((APBADDR)(L1_BASE_MADDR_BFE_1+0x0820))       /* Inter-frame ITD                                   */
         #if IS_BFE_RX_TYPE_NB_EN_SUPPORT
#define RX_TIME_CON2_BFE1             ((APBADDR)(L1_BASE_MADDR_BFE_1+0x0824))       /* RX non-NB DCOC NULL timing setting                */
         #endif
      
#define TX_SWAP_SEL_BFE1              ((APBADDR)(L1_BASE_MADDR_BFE_1+0x0848))       /* TX Swap Selection Control Register                */
      
      
#define RX_SWAP_SEL_BFE1(n)           ((APBADDR)(L1_BASE_MADDR_BFE_1+0x0828+(n)*4)) /* RX Swap Selection Control Register 0 to 7           */
      
      
#define RX_W_RE_BFE1(n)               ((APBADDR)(L1_BASE_MADDR_BFE_1+0x08B0+(n)*4))
#define RX_W_IM_BFE1(n)               ((APBADDR)(L1_BASE_MADDR_BFE_1+0x08D0+(n)*4))
#define RX_W_IMMDT_BFE1               ((APBADDR)(L1_BASE_MADDR_BFE_1+0x08F0))       /* Immediately assign W for IR algorithm             */
#define RX_HW_W_RE_BFE1(n)            ((APBADDR)(L1_BASE_MADDR_BFE_1+0x0A00+(n)*4))
#define RX_HW_W_IM_BFE1(n)            ((APBADDR)(L1_BASE_MADDR_BFE_1+0x0A20+(n)*4))

#define DBG_DCT_I_CHK_SUM_BFE1        ((APBADDR)(L1_BASE_MADDR_BFE_1+0x0A50))
#define DBG_DCT_Q_CHK_SUM_BFE1        ((APBADDR)(L1_BASE_MADDR_BFE_1+0x0A54))
#define DBG_TX_EN_WIN_CNT_BFE1        ((APBADDR)(L1_BASE_MADDR_BFE_1+0x0A58))
#define DBG_RX_EN_WIN_CNT_BFE1        ((APBADDR)(L1_BASE_MADDR_BFE_1+0x0A5C))

#define HW_READ_BCIEN_BFE1()          ((HW_READ(TX_CON0_BFE1)&(0x1<<11)) >>11)
#define HW_WRITE_BCIEN_BFE1(d)         {HW_WRITE(TX_CON0_BFE1, (d<<11)|L1D_WIN_TXMOD_TYPE());}
#define HW_WRITE_BFE_RX_RPT_EN_BFE1(d) {HW_WRITE(RX_CON0_BFE1, ((HW_READ(RX_CON0_BFE1)&0xFF)|d));}
         #if IS_WC_IMM_MODE_ENABLE
#define W_IMMDT_REG_BFE1              RX_W_IMMDT_BFE1
         #endif
...
#if (IS_L1D_MMRF_BSIBPIRS_DYNAMIC_ALLOCATION_SUPPORT)
   #if (IS_CHIP_MT6293)
#define BDLENA_POS_MASK           (0x30FC0) //TDMA Event Enabling register 0 BDLn MASK
#define BULENA_POS_MASK           (0X30F00) //TDMA Event Enabling register 1 BULn MASK
#define BDL_EVTENA_REG            (0)       //TDMA Event Enabling register 0
#define BUL_EVTENA_REG            (1)       //TDMA Event Enabling register 1
   #else
#error "please add IS_CHIP_MTxxxx compile option for the current generation chip"
   #endif
#endif

#if IS_CHIP_MT6293
#define DTIRQ_EVTENA_REG          (0)      //TDMA Event Enabling register 0
#define DTIRQENA_POS_MASK         (1)      // DTIRQ enable position
#endif
...
#if IS_CHIP_MT6293
   #if IS_2G_BANK_B_ENABLE
#define TDMA_EVTFRM_CNT          ((APBADDR)(L1_BASE_NADDR_TDMA_SLP+0x0200))
#define TDMA_EVTFRM_BDNY         ((APBADDR)(L1_BASE_NADDR_TDMA_SLP+0x0204))
#define TDMA_EVTFRM_BDNY_IMM     ((APBADDR)(L1_BASE_NADDR_TDMA_SLP+0x0208))
#define TDMA_EVTFRM_SET          ((APBADDR)(L1_BASE_NADDR_TDMA_SLP+0x020C))
   #else
#define TDMA_EVTFRM_CNT          ((APBADDR)(L1_BASE_MADDR_TDMA_SLP+0x0200))
#define TDMA_EVTFRM_BDNY         ((APBADDR)(L1_BASE_MADDR_TDMA_SLP+0x0204))
#define TDMA_EVTFRM_BDNY_IMM     ((APBADDR)(L1_BASE_MADDR_TDMA_SLP+0x0208))
#define TDMA_EVTFRM_SET          ((APBADDR)(L1_BASE_MADDR_TDMA_SLP+0x020C))
   #endif
#endif /* IS_CHIP_MT6293 */
...
#if IS_CHIP_MT6292 || IS_CHIP_MT6293
#define TDMA_AT_TRG0             ((APBADDR)(L1_BASE_MADDR_TDMA_BASE+0x0440))    /* Atenna Tuning Trigger control event 0 */
#define TDMA_AT_TRG1             ((APBADDR)(L1_BASE_MADDR_TDMA_BASE+0x0444))    /* Atenna Tuning Trigger control event 1 */
#define TDMA_DETWIN_ON           ((APBADDR)(L1_BASE_MADDR_TDMA_BASE+0x0448))    /* Tx Calibration Detection ADC ON event */
#define TDMA_DETWIN_OFF          ((APBADDR)(L1_BASE_MADDR_TDMA_BASE+0x044C))    /* Tx Calibration Detection ADC OFF event */
#define TDMA_DC_PRE_TRG0         ((APBADDR)(L1_BASE_MADDR_TDMA_BASE+0x0450))    /* Pre-burst DC calibration Trigger control event 0 */
#define TDMA_DC_PRE_TRG1         ((APBADDR)(L1_BASE_MADDR_TDMA_BASE+0x0454))    /* Pre-burst DC calibration Trigger control event 1*/
#define TDMA_DC_DETWIN_ON        ((APBADDR)(L1_BASE_MADDR_TDMA_BASE+0x0458))    /* Tx Calibration Detection ADC ON event*/
#define TDMA_DC_DETWIN_OFF       ((APBADDR)(L1_BASE_MADDR_TDMA_BASE+0x045C))    /* Tx Calibration Detection ADC OFF event */
#endif
/* ===================================================================================================================== */
#endif /* IS_CHIP_TK6291 || IS_CHIP_MT6755 || IS_CHIP_MT6292 || IS_CHIP_MT6293 */
...
#define BSI_G_TX_DATA_CON           ((APBADDR32)(L1_BASE_MADDR_MD2G_BSI_BASE + 0x0018)) /* BSI control part of BFE txdata register       */
...
#define GSM_BSI_TXDATA_CON       BSI_G_TX_DATA_CON
...
#if IS_CHIP_MT6293
   #if IS_2G_BANK_B_ENABLE
#define DIG_APC_CON0             ((APBADDR)(L1_BASE_NADDR_ABB_MIXEDSYS+0xC800))
   #else
#define DIG_APC_CON0             ((APBADDR)(L1_BASE_MADDR_ABB_MIXEDSYS+0xC800))
   #endif
#endif
...
#define L1D_MD2GSYS_BUS_CG_ENA()           {uint16 d16 = HW_READ(MD2GSYS_AHB_CON0);  HW_WRITE(MD2GSYS_AHB_CON0,(d16|(1<<9)|(1<<11)));}
...
\*================================*/
#if IS_GL1D_RXD_SUPPORT
#define MD2GSYS_BFE_2ND_CON0     ((APBADDR)(L1_BASE_MADDR_MD2G_CONFG+0x0400))
#endif /* IS_GL1D_RXD_SUPPORT */
...
#if ((IS_CHIP_TK6291 && IS_TK6291_HW_BUG_SW_WORKAROUND_SUPPORT)||(IS_CHIP_MT6761))
/*================================*\
|* md2g_mbist_config              *|
\*================================*/
/*
...
#define DELSEL(n)                ((APBADDR32)(L1_BASE_MADDR_MD2G_MBIST_CONFG+0x1000+(n)*4))
   ...
   #if IS_CHIP_MT6761
#define L1_BASE_MADDR_MD2G_MBIST_CONFG BASE_MADDR_MD2GSYS_MD2G_MBIST_CONFG  
#define DELSEL_MT6761(n)         ((APBADDR32)(L1_BASE_MADDR_MD2G_MBIST_CONFG+0x8000+(n)*4))
   #endif
/* --------------------------------------------------------------------------------------------------------------------- */
#endif
