...
ifneq ($(strip $(NO_PCIBT)),TRUE)
  ifneq ($(filter $(COMPONENT),$(SUB_BUILD)),)
	...
	@perl  ${COMMON_ROOT}/mtk_tools/USR/checkSubNeedFolder.pl $(COMPONENT) $(filter-out $(strip $(SUB_NEED_BUILD_FOLDER)), $(strip $(sort $(dir $(SRC_LIST)) $(foreach path,$(INC_DIR),$(path)/))))
    else
