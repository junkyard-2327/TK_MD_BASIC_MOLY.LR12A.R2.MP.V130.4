...
COM_DEFS += __LTE_OTDOA_CAPABILITY_OFF__
...
ifeq ($(strip $(DSP_FLAVOR)), DEFAULT_ASIC_WO_LTEPOS)
  COM_DEFS += __DSP_DEFAULT_ASIC_WO_LTEPOS__
endif
...
TAS_INHERIT_4G_ANT_SUPPORT_PLATFORM = MT6765 MT6761
ifneq ($(filter __TAS_SUPPORT__,$(strip $(COM_DEFS))),)
  ifneq ($(filter $(TAS_INHERIT_4G_ANT_SUPPORT_PLATFORM), $(strip $(PLATFORM))),)
    COM_DEFS    += __TAS_INHERIT_4G_ANT_SUPPORT__
  endif
endif
...
ANT_RXPWR_OFFSET_SUPPORT_PLATFORM = MT6765 MT6761
