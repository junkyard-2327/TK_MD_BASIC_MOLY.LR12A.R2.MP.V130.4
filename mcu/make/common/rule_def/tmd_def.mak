...
ifeq ($(strip $(GERAN_MODE_SUPPORT)),GERAN_EGPRS_MODE)
  ifeq ($(strip $(UTRAN_MODE_SUPPORT)),NONE)
    ...
    ifneq ($(wildcard ${L1CORE_ROOT}/modem/gl1/common/l1c_trace_public.tmd),)
    GL1_TMD_FILES += ${L1CORE_ROOT}/modem/gl1/common/l1c_trace_public.tmd
    endif
    ifneq ($(wildcard  ${L1CORE_ROOT}/modem/gl1/common/l1c2_trace_public.tmd),)
    GL1_TMD_FILES +=  ${L1CORE_ROOT}/modem/gl1/common/l1c2_trace_public.tmd
    endif
    ifneq ($(wildcard ${L1CORE_ROOT}/modem/gl1/common/l1i_cs_trace_public.tmd),)
    GL1_TMD_FILES += ${L1CORE_ROOT}/modem/gl1/common/l1i_cs_trace_public.tmd
    endif
    ifneq ($(wildcard  ${L1CORE_ROOT}/modem/gl1/common/l1i_ps_trace_public.tmd),)
    GL1_TMD_FILES +=  ${L1CORE_ROOT}/modem/gl1/common/l1i_ps_trace_public.tmd
    endif
    ifneq ($(wildcard  ${L1CORE_ROOT}/modem/gl1/common/l1sc_trace_public.tmd),)
    GL1_TMD_FILES +=  ${L1CORE_ROOT}/modem/gl1/common/l1sc_trace_public.tmd
    endif
    ifneq ($(wildcard  ${L1CORE_ROOT}/modem/gl1/common/l1c_csd_trace_public.tmd),)
    GL1_TMD_FILES +=  ${L1CORE_ROOT}/modem/gl1/common/l1c_csd_trace_public.tmd
    endif
    ifneq ($(wildcard ${L1CORE_ROOT}/modem/gl1/common/L1D_Trace_public.tmd),)
    GL1_TMD_FILES += ${L1CORE_ROOT}/modem/gl1/common/L1D_Trace_public.tmd
    endif
    ifneq ($(wildcard ${L1CORE_ROOT}/modem/gl1/common/L1D2_Trace_public.tmd),)
    GL1_TMD_FILES += ${L1CORE_ROOT}/modem/gl1/common/L1D2_Trace_public.tmd
    endif
    ifneq ($(wildcard ${L1CORE_ROOT}/modem/gl1/common/L1D_EDGE_Trace_public.tmd),)
    GL1_TMD_FILES += ${L1CORE_ROOT}/modem/gl1/common/L1D_EDGE_Trace_public.tmd
    endif
    ifneq ($(wildcard ${L1CORE_ROOT}/modem/gl1/common/l1i_egprs_trace_public.tmd),)
    GL1_TMD_FILES += ${L1CORE_ROOT}/modem/gl1/common/l1i_egprs_trace_public.tmd
    endif
    ifneq ($(wildcard ${L1CORE_ROOT}/modem/gl1/common/l1c_egprs_trace_public.tmd),)
    GL1_TMD_FILES += ${L1CORE_ROOT}/modem/gl1/common/l1c_egprs_trace_public.tmd
    endif
...
ifeq ($(strip $(TEST_LOAD_TYPE)),L1S)
    ...
    ifeq ($(strip $(L1_UMTS)),TRUE)
      ...
      ifneq ($(wildcard ${L1CORE_ROOT}/modem/gl1/common/L1D3_Trace_public.tmd),)
        GL1_TMD_FILES  +=   ${L1CORE_ROOT}/modem/gl1/common/L1D3_Trace_public.tmd
      endif
      ifneq ($(wildcard ${L1CORE_ROOT}/modem/gl1/common/L1_AFC_Trace_public.tmd),)
        GL1_TMD_FILES  +=   ${L1CORE_ROOT}/modem/gl1/common/L1_AFC_Trace_public.tmd
      endif
        ...
        ifeq ($(strip $(L1_WCDMA)),TRUE)
           ifeq ($(strip $(UMTS_FDD_SUPPORT)),UMTS_FDD_MODE_SUPPORT)
              ...
              ifneq ($(wildcard ${L1CORE_ROOT}/modem/ul1/ul1c_public/UL1C_Trace1_public.tmd),)
              UL1_TMD_FILES += ${L1CORE_ROOT}/modem/ul1/ul1c_public/UL1C_Trace1_public.tmd
              endif
              ifneq ($(wildcard ${L1CORE_ROOT}/modem/ul1/ul1c_public/UL1C_Trace2_public.tmd),)
              UL1_TMD_FILES += ${L1CORE_ROOT}/modem/ul1/ul1c_public/UL1C_Trace2_public.tmd
              endif
              ifneq ($(wildcard ${L1CORE_ROOT}/modem/ul1/ul1c_public/UL1C_Trace3_public.tmd),)
              UL1_TMD_FILES += ${L1CORE_ROOT}/modem/ul1/ul1c_public/UL1C_Trace3_public.tmd
              endif
              ifneq ($(wildcard ${L1CORE_ROOT}/modem/ul1/ul1c_public/UL1C_Trace4_public.tmd),)
              UL1_TMD_FILES += ${L1CORE_ROOT}/modem/ul1/ul1c_public/UL1C_Trace4_public.tmd
              endif
              ifneq ($(wildcard ${L1CORE_ROOT}/modem/ul1/ul1d_public/UL1D_Trace_External_public.tmd),)
              UL1_TMD_FILES += ${L1CORE_ROOT}/modem/ul1/ul1d_public/UL1D_Trace_External_public.tmd
              endif
        ...
        ifeq ($(strip $(L1_GPRS)),TRUE)
          ...
          ifneq ($(wildcard ${L1CORE_ROOT}/modem/gl1/common/l1dm_trace_public.tmd),)
          GL1_TMD_FILES  +=   ${L1CORE_ROOT}/modem/gl1/common/l1dm_trace_public.tmd
          endif
        endif
    endif
endif
...
ifneq ($(strip $(MODIS_CONFIG)),TRUE)
  ifneq ($(strip $(EUTRAN_MODE_SUPPORT)),NONE)
    EL1D_PUB_TMD_FILES = ${L1CORE_ROOT}/modem/el1/el1d_pub/trc/el1d_trace_cm0.tmd \
                    ...
                    ifneq ($(wildcard ${L1CORE_ROOT}/modem/el1/el1d_pub/trc/el1d_trace_et0.tmd),)
                        EL1D_PUB_TMD_FILES += ${L1CORE_ROOT}/modem/el1/el1d_pub/trc/el1d_trace_et0.tmd
                    endif
                    ifneq ($(wildcard ${L1CORE_ROOT}/modem/el1/el1d_pub/trc/el1d_trace_tx_public.tmd),)
                        EL1D_PUB_TMD_FILES += ${L1CORE_ROOT}/modem/el1/el1d_pub/trc/el1d_trace_tx_public.tmd
                    endif
  endif
endif
...
ifneq ($(strip $(TEST_LOAD_TYPE)),L1S)
    ...
    ifneq ($(wildcard ${PCORE_ROOT}/modem/upcm/src/data_path_public.tmd),)
...
ifeq ($(filter BASIC UDVT,$(TEST_LOAD_TYPE)),)
  COMMON_TMD_FILES += ${COMMON_ROOT}/service/qmu_bm/src/qmu_bm_trace.tmd
endif
...
ifneq ($(call Upper,$(strip $(EUTRAN_MODE_SUPPORT))),NONE)
  ifneq ($(strip $(TEST_LOAD_TYPE)),L1S)
      ...
      ifneq ($(wildcard ${PCORE_ROOT}/modem/rohc/rohc_core/rohc_public_trace.tmd),)
        ROHC_TMD_FILES += ${PCORE_ROOT}/modem/rohc/rohc_core/rohc_public_trace.tmd
      endif
      ifneq ($(wildcard ${PCORE_ROOT}/modem/rohc/rohc_core/rohc_public_trace2.tmd),)
      ...
      ifneq ($(wildcard ${PCORE_ROOT}/modem/rohc/ral/ral_public_trace.tmd),)
...
ifneq ($(strip $(MODIS_CONFIG)),TRUE)
  ...
  ifneq ($(wildcard ${L1CORE_ROOT}/modem/gl1/common/l1c3_trace_public.tmd),)
    GL1_TMD_FILES   +=   ${L1CORE_ROOT}/modem/gl1/common/l1c3_trace_public.tmd
  endif
  ifneq ($(wildcard ${L1CORE_ROOT}/modem/rtb/rtb_trace_public.tmd),)
    GL1_TMD_FILES   +=   ${L1CORE_ROOT}/modem/rtb/rtb_trace_public.tmd
  endif
  ifneq ($(wildcard ${L1CORE_ROOT}/modem/gl1/common/l1c5_trace_public.tmd),)
    GL1_TMD_FILES   +=   $${L1CORE_ROOT}/modem/gl1/common/l1c5_trace_public.tmd
  endif
...
ifneq ($(strip $(MODIS_CONFIG)),TRUE)
    ...
    ifneq ($(wildcard $(strip $(L1CORE_ROOT))/modem/tl1/tl1trace/tl1_trace_public.tmd),)
    TL1_TMD_FILES +=   $(strip $(L1CORE_ROOT))/modem/tl1/tl1trace/tl1_trace_public.tmd
    endif
...
SYS_TMD_FILES = ${C2K_ROOT}/inc/sys_trace.tmd
...
ifeq ($(strip $(C2K_CONFIG)),TRUE)
  ifneq ($(strip $(call Upper,$(C2K_MODE_SUPPORT))),NONE)
    ...
    COMMON_TMD_FILES += CuStOm_StArT_SYS $(SYS_TMD_FILES) CuStOm_EnD_SYS
