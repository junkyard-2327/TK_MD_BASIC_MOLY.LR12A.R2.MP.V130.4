...
SUPPORT_PLATFORM = TK6291 ELBRUS MT6763 MT6295M MT6739 MT6771 MT6765 MT6761
...
ifneq ($(strip $(TK_MD_CUS)),NONE)
  include make/projects/tk_md_cus/$(strip $(TK_MD_CUS)).mak
endif
endif
...
ifeq ($(strip $(RTOS)),NUCLEUS_V3)
  #COMPOBJS += ${COMMON_ROOT}/service/nucleus_v3/lib/libnucleus_v3.a
endif
  ...
  ifeq ($(strip $(SSS_SUPPORT)),SSS_LIB)
    ifeq ($(strip $(COMPILER)),RVCT)
      ifneq ($(filter $(strip $(PLATFORM)),$(SV5_PLATFORM)),)
        COMPOBJS    += ${COMMON_ROOT}/service/sss/lib/libsss_rvct_sv5.a
        CUS_REL_OBJ_LIST    += ${COMMON_ROOT}/service/sss/lib/libsss_rvct_sv5.a
      else
        COMPOBJS    += ${COMMON_ROOT}/service/sss/lib/libsss_rvct_dummy.a
        CUS_REL_OBJ_LIST    += ${COMMON_ROOT}/service/sss/lib/sss_rvct_dummy.lib
      endif
    else
