...
void UtConfig::custom_init() {
    ...
    SET_BOL("22003",    IDX_BOOL_MEDIA_TAG,             false);
    SET_STR("22003",    IDX_STR_GBA_TYPE,               "GBA_ME");
    SET_BOL("22003",    IDX_BOOL_SUPPORT_ADDING_UNPROVISIONED_RULE, false);
    ...
    SET_STR("22005",    IDX_STR_GBA_TYPE,               "GBA_ME");
    SET_BOL("22005",    IDX_BOOL_SUPPORT_ADDING_UNPROVISIONED_RULE, false);
    ...
    SET_STR("25915",    IDX_STR_GBA_TYPE,               "GBA_ME");
    SET_STR("25915",    IDX_STR_BSF_HOST,               "bsf.ims.mnc015.mcc259.pub.3gppnetwork.org");
    SET_INT("25915",    IDX_INT_GBA_PORT,               10080);
    SET_BOL("25915",    IDX_BOOL_MEDIA_TAG,             false);
    ...
    SET_INT("44000",    IDX_INT_XCAP_PORT,              8090);
    ...
    SET_INT("44020",    IDX_INT_XCAP_PORT,              8090);
    ...
    SET_INT("44021",    IDX_INT_XCAP_PORT,              8090);
    ...
    SET_INT("44101",    IDX_INT_XCAP_PORT,              8090);
