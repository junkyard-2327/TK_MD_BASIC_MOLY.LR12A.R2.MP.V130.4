...
ifneq ($(filter $(MTK_TOOLCHAIN),tc1 tc3),)
...
ifneq ($(wildcard $(MTK_BUILD_ROOT)/mtk_rel),)
#for cus rel include makefile
-include $(MOD_DUMMY_DIR)/app_cus_rel.mk
else
#for internal makefile
