...
#define MD32_IS_ASSEMBLY (!(defined(__CR4__) || defined(__MIPS_IA__) || defined(__CORE_USIP__)) && defined(__RAKE__) && (defined(__darts__) || defined(__GNUC__)))

#if defined(__DSP_CODEBASE_MT6293__) || defined(__MIPS_IA__)
