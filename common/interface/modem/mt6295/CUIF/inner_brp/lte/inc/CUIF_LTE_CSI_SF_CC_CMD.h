...
typedef volatile struct {
    ...
    kal_uint32 CELL_INFO0;                                                                // 0x000C
    kal_uint32 RRC_INFO_0;                                                                // 0x0010
    kal_uint32 RRC_INFO_1;                                                                // 0x0014
    kal_uint32 CSI_PMI_INFO_0;                                                            // 0x0018
    kal_uint32 CSI_PMI_INFO_1;                                                            // 0x001C
    kal_uint32 CSI_PMI_INFO_2;                                                            // 0x0020
    kal_uint32 CSI_PMI_INFO_3;                                                            // 0x0024
    kal_uint32 CSI_PCSI_CMD;                                                              // 0x0028
...
#define O_CUIF_LTE_CSI_SF_CC_CMD_CELL_INFO0                                               (3)
#define O_CUIF_LTE_CSI_SF_CC_CMD_RRC_INFO_0                                               (4)
#define O_CUIF_LTE_CSI_SF_CC_CMD_RRC_INFO_1                                               (5)
#define O_CUIF_LTE_CSI_SF_CC_CMD_CSI_PMI_INFO_0                                           (6)
#define O_CUIF_LTE_CSI_SF_CC_CMD_CSI_PMI_INFO_1                                           (7)
#define O_CUIF_LTE_CSI_SF_CC_CMD_CSI_PMI_INFO_2                                           (8)
#define O_CUIF_LTE_CSI_SF_CC_CMD_CSI_PMI_INFO_3                                           (9)
#define O_CUIF_LTE_CSI_SF_CC_CMD_CSI_PCSI_CMD                                             (10)
...
#define P_CUIF_LTE_CSI_SF_CC_CMD_CELL_INFO0_FRAME_STRUCT                                  (20)
#define L_CUIF_LTE_CSI_SF_CC_CMD_CELL_INFO0_FRAME_STRUCT                                  (2)
#define M_CUIF_LTE_CSI_SF_CC_CMD_CELL_INFO0_FRAME_STRUCT                                  (0x00300000)
