...
#define WORKING_LTE_CRSCE_SELF_WITH_IC_ESTIMATED_BUFF_SIZE    (CEILING_BYTE64(6000))
#define WORKING_LTE_CRSCE_SELF_WITH_IC_RS_EXTRACT_RYY_SIZE    (CEILING_BYTE64(9600))
