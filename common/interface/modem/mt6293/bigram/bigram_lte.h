...
// POS
    ...
    #define BIGRAM_LTE_POS_S_AGC_ADDR   (BIGRAM_LTE_NON_OVERLAY_ADDR + offsetof(bigram_lte_non_overlay_t, payload.pos.payload.sliding_fft.agc_info))
...
#if defined(MT6293) || defined(MT6763) || defined(MT6771) || defined(MT6765) || defined(MT6761)
...
#define CRSCE_PREDICT_BUF_SIZE          (CEILING_BYTE64(6400)) // =6400
...
// MD
    ...
    #define BIGRAM_LTE_CC_MD_AR_BUFF_ADDR(x,p)               (BIGRAM_LTE_CC_ADDR(x) + offsetof(bigram_lte_cc_t, payload.md.payload.md_ar_buff[p]))
