...
#if defined(MT6293) || defined(BIANCO) || defined(MT6763) || defined(MT6771) || defined(MT6765) || defined(MT6761)
...
#define BIGRAM_TDB_LTE_ADDR                 offsetof(bigram_t, grp0.payload.common.tdb_lte.payload.tdb_lte)
    ...
    //#define BIGRAM_LTE_FDB0_ADDR            offsetof(bigram_t, grp0.payload.common.tdb_lte.payload.share.lte_standby_fdb)
    #define BIGRAM_LTE_FDB0_ADDR            offsetof(bigram_t, grp0.payload.common.lte_fdb0)
