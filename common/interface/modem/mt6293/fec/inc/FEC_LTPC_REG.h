...
#define FEC_LTPC_BSI_PMIC_APT_0(n)                                              ((APBADDR32)(FEC_LTPC_GC_REG_REG_BASE + 0x18B0 + (n)* 4))   //n is from 0 to 8
#define FEC_LTPC_BSI_PMIC_DPD_0(n)                                              ((APBADDR32)(FEC_LTPC_GC_REG_REG_BASE + 0x18D4 + (n)* 4))   //n is from 0 to 8
#define FEC_LTPC_BSI_PGA_A_CW_0(n)                                              ((APBADDR32)(FEC_LTPC_GC_REG_REG_BASE + 0x18F8 + (n)* 4))   //n is from 0 to 89
#define FEC_LTPC_BSI_PGA_B_CW_0(n)                                              ((APBADDR32)(FEC_LTPC_GC_REG_REG_BASE + 0x1A60 + (n)* 4))   //n is from 0 to 62
#define FEC_LTPC_BSI_DET_CW_0(n)                                                ((APBADDR32)(FEC_LTPC_GC_REG_REG_BASE + 0x1B5C + (n)* 4))   //n is from 0 to 14
#define FEC_LTPC_APC_APT_DPD_0(n)                                               ((APBADDR32)(FEC_LTPC_GC_REG_REG_BASE + 0x1B98 + (n)* 4))   //n is from 0 to 8
#define FEC_LTPC_VM_APT_DPD_0(n)                                                ((APBADDR32)(FEC_LTPC_GC_REG_REG_BASE + 0x1BBC + (n)* 4))   //n is from 0 to 8
#define FEC_LTPC_MIPI_PA_ETM_IN_APT_MODE_0(n)                                   ((APBADDR32)(FEC_LTPC_GC_REG_REG_BASE + 0x1C50 + (n)* 4))   //n is from 0 to 107
#define FEC_LTPC_MIPI_PA_ETM_IN_DPD_MODE_0(n)                                   ((APBADDR32)(FEC_LTPC_GC_REG_REG_BASE + 0x1E00 + (n)* 4))   //n is from 0 to 107
