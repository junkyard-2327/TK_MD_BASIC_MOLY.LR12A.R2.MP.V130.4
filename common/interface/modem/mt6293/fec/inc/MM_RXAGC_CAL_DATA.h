 ...
 * $Log:$
 *
 * 01 24 2017 cherry.wu
 * [MOLY00217714] [6293] L1 TPC/AGC development
 * 1. Add/remove assert
 * 2. modify cal use dc cw
 * 3. fix dynamic cacheable problem(include mm_rxagc_cal_data)
 * 4. merge ut case
 *
 * 01 03 2017 cherry.wu
 * [MOLY00217714] [6293] L1 TPC/AGC development
 * 	
 * 	seperate temperature part from MM pathloss structure
 *
 * 12 28 2016 cherry.wu
 * [MOLY00217714] [6293] L1 TPC/AGC development
 * 	
 * 	:add pathloss db dealloc function
 *
 * 12 07 2016 cherry.wu
 * [MOLY00217307] [EL1D][6293] move AGC pathloss interpolation to do after RFD calculate RX RFDB
 * 	
 * 	.
 *
 * 11 18 2016 wan-ting.hsu
 * [MOLY00181056] [MT6293][xl1sim] FEC development
 * Porting agc calibration data struct. fix xl1sim rssi issue
 *
 * 11 10 2016 cherry.wu
 * [MOLY00182186] [6293][EL1D] AGC Development
 * 1.arx_req condition and update arx mode only arx trigger
 * 2.add inter-CM bitmap ASSERT
 * 3.update ant_port by SF
 * 4.get temperature idx from sch mode api
 * 5.get qdl_info from rfdb
 * 6.remove temperature addr from cuif
 * 7.remove divide 3 from pl interpolation
 * 8.fix ut case
 * 9.modify MM_RXAGC_CAL_DATA.h annotation
 *
 * 10 19 2016 cherry.wu
 * [MOLY00182186] [6293][EL1D] AGC Development
 * 	
 * 	:modify 1. time probe 2. modify cacheable switch usage 
 * 	3. inject sting fix gain value 4.PL temp struct align 128
 *
 * 10 14 2016 cherry.wu
 * [MOLY00207762] [EL1D][6293][AGC] Update to new Pathloss structure
 * .
 *
 *------------------------------------------------------------------------------
...
typedef struct
{
   ...
   kal_atomic_uint32 is_in_use;
   UINT8 padding_to_128_bytes[SRAM_PADDIND_TO_128_ALIGN((sizeof(MM_RXAGC_PL_TBL_L1_EMI_T)*RXAGC_CC_NUM) + (sizeof(UINT32)*RXAGC_CC_NUM) + sizeof(kal_atomic_uint32))];
