...
typedef volatile struct {
    ...
    kal_uint32 FEC_WTPC_CUIF_R5_SETPOINT_BACKOFF;                                         // 0x05F0
    kal_uint32 rsv_05DC[78];                                                              // 0x05F4..0x0728  padding-tag-skip
} FEC_W_TX_INFO_t;
...
typedef volatile struct {
    ...
    /*ATX PCFE1 ALGO related table Size = 132 words*/
