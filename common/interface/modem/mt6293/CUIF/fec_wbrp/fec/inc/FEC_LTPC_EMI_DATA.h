...
typedef struct
{
	...
	UINT32	BSI_PMIC_APT[PA_CW_IDX_DYM];  // 9
	UINT32	BSI_PMIC_DPD[PA_CW_IDX_DYM];  // 9
	...
	UINT32  TMP[27];
}LTE_TX_FEC_CW_TABLE_T; // total 448 word for l1 128 byte align //fec 424 word for size 32byte align
