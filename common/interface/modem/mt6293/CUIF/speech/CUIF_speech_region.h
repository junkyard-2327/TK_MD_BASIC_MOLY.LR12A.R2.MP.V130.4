...
typedef volatile struct {
    ...
    kal_uint16 MemAddr_BandFlag;       //SPH_DM_ADDR_BAND_FLAG
    kal_uint16 MemAddr_SEPtr;          //SPH_DM_ADDR_SE_PTR
    kal_uint16 MemAddr_SE2Ptr;         //SPH_DM_ADDR_SE2_PTR
    kal_uint16 MemAddr_SDPtr;          //SPH_DM_ADDR_SD_PTR
    kal_uint16 MemAddr_SE3Buf;         //SPH_DM_ADDR_SE3_BUF
    kal_uint16 MemAddr_SE4Buf;         //SPH_DM_ADDR_SE4_BUF
    kal_uint16 MemAddr_ERPtr;          //SPH_DM_ADDR_ANC_PTR
...
typedef volatile struct {
    kal_uint16 SFECtrl;                //SPH_SFE_CTRL    
    kal_uint16 MemAddr_STFltCoef;      //SPH_PM_ADDR_ST_FLT_COEF     
    kal_uint16 MemAddr_SRCCoef;        //SPH_PM_ADDR_SRC_FLT_COEF     
    kal_uint16 MemAddr_SRCPlusCoef;    //SPH_PM_ADDR_SRC_PLUS_FLT_COEF     
    kal_uint16 STVol;                  //SPH_ST_VOL
