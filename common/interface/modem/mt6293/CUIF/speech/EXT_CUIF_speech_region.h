...
typedef volatile struct {
    ...
    kal_int16 DPLBuf_UL_Pre[640] __attribute__ ((aligned (32)));
    kal_int16 DPLBuf_UL_Pos[640] __attribute__ ((aligned (32)));
    kal_int16 DPLBuf_DL_Pre[640] __attribute__ ((aligned (32)));
    kal_int16 DPLBuf_DL_Pos[640] __attribute__ ((aligned (32)));
    kal_int16 DPLBuf_UL_2[640] __attribute__ ((aligned (32)));
    kal_int16 DPLBuf_UL_3[640] __attribute__ ((aligned (32)));
    kal_int16 DPLBuf_UL_4[640] __attribute__ ((aligned (32)));
