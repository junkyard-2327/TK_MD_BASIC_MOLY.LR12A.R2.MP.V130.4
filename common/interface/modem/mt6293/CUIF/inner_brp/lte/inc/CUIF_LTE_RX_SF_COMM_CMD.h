...
// ---------- RX_INFO1 bit-field ----------
#define P_CUIF_LTE_RX_SF_COMM_CMD_RX_INFO1_FLAG_TMO_TEST                                  (10)
#define L_CUIF_LTE_RX_SF_COMM_CMD_RX_INFO1_FLAG_TMO_TEST                                  (1)
#define M_CUIF_LTE_RX_SF_COMM_CMD_RX_INFO1_FLAG_TMO_TEST                                  (0x00000400)
