...
// ---------- CC_INFO0 bit-field ----------
#define P_CUIF_LTE_RSSI_CC_CMD_CC_INFO0_CC_VLD                                            (31)
#define L_CUIF_LTE_RSSI_CC_CMD_CC_INFO0_CC_VLD                                            (1)
#define M_CUIF_LTE_RSSI_CC_CMD_CC_INFO0_CC_VLD                                            (0x80000000)
