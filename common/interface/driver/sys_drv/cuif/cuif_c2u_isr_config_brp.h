...
irq_auto_eoi(CUIF_TRUE)
#else
irq_index(CUIF_C2U_BRP_RESERVE1)
irq_entry_function(CUIF_DefaultISR)
irq_auto_eoi(CUIF_TRUE)
#endif
...
irq_auto_eoi(CUIF_TRUE)
#else
irq_index(CUIF_C2U_BRP_RESERVE2)
irq_entry_function(CUIF_DefaultISR)
irq_auto_eoi(CUIF_TRUE)
#endif
...
irq_auto_eoi(CUIF_TRUE)
#else
irq_index(CUIF_C2U_BRP_RESERVE3)
irq_entry_function(CUIF_DefaultISR)
irq_auto_eoi(CUIF_TRUE)
#endif
